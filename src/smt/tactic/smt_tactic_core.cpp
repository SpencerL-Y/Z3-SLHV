...
public:
    ...
    void operator()(goal_ref const & in,
        ...
        try {
            ...
            #ifdef SLHV_DEBUG
            std::cout << "smt_tactic execute: " << std::endl;
            // m_params.display(std::cout);
            in->display(std::cout);
            #endif
...
static tactic * mk_seq_smt_tactic(ast_manager& m, params_ref const & p) {
    #ifdef SLHV_DEBUG
    std::cout << "mk_seq_smt_tactic"  << std::endl;
    #endif
...
tactic * mk_smt_tactic_core(ast_manager& m, params_ref const& p, symbol const& logic) {
    ...
    #ifdef SLHV_DEBUG
    std::cout << "mk_smt_tactic core, parallel: " << pp.enable() << std::endl;
    #endif
