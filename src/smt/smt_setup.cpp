...
namespace smt {
    ...
    void setup::operator()(config_mode cm) {
        ...
        #ifdef SLHV_DEBUG
        std::cout << "configuring logical context, logic: " << m_logic << " " << cm << std::endl;
        #endif
    ...
    void setup::setup_default() {
        #ifdef SLHV_DEBUG
        std::cout << "setup_default()" << std::endl;
        #endif
        if (m_logic == "QF_UF") 
            setup_QF_UF();
    ...
    void setup::setup_SLHV() {
        m_context.register_plugin(alloc(smt::theory_slhv, m_context));
        #ifdef SLHV_DEBUG
        std::cout << "SLHV registered" << std::endl;
        #endif
    }
    ...
    void setup::setup_unknown() {
        #ifdef SLHV_DEBUG
        std::cout << "setup_unknown()" << std::endl;
        #endif
        static_features st(m_manager);
        ptr_vector<expr> fmls;
        m_context.get_asserted_formulas(fmls);
    ...
    void setup::setup_unknown(static_features & st) {
        #ifdef SLHV_DEBUG
        std::cout << "setup_unknown(st): "  << std::endl;
        std::cout << "num non UF theories: " << st.num_non_uf_theories() << "\n";
        std::cout << "num theories: " << st.num_theories() << "\n";
        std::cout << "is_diff_logic: " << is_diff_logic(st) << "\n";
        std::cout << "is_arith: " << is_arith(st) << "\n";
        std::cout << "has UF: " << st.has_uf() << "\n";
        std::cout << "has real: " << st.m_has_real << "\n";
        std::cout << "has int: " << st.m_has_int << "\n";
        std::cout << "has bv: " << st.m_has_bv << "\n";
        std::cout << "has fpa: " << st.m_has_fpa << "\n"; 
        std::cout << "has arrays: " << st.m_has_arrays << "\n";
        #endif
        TRACE("setup", tout << "setup_unknown\n";);
