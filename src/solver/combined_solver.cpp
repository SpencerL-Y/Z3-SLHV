...
public:
    ...
    #ifdef SLHV_DEBUG
    std::cout << "combined solver assert_expr_core" << std::endl;
    #endif
...
#ifdef SLHV_DEBUG
    std::cout << "check_sat_core for combined solver" << std::endl;
#endif
        ...
        if (get_num_assumptions() != 0 ||            
            ...
            switch_inc_mode();
            #ifdef SLHV_DEBUG
                std::cout << "m_solver2->check_sat_core" << std::endl;
            #endif
        ...
        m_use_solver1_results = true;
            #ifdef SLHV_DEBUG
                std::cout << "m_solver1->check_sat_core" << std::endl;
            #endif
