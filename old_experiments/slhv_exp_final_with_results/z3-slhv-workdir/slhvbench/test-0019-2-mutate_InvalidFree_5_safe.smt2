...
(assert
 (let (($x1121 (= loc_5 4)))
 (let (($x1251 (= invalidFree_5 invalidFree_4)))
 (let (($x1114 (= H_5 H_4)))
 ...
 (let (($x1248 (and (and (and (or true invalidFree_4) (and true true)) $x1101) $x1108)))
 (let (($x1060 (= loc_4 4)))
 (let (($x1240 (= invalidFree_4 invalidFree_3)))
 (let (($x1053 (= H_4 H_3)))
 ...
 (let (($x1237 (and (and (and (or true invalidFree_3) (and true true)) $x1040) $x1047)))
 (let (($x999 (= loc_3 4)))
 (let (($x1229 (= invalidFree_3 invalidFree_2)))
 (let (($x994 (= AH_3 AH_2)))
 ...
 (let (($x1214 (or $x892 invalidFree_2)))
 (let (($x903 (and (= H8_3 (uplus h13_3 (pt $p12_main01_3 (Pt_R_0 l27_3)))) (= H9_3 (uplus h13_3 (pt $p12_main01_3 (Pt_R_0 nil)))))))
 (let (($x1215 (or $x903 invalidFree_2)))
 (let (($x915 (= $p12_main01_3 (locadd $p1_main0_2 1))))
 (let (($x1216 (or $x915 invalidFree_2)))
 (let (($x926 (and (= H_2 (uplus h11_3 (pt $p11_main01_3 (Pt_R_0 l25_3)))) (= H8_3 (uplus h11_3 (pt $p11_main01_3 (Pt_R_0 nil)))))))
 (let (($x1217 (or $x926 invalidFree_2)))
 (let (($x937 (= $p11_main01_3 $p1_main0_2)))
 (let (($x1218 (or $x937 invalidFree_2)))
 (let (($x1225 (and (and (and (and (and (and $x1218 $x1217) $x1216) $x1215) $x1214) $x1223) $x987)))
 (let (($x859 (= loc_2 3)))
 ...
 (let (($x1206 (and (and (and (or true invalidFree_1) (and true true)) $x845) $x852)))
 (let (($x714 (= loc_1 2)))
 ...
 (let (($x1194 (and (or (or $x1191 (and $x800 $x1182)) $x1183) (or (or $x1179 (and $x769 $x1170)) $x1171))))
 (let (($x738 (= $i10_main0_1 1)))
 (let (($x739 (and $x714 $x738)))
 (let (($x1202 (=> $x739 (and (and (and (and $x1194 (and $x807 $x1196)) $x845) $x852) $x859))))
 ...
 (let (($x1137 (or $x602 invalidFree_0)))
 (let (($x613 (= $p3_main01_1 $p1_main01_1)))
 (let (($x1138 (or $x613 invalidFree_0)))
 ...
 (let (($x1140 (or $x626 invalidFree_0)))
 ...
 (let (($x1144 (and (and (and (or $x643 invalidFree_0) $x1140) (or $x624 invalidFree_0)) $x1138)))
 (let (($x1149 (and (and (and (and (and $x1144 $x1137) (or $x590 invalidFree_0)) $x1135) $x1134) $x1133)))
 (let (($x1155 (and (and (and (and (and $x1149 $x1132) $x1131) $x1130) (or $x515 invalidFree_0)) $x1154)))
 (let (($x458 (= loc_0 1)))
 (let (($x1127 (not invalidFree_0)))
 (let (($x460 (and (and (= H_0 emp) (= AH_0 emp)) $x458)))
 (let (($x1163 (and (and $x460 $x1127) (=> $x458 (and (and (and (and $x1155 $x706) $x711) $x1159) $x714)))))
 (let (($x1213 (and $x1163 (and $x1202 (=> $x863 (and (and (and $x1206 $x872) $x1208) $x859))))))
 (let (($x1233 (and $x1213 (=> $x859 (and (and (and (and $x1225 $x991) $x995) $x1229) $x999)))))
 (let (($x1255 (and (and $x1233 (=> $x999 (and (and (and $x1237 $x1054) $x1240) $x1060))) (=> $x1060 (and (and (and $x1248 $x1115) $x1251) $x1121)))))
 (and $x1255 invalidFree_5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
