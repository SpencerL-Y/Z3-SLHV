...
(assert
 (let (($x774 (= AH_3 (uplus ah7 (pt l16 (Pt_R_1 d11))))))
 (let (($x767 (or (= H_3 (uplus h4 (pt l14 (Pt_R_0 l15)))) (= H_3 (uplus h4 (pt l14 (Pt_R_1 d10)))))))
 (let (($x613 (= loc_3 4)))
 ...
 (let (($x752 (and (and (and (and (and (and $x568 $x566) $x538) $x583) $x602) $x606) $x613)))
 (let (($x505 (= loc_2 3)))
 (let (($x520 (= H_2 H_1)))
 ...
 (let (($x739 (=> $x432 (and (and (and (and (and $x461 $x459) $x472) $x491) $x498) $x505))))
 (let (($x745 (and $x739 (=> $x509 (and (and (and (and $x511 $x515) $x498) $x521) $x505)))))
 ...
 (let (($x727 (and (and (and (and (and (and $x367 $x356) $x354) $x352) $x324) $x313) $x311)))
 (let (($x277 (= loc_0 1)))
 (let (($x279 (and (and (= H_0 emp) (= AH_0 emp)) $x277)))
 (let (($x733 (and $x279 (=> $x277 (and (and (and (and $x727 $x398) $x407) $x412) $x418)))))
 (and (and (and $x733 $x745) (=> $x505 $x752)) (and (and $x613 $x767) $x774)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
