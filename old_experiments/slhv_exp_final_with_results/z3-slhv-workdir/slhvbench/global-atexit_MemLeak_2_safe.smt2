...
(assert
 (let (($x449 (= AH_2 (uplus ah1 (pt l7 (Pt_R_1 d4))))))
 (let (($x442 (or (= H_2 (uplus h3 (pt l5 (Pt_R_0 l6)))) (= H_2 (uplus h3 (pt l5 (Pt_R_1 d3)))))))
 (let (($x280 (= loc_2 3)))
 (let (($x353 (= loc_2 4)))
 ...
 (let (($x425 (and (and (and (and (and (and $x331 $x320) $x318) $x307) $x395) $x349) $x266)))
 (let (($x224 (= loc_1 2)))
 ...
 (let (($x418 (and (and (and (and (and false (and true true)) $x250) $x266) $x273) $x280)))
 ...
 (let (($x165 (= $M.01_1 nil)))
 (let (($x410 (and (and (and (and (and (and $x165 $x163) $x152) $x150) $x184) $x197) $x218)))
 (let (($x136 (= loc_0 1)))
 (let (($x138 (and (and (= H_0 emp) (= AH_0 emp)) $x136)))
 (let (($x429 (and (and $x138 (=> $x136 (and $x410 $x224))) (and (=> $x229 $x418) (=> $x296 (and $x425 $x353))))))
 (and $x429 (and (and $x280 $x442) $x449))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
