...
(assert
 (let (($x2073 (or (= H_1 (uplus h58 (pt l80 (Pt_R_0 l81)))) (= H_1 (uplus h58 (pt l80 (Pt_R_1 d20)))))))
 (let (($x2082 (and (and false $x2073) (= AH_1 (uplus ah7 (pt l82 (Pt_R_1 d21)))))))
 (let (($x2031 (= loc_1 2)))
 (let (($x2024 (= H_1 H_0)))
 ...
 (let (($x2058 (and (and (and (and (and (and $x1689 $x1681) $x1697) $x1938) $x2018) $x2025) $x2031)))
 (let (($x1672 (= loc_0 1)))
 (let (($x1674 (and (and (= H_0 emp) (= AH_0 emp)) $x1672)))
 (and (and $x1674 (=> $x1672 $x2058)) $x2082)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
