...
(assert
 (let (($x1918 (or (= H_3 (uplus h13 (pt l23 (Pt_R_0 l24)))) (= H_3 (uplus h13 (pt l23 (Pt_R_1 d39)))))))
 (let (($x1927 (and (and false $x1918) (= AH_3 (uplus ah9 (pt l25 (Pt_R_1 d40)))))))
 (let (($x1724 (= loc_3 6)))
 (let (($x1718 (= H_3 H_2)))
 (let (($x1651 (= AH_3 AH_2)))
 ...
 (let (($x1901 (and (and (and (and (and (and $x1673 $x1671) $x1668) $x1682) $x1691) $x1716) $x1719)))
 (let (($x1433 (= loc_2 4)))
 (let (($x1656 (= loc_3 5)))
 ...
 (let (($x1885 (and (and (= $p3_foo01_3 $M.1_2) (= $i4_foo01_3 $i2_foo0_2)) $x1483)))
 (let (($x1891 (and (and (and (and (and (and $x1885 $x1471) $x1460) $x1457) $x1455) $x1819) $x1581)))
 (let (($x1408 (= loc_2 3)))
 (let (($x1904 (and (=> $x1408 (and (and (and $x1891 $x1648) $x1652) $x1656)) (=> $x1433 (and $x1901 $x1724)))))
 (let (($x1401 (= H_2 H_1)))
 ...
 (let (($x1876 (=> $x1244 (and (and (and (and (and $x1245 $x1249) $x1319) $x1395) $x1402) $x1408))))
 (let (($x1882 (and $x1876 (=> $x1412 (and (and (and (and $x1414 $x1319) $x1428) $x1402) $x1433)))))
 ...
 (let (($x1847 (and (and (and (and (= $M.01_1 0) (= $M.11_1 nil)) $x1020) $x1018) $x1016)))
 (let (($x1853 (and (and (and (and (and (and $x1847 $x1014) $x1012) $x1010) $x987) $x985) $x983)))
 (let (($x1859 (and (and (and (and (and (and $x1853 $x981) $x979) $x977) $x954) $x952) $x950)))
 (let (($x1865 (and (and (and (and (and (and $x1859 $x948) $x945) $x934) $x923) $x921) $x1776)))
 (let (($x867 (= loc_0 1)))
 (let (($x869 (and (and (= H_0 emp) (= AH_0 emp)) $x867)))
 (let (($x1883 (and (and $x869 (=> $x867 (and (and (and $x1865 $x1166) $x1235) $x1238))) $x1882)))
 (and (and $x1883 $x1904) $x1927)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
