...
(assert
 (let (($x5236 (or (= H_2 (uplus h146 (pt l194 (Pt_R_0 l195)))) (= H_2 (uplus h146 (pt l194 (Pt_R_1 d18)))))))
 (let (($x5245 (and (and false $x5236) (= AH_2 (uplus ah7 (pt l196 (Pt_R_1 d19)))))))
 (let (($x5150 (= loc_2 4)))
 (let (($x5111 (= H_2 H_1)))
 ...
 (let (($x5216 (=> $x4555 (and (and (and (and (and $x4556 $x4560) $x4975) $x5105) $x5112) $x5118))))
 (let (($x5222 (and $x5216 (=> $x5122 (and (and (and (and $x5124 $x5145) $x5105) $x5112) $x5150)))))
 ...
 (let (($x5205 (and (and (and (and (and (and $x3808 $x3791) $x3780) $x3769) $x3752) $x3744) $x3838)))
 (let (($x3711 (= loc_0 1)))
 (let (($x3713 (and (and (= H_0 emp) (= AH_0 emp)) $x3711)))
 (let (($x5223 (and (and $x3713 (=> $x3711 (and (and (and $x5205 $x4375) $x4543) $x4549))) $x5222)))
 (and $x5223 $x5245)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
