...
(assert
 (let (($x693 (= loc_2 2)))
 (let (($x769 (= invalidFree_2 invalidFree_1)))
 (let (($x686 (= H_2 H_1)))
 ...
 (let (($x766 (and (and (and (or true invalidFree_1) (and true true)) $x676) $x680)))
 (let (($x643 (= loc_1 2)))
 (let (($x757 (= invalidFree_1 invalidFree2_1)))
 (let (($x636 (= H_1 H6_1)))
 (let (($x633 (= AH_1 AH4_1)))
 ...
 (let (($x707 (or $x413 invalidFree2_1)))
 (let (($x708 (= invalidFree2_1 invalidFree1_1)))
 (let (($x709 (and invalidFree1_1 $x708)))
 (let (($x415 (= H6_1 h8_1)))
 ...
 (let (($x716 (or (= $p8_main01_1 nil) (= ah4_1 (uplus AH3_1 (pt $p8_main01_1 (Pt_R_1 d7_1)))))))
 (let (($x717 (and $x716 invalidFree2_1)))
 (let (($x449 (= $p8_main01_1 $p1_main01_1)))
 (let (($x720 (or $x449 invalidFree1_1)))
 (let (($x721 (= invalidFree1_1 invalidFree_0)))
 (let (($x722 (and invalidFree_0 $x721)))
 (let (($x451 (= H5_1 h7_1)))
 ...
 (let (($x741 (or $x565 invalidFree_0)))
 ...
 (let (($x745 (and (and (and (or $x588 invalidFree_0) $x741) (or $x563 invalidFree_0)) $x739)))
 (let (($x751 (and (and (and (and (and (and $x745 $x738) $x737) $x736) $x735) $x734) $x733)))
 (let (($x754 (and (and (and $x751 (or (or $x730 (and $x483 $x721)) $x722)) $x720) (or (or $x717 (and $x447 $x708)) $x709))))
 (let (($x346 (= loc_0 1)))
 (let (($x699 (not invalidFree_0)))
 (let (($x348 (and (and (= H_0 emp) (= AH_0 emp)) $x346)))
 (let (($x762 (and (and $x348 $x699) (=> $x346 (and (and (and $x754 $x707) (and $x637 $x757)) $x643)))))
 (and (and $x762 (=> $x643 (and (and (and $x766 $x687) $x769) $x693))) invalidFree_2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
