...
(assert
 (let (($x742 (= loc_3 2)))
 (let (($x829 (= invalidFree_3 invalidFree_2)))
 (let (($x735 (= H_3 H_2)))
 ...
 (let (($x826 (and (and (and (or true invalidFree_2) (and true true)) $x725) $x729)))
 (let (($x693 (= loc_2 2)))
 (let (($x818 (= invalidFree_2 invalidFree_1)))
 (let (($x686 (= H_2 H_1)))
 ...
 (let (($x815 (and (and (and (or true invalidFree_1) (and true true)) $x676) $x680)))
 (let (($x643 (= loc_1 2)))
 (let (($x806 (= invalidFree_1 invalidFree2_1)))
 (let (($x636 (= H_1 H6_1)))
 (let (($x633 (= AH_1 AH4_1)))
 ...
 (let (($x756 (or $x413 invalidFree2_1)))
 (let (($x757 (= invalidFree2_1 invalidFree1_1)))
 (let (($x758 (and invalidFree1_1 $x757)))
 (let (($x415 (= H6_1 h8_1)))
 ...
 (let (($x765 (or (= $p8_main01_1 nil) (= ah4_1 (uplus AH3_1 (pt $p8_main01_1 (Pt_R_1 d7_1)))))))
 (let (($x766 (and $x765 invalidFree2_1)))
 (let (($x449 (= $p8_main01_1 $p1_main01_1)))
 (let (($x769 (or $x449 invalidFree1_1)))
 (let (($x770 (= invalidFree1_1 invalidFree_0)))
 (let (($x771 (and invalidFree_0 $x770)))
 (let (($x451 (= H5_1 h7_1)))
 ...
 (let (($x790 (or $x565 invalidFree_0)))
 ...
 (let (($x794 (and (and (and (or $x588 invalidFree_0) $x790) (or $x563 invalidFree_0)) $x788)))
 (let (($x800 (and (and (and (and (and (and $x794 $x787) $x786) $x785) $x784) $x783) $x782)))
 (let (($x803 (and (and (and $x800 (or (or $x779 (and $x483 $x770)) $x771)) $x769) (or (or $x766 (and $x447 $x757)) $x758))))
 (let (($x346 (= loc_0 1)))
 (let (($x748 (not invalidFree_0)))
 (let (($x348 (and (and (= H_0 emp) (= AH_0 emp)) $x346)))
 (let (($x811 (and (and $x348 $x748) (=> $x346 (and (and (and $x803 $x756) (and $x637 $x806)) $x643)))))
 (let (($x833 (and (and $x811 (=> $x643 (and (and (and $x815 $x687) $x818) $x693))) (=> $x693 (and (and (and $x826 $x736) $x829) $x742)))))
 (and $x833 invalidFree_3))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
