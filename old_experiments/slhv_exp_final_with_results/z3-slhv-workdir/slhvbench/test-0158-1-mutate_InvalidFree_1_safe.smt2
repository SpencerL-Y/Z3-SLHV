...
(assert
 (let (($x643 (= loc_1 2)))
 (let (($x707 (= invalidFree_1 invalidFree2_1)))
 (let (($x636 (= H_1 H6_1)))
 (let (($x633 (= AH_1 AH4_1)))
 ...
 (let (($x657 (or $x413 invalidFree2_1)))
 (let (($x658 (= invalidFree2_1 invalidFree1_1)))
 (let (($x659 (and invalidFree1_1 $x658)))
 (let (($x415 (= H6_1 h8_1)))
 ...
 (let (($x666 (or (= $p8_main01_1 nil) (= ah4_1 (uplus AH3_1 (pt $p8_main01_1 (Pt_R_1 d7_1)))))))
 (let (($x667 (and $x666 invalidFree2_1)))
 (let (($x449 (= $p8_main01_1 $p1_main01_1)))
 (let (($x670 (or $x449 invalidFree1_1)))
 (let (($x671 (= invalidFree1_1 invalidFree_0)))
 (let (($x672 (and invalidFree_0 $x671)))
 (let (($x451 (= H5_1 h7_1)))
 ...
 (let (($x691 (or $x565 invalidFree_0)))
 ...
 (let (($x695 (and (and (and (or $x588 invalidFree_0) $x691) (or $x563 invalidFree_0)) $x689)))
 (let (($x701 (and (and (and (and (and (and $x695 $x688) $x687) $x686) $x685) $x684) $x683)))
 (let (($x704 (and (and (and $x701 (or (or $x680 (and $x483 $x671)) $x672)) $x670) (or (or $x667 (and $x447 $x658)) $x659))))
 (let (($x346 (= loc_0 1)))
 (let (($x649 (not invalidFree_0)))
 (let (($x348 (and (and (= H_0 emp) (= AH_0 emp)) $x346)))
 (let (($x712 (and (and $x348 $x649) (=> $x346 (and (and (and $x704 $x657) (and $x637 $x707)) $x643)))))
 (and $x712 invalidFree_1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
