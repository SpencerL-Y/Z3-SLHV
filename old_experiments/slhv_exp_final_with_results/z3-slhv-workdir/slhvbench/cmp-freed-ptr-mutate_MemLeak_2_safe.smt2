...
(assert
 (let (($x642 (or (= H_2 (uplus h4 (pt l14 (Pt_R_0 l15)))) (= H_2 (uplus h4 (pt l14 (Pt_R_1 d10)))))))
 (let (($x651 (and (and false $x642) (= AH_2 (uplus ah7 (pt l16 (Pt_R_1 d11)))))))
 (let (($x505 (= loc_2 3)))
 (let (($x520 (= H_2 H_1)))
 ...
 (let (($x622 (=> $x432 (and (and (and (and (and $x461 $x459) $x472) $x491) $x498) $x505))))
 (let (($x628 (and $x622 (=> $x509 (and (and (and (and $x511 $x515) $x498) $x521) $x505)))))
 ...
 (let (($x610 (and (and (and (and (and (and $x367 $x356) $x354) $x352) $x324) $x313) $x311)))
 (let (($x277 (= loc_0 1)))
 (let (($x279 (and (and (= H_0 emp) (= AH_0 emp)) $x277)))
 (let (($x616 (and $x279 (=> $x277 (and (and (and (and $x610 $x398) $x407) $x412) $x418)))))
 (and (and $x616 $x628) $x651)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
