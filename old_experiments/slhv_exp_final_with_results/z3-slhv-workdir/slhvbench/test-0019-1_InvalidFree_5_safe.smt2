...
(assert
 (let (($x1093 (= loc_5 4)))
 (let (($x1232 (= invalidFree_5 invalidFree_4)))
 (let (($x1086 (= H_5 H_4)))
 ...
 (let (($x1229 (and (and (and (or true invalidFree_4) (and true true)) $x1073) $x1080)))
 (let (($x1035 (= loc_4 4)))
 (let (($x1221 (= invalidFree_4 invalidFree_3)))
 (let (($x1028 (= H_4 H_3)))
 ...
 (let (($x1218 (and (and (and (or true invalidFree_3) (and true true)) $x1015) $x1022)))
 (let (($x977 (= loc_3 4)))
 (let (($x1210 (= invalidFree_3 invalidFree_2)))
 (let (($x969 (= H_3 H_2)))
 ...
 (let (($x1204 (or $x921 invalidFree_2)))
 (let (($x1212 (and (and (and (and (and (and $x1204 $x925) $x959) $x963) $x970) $x1210) $x977)))
 (let (($x763 (= loc_2 3)))
 ...
 (let (($x1195 (= invalidFree_2 invalidFree3_2)))
 (let (($x900 (= H_2 H8_2)))
 (let (($x901 (and (and (= $p11_main0_2 $p11_main01_2) (= AH_2 AH6_2)) $x900)))
 (let (($x1155 (= invalidFree3_2 invalidFree2_2)))
 (let (($x1156 (and invalidFree2_2 $x1155)))
 (let (($x799 (= H8_2 h11_2)))
 ...
 (let (($x1163 (or (= $p11_main01_2 nil) (= ah6_2 (uplus AH5_2 (pt $p11_main01_2 (Pt_R_1 d11_2)))))))
 (let (($x1164 (and $x1163 invalidFree3_2)))
 (let (($x830 (= $p11_main01_2 $p1_main0_1)))
 (let (($x1167 (or $x830 invalidFree2_2)))
 ...
 (let (($x1176 (or (= $p9_main0_1 nil) (= ah4_2 (uplus AH4_2 (pt $p9_main0_1 (Pt_R_1 d8_2)))))))
 (let (($x1177 (and $x1176 invalidFree2_2)))
 (let (($x1180 (= invalidFree1_2 invalidFree_1)))
 (let (($x1181 (and invalidFree_1 $x1180)))
 (let (($x863 (= H6_2 h9_2)))
 ...
 (let (($x1188 (or (= $p7_main0_1 nil) (= ah2_2 (uplus AH_1 (pt $p7_main0_1 (Pt_R_1 d5_2)))))))
 (let (($x1189 (and $x1188 invalidFree1_2)))
 (let (($x1192 (and (or (or $x1189 (and $x892 $x1180)) $x1181) (or (or $x1177 (and $x861 $x1168)) $x1169))))
 (let (($x1197 (and (and (and $x1192 $x1167) (or (or $x1164 (and $x828 $x1155)) $x1156)) (and $x901 $x1195))))
 (let (($x701 (= loc_1 2)))
 (let (($x798 (and $x701 (not (= $i10_main0_1 1)))))
 (let (($x1142 (= invalidFree_2 invalidFree_1)))
 (let (($x755 (= H_2 H_1)))
 ...
 (let (($x1139 (and (and (and (or true invalidFree_1) (and true true)) $x742) $x749)))
 (let (($x705 (= $i10_main0_1 1)))
 (let (($x706 (and $x701 $x705)))
 (let (($x1202 (and (=> $x706 (and (and (and $x1139 $x756) $x1142) $x763)) (=> $x798 (and (and (and $x1197 $x912) $x749) $x763)))))
 (let (($x1131 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1109 (or $x593 invalidFree_0)))
 (let (($x604 (= $p3_main01_1 $p1_main01_1)))
 (let (($x1110 (or $x604 invalidFree_0)))
 ...
 (let (($x1112 (or $x617 invalidFree_0)))
 ...
 (let (($x1116 (and (and (and (or $x634 invalidFree_0) $x1112) (or $x615 invalidFree_0)) $x1110)))
 (let (($x1121 (and (and (and (and (and $x1116 $x1109) (or $x581 invalidFree_0)) $x1107) $x1106) $x1105)))
 (let (($x1127 (and (and (and (and (and $x1121 $x1104) $x1103) $x1102) (or $x506 invalidFree_0)) $x1126)))
 (let (($x449 (= loc_0 1)))
 (let (($x1099 (not invalidFree_0)))
 (let (($x451 (and (and (= H_0 emp) (= AH_0 emp)) $x449)))
 (let (($x1135 (and (and $x451 $x1099) (=> $x449 (and (and (and (and $x1127 $x693) $x698) $x1131) $x701)))))
 (let (($x1225 (and (and (and $x1135 $x1202) (=> $x763 $x1212)) (=> $x977 (and (and (and $x1218 $x1029) $x1221) $x1035)))))
 (and (and $x1225 (=> $x1035 (and (and (and $x1229 $x1087) $x1232) $x1093))) invalidFree_5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
