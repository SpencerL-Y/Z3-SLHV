...
(assert
 (let (($x1312 (or (= H_2 (uplus h11 (pt l17 (Pt_R_0 l18)))) (= H_2 (uplus h11 (pt l17 (Pt_R_1 d31)))))))
 (let (($x1321 (and (and false $x1312) (= AH_2 (uplus ah9 (pt l19 (Pt_R_1 d32)))))))
 (let (($x1177 (= loc_2 4)))
 (let (($x1146 (= H_2 H_1)))
 ...
 (let (($x1292 (=> $x1022 (and (and (and (and (and $x1023 $x1027) $x1091) $x1140) $x1147) $x1153))))
 (let (($x1298 (and $x1292 (=> $x1157 (and (and (and (and $x1159 $x1091) $x1172) $x1147) $x1177)))))
 ...
 (let (($x840 (= $M.02_1 2)))
 (let (($x842 (= $M.31_1 nil)))
 (let (($x1263 (and (and (and (and (= $M.01_1 0) (= $M.11_1 nil)) $x842) $x840) $x838)))
 (let (($x1269 (and (and (and (and (and (and $x1263 $x836) $x834) $x832) $x815) $x813) $x811)))
 (let (($x1275 (and (and (and (and (and (and $x1269 $x809) $x807) $x805) $x788) $x786) $x784)))
 (let (($x1281 (and (and (and (and (and (and $x1275 $x782) $x779) $x768) $x757) $x755) $x1229)))
 (let (($x705 (= loc_0 1)))
 (let (($x707 (and (and (= H_0 emp) (= AH_0 emp)) $x705)))
 (let (($x1299 (and (and $x707 (=> $x705 (and (and (and $x1281 $x980) $x1013) $x1016))) $x1298)))
 (and $x1299 $x1321)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
