...
(assert
 (let (($x1348 (= loc_3 4)))
 (let (($x1436 (= invalidFree_3 invalidFree_2)))
 (let (($x1343 (= AH_3 AH_2)))
 ...
 (let (($x1422 (or $x1235 invalidFree_2)))
 (let (($x1247 (= $p16_append01_3 (locadd $p2_append0_2 1))))
 (let (($x1423 (or $x1247 invalidFree_2)))
 (let (($x1249 (= $p15_append01_3 $p13_append0_2)))
 (let (($x1424 (or $x1249 invalidFree_2)))
 (let (($x1429 (and (and (and (and (and $x1424 $x1423) $x1422) $x1421) $x1420) (or $x1184 invalidFree_2))))
 (let (($x1438 (and (and (and (and (and (and $x1429 $x1430) $x1333) $x1340) $x1344) $x1436) $x1348)))
 (let (($x1093 (= loc_2 3)))
 (let (($x1404 (= invalidFree_2 invalidFree_1)))
 ...
 (let (($x1408 (or $x1104 invalidFree_1)))
 ...
 (let (($x1414 (and (and (and (and (and (or $x1115 invalidFree_1) $x1408) $x1125) $x1150) $x1082) $x1404)))
 (let (($x929 (= loc_1 2)))
 ...
 (let (($x1387 (or $x951 invalidFree_1)))
 (let (($x953 (= $p12_append01_2 $p11_append01_2)))
 (let (($x1388 (or $x953 invalidFree_1)))
 (let (($x962 (and (= H_1 (uplus h11_2 (pt $p10_append01_2 (Pt_R_0 l16_2)))) (= $p11_append01_2 l16_2))))
 (let (($x1389 (or $x962 invalidFree_1)))
 (let (($x974 (= $p10_append01_2 (locadd $p9_append01_2 1))))
 (let (($x1390 (or $x974 invalidFree_1)))
 (let (($x983 (and (= H_1 (uplus h9_2 (pt $p8_append01_2 (Pt_R_0 l14_2)))) (= $p9_append01_2 l14_2))))
 (let (($x1391 (or $x983 invalidFree_1)))
 (let (($x994 (= $p8_append01_2 $p2_append0_1)))
 (let (($x1392 (or $x994 invalidFree_1)))
 (let (($x1399 (and (and (and (and (and (and $x1392 $x1391) $x1390) $x1389) $x1388) $x1387) $x1398)))
 (let (($x949 (= $i7_append0_1 1)))
 (let (($x950 (and $x929 $x949)))
 (let (($x1407 (=> $x950 (and (and (and (and (and $x1399 $x1072) $x1082) $x1089) $x1404) $x1093))))
 (let (($x1382 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1357 (or $x706 invalidFree_0)))
 (let (($x717 (= $p5_append01_1 $p2_append01_1)))
 (let (($x1358 (or $x717 invalidFree_0)))
 ...
 (let (($x1369 (and (and (and (or $x810 invalidFree_0) $x1365) $x1364) (or $x777 invalidFree_0))))
 (let (($x1375 (and (and (and (and (and (and $x1369 $x1362) $x1361) $x1360) $x1359) $x1358) $x1357)))
 (let (($x1383 (and (and (and (and (and $x1375 (or $x697 invalidFree_0)) $x1377) $x917) $x926) $x1382)))
 (let (($x646 (= loc_0 1)))
 (let (($x1354 (not invalidFree_0)))
 (let (($x648 (and (and (= H_0 emp) (= AH_0 emp)) $x646)))
 (let (($x1418 (and (and (and $x648 $x1354) (=> $x646 (and $x1383 $x929))) (and $x1407 (=> $x1103 (and $x1414 $x1093))))))
 (and (and $x1418 (=> $x1093 $x1438)) invalidFree_3))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
