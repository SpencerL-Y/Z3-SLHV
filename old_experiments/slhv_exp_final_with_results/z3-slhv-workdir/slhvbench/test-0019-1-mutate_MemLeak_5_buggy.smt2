...
(assert
 (let (($x1145 (= AH_5 (uplus ah5 (pt l27 (Pt_R_1 d10))))))
 (let (($x1138 (or (= H_5 (uplus h11 (pt l25 (Pt_R_0 l26)))) (= H_5 (uplus h11 (pt l25 (Pt_R_1 d9)))))))
 (let (($x951 (= loc_5 4)))
 (let (($x944 (= H_5 H_4)))
 ...
 (let (($x687 (= loc_2 3)))
 (let (($x1112 (=> $x687 (and (and (and (and (and $x788 $x792) $x823) $x827) $x834) $x841))))
 ...
 (let (($x1104 (=> $x711 (and (and (and (and (and $x772 $x741) $x778) $x666) $x673) $x687))))
 (let (($x679 (= H_2 H_1)))
 (let (($x680 (and (and true (= AH_2 AH_1)) $x679)))
 (let (($x632 (= $i10_main0_1 1)))
 (let (($x633 (and $x628 $x632)))
 (let (($x1105 (and (=> $x633 (and (and (and (and $x635 $x666) $x673) $x680) $x687)) $x1104)))
 ...
 (let (($x438 (or (and (= $p7_main01_1 $p9_main01_1) (= $i10_main01_1 1)) (and (not (= $p7_main01_1 $p9_main01_1)) (= $i10_main01_1 0)))))
 ...
 (let (($x1082 (and (and (and (and (and (and $x566 $x549) $x547) $x536) $x525) $x513) $x502)))
 (let (($x1088 (and (and (and (and (and (and $x1082 $x491) $x479) $x468) $x459) $x447) $x438)))
 (let (($x381 (= loc_0 1)))
 (let (($x383 (and (and (= H_0 emp) (= AH_0 emp)) $x381)))
 (let (($x1106 (and (and $x383 (=> $x381 (and (and (and $x1088 $x984) $x625) $x628))) $x1105)))
 (let (($x1119 (and (and $x1106 $x1112) (=> $x841 (and (and (and (and $x635 $x876) $x883) $x890) $x896)))))
 (let (($x1125 (and $x1119 (=> $x896 (and (and (and (and $x635 $x931) $x938) $x945) $x951)))))
 (and $x1125 (and (and $x951 $x1138) $x1145)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
