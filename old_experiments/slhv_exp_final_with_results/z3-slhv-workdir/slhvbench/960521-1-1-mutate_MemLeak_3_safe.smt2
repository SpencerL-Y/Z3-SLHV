...
(assert
 (let (($x1645 (= AH_3 (uplus ah9 (pt l25 (Pt_R_1 d36))))))
 (let (($x1638 (or (= H_3 (uplus h9 (pt l23 (Pt_R_0 l24)))) (= H_3 (uplus h9 (pt l23 (Pt_R_1 d35)))))))
 (let (($x1396 (= loc_3 4)))
 (let (($x1388 (= H_3 H_2)))
 ...
 (let (($x1148 (= loc_2 3)))
 (let (($x1624 (=> $x1148 (and (and (and (and (and $x1295 $x1299) $x1354) $x1382) $x1389) $x1396))))
 ...
 (let (($x1608 (and (and (= $p20_main01_2 $M.1_1) (= $p21_main01_2 $p20_main01_2)) $x1251)))
 (let (($x1614 (and (and (and (and (and (and $x1608 $x1217) $x1215) $x1213) $x1273) $x1286) $x1142)))
 (let (($x936 (= loc_1 2)))
 ...
 (let (($x1598 (and (and (= $p16_main01_2 $M.1_1) (= $p17_main01_2 $p16_main01_2)) $x1040)))
 (let (($x1604 (and (and (and (and (and (and $x1598 $x1006) $x1004) $x1002) $x1068) $x1111) $x1142)))
 ...
 (let (($x800 (= $M.02_1 3)))
 (let (($x802 (= $M.21_1 nil)))
 (let (($x1571 (and (and (and (and (= $M.01_1 0) (= $M.11_1 nil)) $x802) $x800) $x798)))
 (let (($x1577 (and (and (and (and (and (and $x1571 $x796) $x794) $x792) $x769) $x767) $x765)))
 (let (($x1583 (and (and (and (and (and (and $x1577 $x763) $x761) $x759) $x736) $x734) $x732)))
 (let (($x1589 (and (and (and (and (and (and $x1583 $x730) $x727) $x716) $x705) $x703) $x691)))
 (let (($x621 (= loc_0 1)))
 (let (($x1595 (=> $x621 (and (and (and (and (and $x1589 $x682) $x1451) $x928) $x933) $x936))))
 (let (($x623 (and (and (= H_0 emp) (= AH_0 emp)) $x621)))
 (let (($x1618 (and (and $x623 $x1595) (and (=> $x969 (and $x1604 $x1148)) (=> $x1180 (and $x1614 $x1148))))))
 (and (and $x1618 $x1624) (and (and $x1396 $x1638) $x1645))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
