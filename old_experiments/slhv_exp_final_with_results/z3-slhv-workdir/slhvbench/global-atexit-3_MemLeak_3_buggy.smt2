...
(assert
 (let (($x1153 (= AH_3 (uplus ah7 (pt l17 (Pt_R_1 d16))))))
 (let (($x1146 (or (= H_3 (uplus h10 (pt l15 (Pt_R_0 l16)))) (= H_3 (uplus h10 (pt l15 (Pt_R_1 d15)))))))
 (let (($x771 (= loc_3 5)))
 (let (($x956 (= loc_3 3)))
 ...
 (let (($x1124 (and (and (and (and (and (and $x917 $x906) $x897) $x895) $x867) $x865) $x863)))
 (let (($x1130 (and (and (and (and (and $x1124 $x835) (and $x940 true)) $x952) $x954) $x956)))
 (let (($x691 (= loc_2 4)))
 ...
 (let (($x1116 (and (and (and (and (and (and $x786 $x784) $x792) $x794) $x797) $x764) $x802)))
 ...
 (let (($x618 (= loc_2 3)))
 (let (($x1110 (=> $x618 (and (and (and (and (and $x697 $x701) $x747) $x757) $x764) $x771))))
 ...
 (let (($x1100 (and (and (and (and (and (and $x669 $x658) $x656) $x645) $x998) $x687) $x604)))
 (let (($x538 (= loc_1 2)))
 ...
 (let (($x1103 (and (=> $x543 (and (and (and (and $x545 $x591) $x604) $x611) $x618)) (=> $x634 (and $x1100 $x691)))))
 ...
 (let (($x447 (= $M.01_1 nil)))
 (let (($x1086 (and (and (and (and (and (and $x447 $x445) $x434) $x432) $x466) $x515) $x532)))
 (let (($x418 (= loc_0 1)))
 (let (($x420 (and (and (= H_0 emp) (= AH_0 emp)) $x418)))
 (let (($x1133 (and (and (and $x420 (=> $x418 (and $x1086 $x538))) $x1103) (and (and $x1110 (=> $x777 $x1116)) (=> $x834 $x1130)))))
 (and $x1133 (and (and $x771 $x1146) $x1153))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
