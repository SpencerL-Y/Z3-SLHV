...
(assert
 (let (($x705 (= loc_5 4)))
 (let (($x702 (= invalidDeref_5 invalidDeref_4)))
 (let (($x698 (= H_5 H_4)))
 ...
 (let (($x693 (and (and (and (or true invalidDeref_4) (and true true)) $x685) $x692)))
 (let (($x659 (= loc_4 4)))
 (let (($x656 (= invalidDeref_4 invalidDeref_3)))
 (let (($x652 (= H_4 H_3)))
 ...
 (let (($x647 (and (and (and (or true invalidDeref_3) (and true true)) $x639) $x646)))
 (let (($x613 (= loc_3 4)))
 (let (($x609 (= invalidDeref_3 invalidDeref_2)))
 ...
 (let (($x570 (and (or (= $p7_main01_3 $p4_main0_2) invalidDeref_2) (or $x566 invalidDeref_2))))
 (let (($x603 (and (and (and $x570 (or (= $r_main01_3 0) invalidDeref_2)) $x583) $x602)))
 (let (($x505 (= loc_2 3)))
 ...
 (let (($x662 (and (and $x527 (=> $x505 (and (and (and $x603 $x606) $x609) $x613))) (=> $x613 (and (and (and $x647 $x653) $x656) $x659)))))
 (and (and $x662 (=> $x659 (and (and (and $x693 $x699) $x702) $x705))) invalidDeref_5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
