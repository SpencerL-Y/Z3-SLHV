...
(assert
 (let (($x505 (= loc_2 3)))
 (let (($x598 (= invalidFree_2 invalidFree_1)))
 (let (($x520 (= H_2 H_1)))
 ...
 (let (($x596 (and (and (and (or true invalidFree_1) (and true true)) $x515) $x498)))
 (let (($x418 (= loc_1 2)))
 (let (($x509 (and $x418 (not (= $i5_main0_1 1)))))
 (let (($x491 (and $x488 $x490)))
 (let (($x586 (= invalidFree_2 invalidFree2_2)))
 (let (($x470 (= H_2 H4_2)))
 (let (($x471 (and (and (= $p6_main0_2 $p6_main01_2) (= AH_2 AH4_2)) $x470)))
 (let (($x571 (= invalidFree2_2 invalidFree_1)))
 (let (($x572 (and invalidFree_1 $x571)))
 (let (($x433 (= H4_2 h2_2)))
 ...
 (let (($x579 (or (= $p6_main01_2 nil) (= ah4_2 (uplus AH_1 (pt $p6_main01_2 (Pt_R_1 d6_2)))))))
 (let (($x580 (and $x579 invalidFree2_2)))
 (let (($x461 (= $p6_main01_2 $p4_main0_1)))
 (let (($x583 (or $x461 invalidFree_1)))
 (let (($x588 (and (and $x583 (or (or $x580 (and $x459 $x571)) $x572)) (and $x471 $x586))))
 (let (($x431 (= $i5_main0_1 1)))
 (let (($x432 (and $x418 $x431)))
 (let (($x602 (and (=> $x432 (and (and (and $x588 $x491) $x498) $x505)) (=> $x509 (and (and (and $x596 $x521) $x598) $x505)))))
 ...
 (let (($x560 (= invalidFree_1 invalidFree1_1)))
 (let (($x396 (= H_1 H3_1)))
 (let (($x393 (= AH_1 AH3_1)))
 ...
 (let (($x536 (or $x313 invalidFree1_1)))
 ...
 (let (($x538 (= invalidFree1_1 invalidFree_0)))
 (let (($x539 (and invalidFree_0 $x538)))
 (let (($x326 (= H2_1 h1_1)))
 ...
 (let (($x546 (or (= $p2_main01_1 nil) (= ah2_1 (uplus AH1_1 (pt $p2_main01_1 (Pt_R_1 d3_1)))))))
 (let (($x547 (and $x546 invalidFree1_1)))
 (let (($x354 (= $p2_main01_1 $p1_main01_1)))
 (let (($x550 (or $x354 invalidFree_0)))
 (let (($x356 (= $p1_main01_1 $p0_main01_1)))
 (let (($x551 (or $x356 invalidFree_0)))
 ...
 (let (($x555 (and (and (and (or $x367 invalidFree_0) $x551) $x550) (or (or $x547 (and $x352 $x538)) $x539))))
 (let (($x558 (and (and (and $x555 (or $x324 invalidFree1_1)) $x536) (or $x311 invalidFree1_1))))
 (let (($x277 (= loc_0 1)))
 (let (($x566 (=> $x277 (and (and (and (and $x558 (and $x397 $x560)) $x407) $x412) $x418))))
 (let (($x530 (not invalidFree_0)))
 (let (($x279 (and (and (= H_0 emp) (= AH_0 emp)) $x277)))
 (and (and (and (and $x279 $x530) $x566) $x602) invalidFree_2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
