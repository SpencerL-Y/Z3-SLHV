...
(assert
 ...
 (let (($x1242 (= invalidFree_3 invalidFree3_3)))
 (let (($x1078 (= H_3 H10_3)))
 ...
 (let (($x1217 (or $x977 invalidFree3_3)))
 (let (($x1218 (= invalidFree3_3 invalidFree_2)))
 (let (($x1219 (and invalidFree_2 $x1218)))
 ...
 (let (($x1226 (or (= $p13_main01_3 nil) (= ah6_3 (uplus AH_2 (pt $p13_main01_3 (Pt_R_1 d11_3)))))))
 (let (($x1227 (and $x1226 invalidFree3_3)))
 (let (($x1010 (= $p13_main01_3 $p1_main0_2)))
 (let (($x1230 (or $x1010 invalidFree_2)))
 (let (($x1021 (and (= H8_3 (uplus h13_3 (pt $p12_main01_3 (Pt_R_0 l27_3)))) (= H9_3 (uplus h13_3 (pt $p12_main01_3 (Pt_R_0 nil)))))))
 (let (($x1231 (or $x1021 invalidFree_2)))
 (let (($x1033 (= $p12_main01_3 (locadd $p1_main0_2 1))))
 (let (($x1232 (or $x1033 invalidFree_2)))
 (let (($x1044 (and (= H_2 (uplus h11_3 (pt $p11_main01_3 (Pt_R_0 l25_3)))) (= H8_3 (uplus h11_3 (pt $p11_main01_3 (Pt_R_0 nil)))))))
 (let (($x1233 (or $x1044 invalidFree_2)))
 (let (($x1055 (= $p11_main01_3 $p1_main0_2)))
 (let (($x1234 (or $x1055 invalidFree_2)))
 (let (($x1239 (and (and (and (and (and $x1234 $x1233) $x1232) $x1231) $x1230) (or (or $x1227 (and $x1008 $x1218)) $x1219))))
 (let (($x1247 (and (and (and (and (and $x1239 $x1217) (and $x1079 $x1242)) $x1113) $x1117) $x1121)))
 (let (($x933 (= loc_2 3)))
 (let (($x1208 (= invalidFree_2 invalidFree_1)))
 (let (($x945 (= H_2 H_1)))
 ...
 (let (($x1206 (and (and (and (or true invalidFree_1) (and true true)) $x919) $x926)))
 (let (($x785 (= loc_1 2)))
 (let (($x937 (and $x785 (not (= $i10_main0_1 1)))))
 (let (($x1196 (= invalidFree_2 invalidFree2_2)))
 (let (($x877 (= H_2 H7_2)))
 (let (($x875 (= AH_2 AH5_2)))
 (let (($x878 (and $x875 $x877)))
 (let (($x1170 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1171 (and invalidFree1_2 $x1170)))
 (let (($x811 (= H7_2 h10_2)))
 ...
 (let (($x1178 (or (= $p9_main0_1 nil) (= ah4_2 (uplus AH4_2 (pt $p9_main0_1 (Pt_R_1 d8_2)))))))
 (let (($x1179 (and $x1178 invalidFree2_2)))
 ...
 (let (($x1190 (or (= $p7_main0_1 nil) (= ah2_2 (uplus AH_1 (pt $p7_main0_1 (Pt_R_1 d5_2)))))))
 (let (($x1191 (and $x1190 invalidFree1_2)))
 (let (($x1194 (and (or (or $x1191 (and $x871 $x1182)) $x1183) (or (or $x1179 (and $x840 $x1170)) $x1171))))
 (let (($x809 (= $i10_main0_1 1)))
 (let (($x810 (and $x785 $x809)))
 (let (($x1202 (=> $x810 (and (and (and (and $x1194 (and $x878 $x1196)) $x919) $x926) $x933))))
 (let (($x1159 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1137 (or $x669 invalidFree_0)))
 (let (($x680 (= $p3_main01_1 $p1_main01_1)))
 (let (($x1138 (or $x680 invalidFree_0)))
 ...
 (let (($x1140 (or $x693 invalidFree_0)))
 ...
 (let (($x1144 (and (and (and (or $x710 invalidFree_0) $x1140) (or $x691 invalidFree_0)) $x1138)))
 (let (($x1149 (and (and (and (and (and $x1144 $x1137) (or $x657 invalidFree_0)) $x1135) $x1134) $x1133)))
 (let (($x1155 (and (and (and (and (and $x1149 $x1132) $x1131) $x1130) (or $x582 invalidFree_0)) $x1154)))
 (let (($x525 (= loc_0 1)))
 (let (($x1127 (not invalidFree_0)))
 (let (($x527 (and (and (= H_0 emp) (= AH_0 emp)) $x525)))
 (let (($x1163 (and (and $x527 $x1127) (=> $x525 (and (and (and (and $x1155 $x777) $x782) $x1159) $x785)))))
 (let (($x1213 (and $x1163 (and $x1202 (=> $x937 (and (and (and $x1206 $x946) $x1208) $x933))))))
 (and (and $x1213 (=> $x933 $x1247)) invalidFree_3))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
