...
(assert
 (let (($x1093 (= loc_2 3)))
 (let (($x1211 (= invalidFree_2 invalidFree_1)))
 ...
 (let (($x1215 (or $x1104 invalidFree_1)))
 ...
 (let (($x1221 (and (and (and (and (and (or $x1115 invalidFree_1) $x1215) $x1125) $x1150) $x1082) $x1211)))
 (let (($x929 (= loc_1 2)))
 ...
 (let (($x1194 (or $x951 invalidFree_1)))
 (let (($x953 (= $p12_append01_2 $p11_append01_2)))
 (let (($x1195 (or $x953 invalidFree_1)))
 (let (($x962 (and (= H_1 (uplus h11_2 (pt $p10_append01_2 (Pt_R_0 l16_2)))) (= $p11_append01_2 l16_2))))
 (let (($x1196 (or $x962 invalidFree_1)))
 (let (($x974 (= $p10_append01_2 (locadd $p9_append01_2 1))))
 (let (($x1197 (or $x974 invalidFree_1)))
 (let (($x983 (and (= H_1 (uplus h9_2 (pt $p8_append01_2 (Pt_R_0 l14_2)))) (= $p9_append01_2 l14_2))))
 (let (($x1198 (or $x983 invalidFree_1)))
 (let (($x994 (= $p8_append01_2 $p2_append0_1)))
 (let (($x1199 (or $x994 invalidFree_1)))
 (let (($x1206 (and (and (and (and (and (and $x1199 $x1198) $x1197) $x1196) $x1195) $x1194) $x1205)))
 (let (($x949 (= $i7_append0_1 1)))
 (let (($x950 (and $x929 $x949)))
 (let (($x1214 (=> $x950 (and (and (and (and (and $x1206 $x1072) $x1082) $x1089) $x1211) $x1093))))
 (let (($x1189 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1164 (or $x706 invalidFree_0)))
 (let (($x717 (= $p5_append01_1 $p2_append01_1)))
 (let (($x1165 (or $x717 invalidFree_0)))
 ...
 (let (($x1176 (and (and (and (or $x810 invalidFree_0) $x1172) $x1171) (or $x777 invalidFree_0))))
 (let (($x1182 (and (and (and (and (and (and $x1176 $x1169) $x1168) $x1167) $x1166) $x1165) $x1164)))
 (let (($x1190 (and (and (and (and (and $x1182 (or $x697 invalidFree_0)) $x1184) $x917) $x926) $x1189)))
 (let (($x646 (= loc_0 1)))
 (let (($x1161 (not invalidFree_0)))
 (let (($x648 (and (and (= H_0 emp) (= AH_0 emp)) $x646)))
 (let (($x1225 (and (and (and $x648 $x1161) (=> $x646 (and $x1190 $x929))) (and $x1214 (=> $x1103 (and $x1221 $x1093))))))
 (and $x1225 invalidFree_2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
