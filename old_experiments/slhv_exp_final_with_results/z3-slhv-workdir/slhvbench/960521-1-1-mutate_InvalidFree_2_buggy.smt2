...
(assert
 ...
 (let (($x1441 (= invalidFree_2 invalidFree4_2)))
 (let (($x1271 (= H_2 H7_2)))
 ...
 (let (($x1408 (= invalidFree4_2 invalidFree3_2)))
 (let (($x1409 (and invalidFree3_2 $x1408)))
 (let (($x1181 (= H7_2 h8_2)))
 ...
 (let (($x1416 (or (= $p23_main01_2 nil) (= ah8_2 (uplus AH5_2 (pt $p23_main01_2 (Pt_R_1 d34_2)))))))
 (let (($x1417 (and $x1416 invalidFree4_2)))
 (let (($x1215 (= $p23_main01_2 $p22_main01_2)))
 (let (($x1420 (or $x1215 invalidFree3_2)))
 (let (($x1217 (= $p22_main01_2 $M.2_1)))
 (let (($x1421 (or $x1217 invalidFree3_2)))
 (let (($x1422 (= invalidFree3_2 invalidFree_1)))
 (let (($x1423 (and invalidFree_1 $x1422)))
 (let (($x1219 (= H6_2 h7_2)))
 ...
 (let (($x1430 (or (= $p21_main01_2 nil) (= ah6_2 (uplus AH_1 (pt $p21_main01_2 (Pt_R_1 d28_2)))))))
 (let (($x1431 (and $x1430 invalidFree3_2)))
 (let (($x1253 (= $p21_main01_2 $p20_main01_2)))
 (let (($x1434 (or $x1253 invalidFree_1)))
 (let (($x1255 (= $p20_main01_2 $M.1_1)))
 (let (($x1435 (or $x1255 invalidFree_1)))
 (let (($x1438 (and (and (and $x1435 $x1434) (or (or $x1431 (and $x1251 $x1422)) $x1423)) $x1421)))
 (let (($x1443 (and (and (and $x1438 $x1420) (or (or $x1417 (and $x1213 $x1408)) $x1409)) (and $x1272 $x1441))))
 (let (($x936 (= loc_1 2)))
 ...
 (let (($x1395 (= invalidFree_2 invalidFree2_2)))
 (let (($x1066 (= H_2 H5_2)))
 ...
 (let (($x1361 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1362 (and invalidFree1_2 $x1361)))
 (let (($x970 (= H5_2 h6_2)))
 ...
 (let (($x1369 (or (= $p19_main01_2 nil) (= ah4_2 (uplus AH3_2 (pt $p19_main01_2 (Pt_R_1 d22_2)))))))
 (let (($x1370 (and $x1369 invalidFree2_2)))
 (let (($x1004 (= $p19_main01_2 $p18_main01_2)))
 (let (($x1373 (or $x1004 invalidFree1_2)))
 (let (($x1006 (= $p18_main01_2 $M.2_1)))
 (let (($x1374 (or $x1006 invalidFree1_2)))
 (let (($x1375 (= invalidFree1_2 invalidFree_1)))
 (let (($x1376 (and invalidFree_1 $x1375)))
 (let (($x1008 (= H4_2 h5_2)))
 ...
 (let (($x1383 (or (= $p17_main01_2 nil) (= ah2_2 (uplus AH_1 (pt $p17_main01_2 (Pt_R_1 d16_2)))))))
 (let (($x1384 (and $x1383 invalidFree1_2)))
 (let (($x1042 (= $p17_main01_2 $p16_main01_2)))
 (let (($x1387 (or $x1042 invalidFree_1)))
 (let (($x1044 (= $p16_main01_2 $M.1_1)))
 (let (($x1388 (or $x1044 invalidFree_1)))
 (let (($x1391 (and (and (and $x1388 $x1387) (or (or $x1384 (and $x1040 $x1375)) $x1376)) $x1374)))
 (let (($x1397 (and (and (and $x1391 $x1373) (or (or $x1370 (and $x1002 $x1361)) $x1362)) (and $x1067 $x1395))))
 (let (($x968 (= $i15_main0_1 1)))
 (let (($x969 (and $x936 $x968)))
 (let (($x1448 (and (=> $x969 (and (and (and $x1397 $x1111) $x1142) $x1148)) (=> $x1180 (and (and (and $x1443 $x1286) $x1142) $x1148)))))
 (let (($x1350 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1309 (or $x761 invalidFree_0)))
 (let (($x763 (= $i6_main01_1 3)))
 (let (($x1310 (or $x763 invalidFree_0)))
 (let (($x765 (= $i5_main01_1 $M.02_1)))
 (let (($x1311 (or $x765 invalidFree_0)))
 (let (($x767 (= $M.12_1 $p3_main01_1)))
 (let (($x1312 (or $x767 invalidFree_0)))
 (let (($x769 (= $p4_main01_1 $p3_main01_1)))
 (let (($x1313 (or $x769 invalidFree_0)))
 ...
 (let (($x1315 (or $x794 invalidFree_0)))
 (let (($x796 (= $i1_main01_1 3)))
 (let (($x1316 (or $x796 invalidFree_0)))
 (let (($x798 (= $i0_main01_1 $M.02_1)))
 (let (($x1317 (or $x798 invalidFree_0)))
 (let (($x800 (= $M.02_1 3)))
 (let (($x1318 (or $x800 invalidFree_0)))
 (let (($x802 (= $M.21_1 nil)))
 (let (($x1319 (or $x802 invalidFree_0)))
 (let (($x804 (= $M.11_1 nil)))
 (let (($x1320 (or $x804 invalidFree_0)))
 (let (($x806 (= $M.01_1 0)))
 (let (($x1321 (or $x806 invalidFree_0)))
 (let (($x1327 (and (and (and (and (and (and $x1321 $x1320) $x1319) $x1318) $x1317) $x1316) $x1315)))
 (let (($x1332 (and (and (and (and (and $x1327 (or $x792 invalidFree_0)) $x1313) $x1312) $x1311) $x1310)))
 (let (($x1337 (and (and (and (and (and $x1332 $x1309) (or $x759 invalidFree_0)) $x1307) $x1306) $x1305)))
 (let (($x1343 (and (and (and (and (and (and $x1337 $x1304) $x1303) $x1302) $x1301) $x1300) $x1299)))
 (let (($x1351 (and (and (and (and (and $x1343 (or $x682 invalidFree_0)) $x1345) $x928) $x933) $x1350)))
 (let (($x621 (= loc_0 1)))
 (let (($x1296 (not invalidFree_0)))
 (let (($x623 (and (and (= H_0 emp) (= AH_0 emp)) $x621)))
 (and (and (and (and $x623 $x1296) (=> $x621 (and $x1351 $x936))) $x1448) invalidFree_2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
