...
(assert
 (let (($x918 (or (= H_2 (uplus h11 (pt l25 (Pt_R_0 l26)))) (= H_2 (uplus h11 (pt l25 (Pt_R_1 d9)))))))
 (let (($x927 (and (and false $x918) (= AH_2 (uplus ah5 (pt l27 (Pt_R_1 d10)))))))
 (let (($x687 (= loc_2 3)))
 ...
 (let (($x777 (and (= AH_2 AH5_2) (= H_2 H7_2))))
 ...
 (let (($x903 (=> $x711 (and (and (and (and (and $x772 $x741) $x778) $x666) $x673) $x687))))
 (let (($x679 (= H_2 H_1)))
 (let (($x680 (and (and true (= AH_2 AH_1)) $x679)))
 (let (($x632 (= $i10_main0_1 1)))
 (let (($x633 (and $x628 $x632)))
 (let (($x897 (=> $x633 (and (and (and (and (and true true) $x666) $x673) $x680) $x687))))
 ...
 (let (($x881 (and (and (and (and (and (and $x566 $x549) $x547) $x536) $x525) $x513) $x502)))
 (let (($x887 (and (and (and (and (and (and $x881 $x491) $x479) $x468) $x459) $x447) $x438)))
 (let (($x381 (= loc_0 1)))
 (let (($x383 (and (and (= H_0 emp) (= AH_0 emp)) $x381)))
 (let (($x905 (and (and $x383 (=> $x381 (and (and (and $x887 $x816) $x625) $x628))) (and $x897 $x903))))
 (and $x905 $x927)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
