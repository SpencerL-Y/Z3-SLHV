...
(assert
 (let (($x911 (= loc_1 2)))
 (let (($x930 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x919 (or $x761 invalidFree_0)))
 (let (($x763 (= $p1_main01_1 $p0_main01_1)))
 (let (($x920 (or $x763 invalidFree_0)))
 ...
 (let (($x776 (= $M.01_1 nil)))
 (let (($x922 (or $x776 invalidFree_0)))
 (let (($x927 (and (and (and (and (and $x922 (or $x774 invalidFree_0)) $x920) $x919) $x795) $x884)))
 (let (($x747 (= loc_0 1)))
 (let (($x917 (not invalidFree_0)))
 (let (($x749 (and (and (= H_0 emp) (= AH_0 emp)) $x747)))
 (let (($x934 (and (and $x749 $x917) (=> $x747 (and (and (and $x927 $x905) $x930) $x911)))))
 (and $x934 invalidFree_1)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
