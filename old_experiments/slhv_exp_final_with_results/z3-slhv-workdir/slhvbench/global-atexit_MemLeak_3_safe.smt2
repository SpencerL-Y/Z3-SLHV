...
(assert
 (let (($x581 (= AH_3 (uplus ah1 (pt l7 (Pt_R_1 d4))))))
 (let (($x574 (or (= H_3 (uplus h3 (pt l5 (Pt_R_0 l6)))) (= H_3 (uplus h3 (pt l5 (Pt_R_1 d3)))))))
 (let (($x582 (and (or (or (= loc_3 3) (= loc_3 5)) (= loc_3 6)) $x574)))
 (let (($x435 (= loc_3 6)))
 (let (($x399 (= H_3 H_2)))
 ...
 (let (($x557 (=> $x424 (and (and (and (and (and $x425 $x428) $x377) $x390) $x400) $x435))))
 (let (($x418 (= loc_3 5)))
 (let (($x392 (= $r_main0_3 $r_main0_2)))
 (let (($x393 (and $x390 $x392)))
 (let (($x549 (and (and (and (and (and false (and true true)) $x377) $x393) $x400) $x418)))
 (let (($x409 (= $i0_h0_2 1)))
 (let (($x410 (and $x353 $x409)))
 (let (($x406 (= loc_3 3)))
 (let (($x280 (= loc_2 3)))
 (let (($x545 (=> $x280 (and (and (and (and (and true true) $x377) $x393) $x400) $x406))))
 ...
 (let (($x536 (and (and (and (and (and (and $x331 $x320) $x318) $x307) $x477) $x349) $x266)))
 (let (($x224 (= loc_1 2)))
 ...
 (let (($x525 (and false $x231)))
 (let (($x228 (= $i3_main0_1 1)))
 (let (($x229 (and $x224 $x228)))
 (let (($x539 (and (=> $x229 (and (and (and (and $x525 $x250) $x266) $x273) $x280)) (=> $x296 (and $x536 $x353)))))
 ...
 (let (($x165 (= $M.01_1 nil)))
 (let (($x521 (and (and (and (and (and (and $x165 $x163) $x152) $x150) $x184) $x197) $x218)))
 (let (($x136 (= loc_0 1)))
 (let (($x138 (and (and (= H_0 emp) (= AH_0 emp)) $x136)))
 (let (($x559 (and (and (and $x138 (=> $x136 (and $x521 $x224))) $x539) (and (and $x545 (=> $x410 $x549)) $x557))))
 (and $x559 (and $x582 $x581)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
