...
(assert
 ...
 (let (($x1075 (= invalidFree_2 invalidFree3_2)))
 (let (($x944 (= H_2 H6_2)))
 (let (($x942 (= AH_2 AH5_2)))
 ...
 (let (($x840 (= $M.04_2 nil)))
 (let (($x1038 (or $x840 invalidFree3_2)))
 (let (($x1039 (= invalidFree3_2 invalidFree2_2)))
 (let (($x1040 (and invalidFree2_2 $x1039)))
 (let (($x842 (= H6_2 h7_2)))
 ...
 (let (($x1047 (or (= $p17_main01_2 nil) (= ah6_2 (uplus AH4_2 (pt $p17_main01_2 (Pt_R_1 d14_2)))))))
 (let (($x1048 (and $x1047 invalidFree3_2)))
 (let (($x870 (= $p17_main01_2 $p16_main01_2)))
 (let (($x1051 (or $x870 invalidFree2_2)))
 (let (($x872 (= $p16_main01_2 $M.0_1)))
 (let (($x1052 (or $x872 invalidFree2_2)))
 (let (($x1053 (= invalidFree2_2 invalidFree_1)))
 (let (($x1054 (and invalidFree_1 $x1053)))
 (let (($x874 (= H5_2 h6_2)))
 ...
 (let (($x1061 (or (= $p15_main01_2 nil) (= ah4_2 (uplus AH_1 (pt $p15_main01_2 (Pt_R_1 d10_2)))))))
 (let (($x1062 (and $x1061 invalidFree2_2)))
 (let (($x902 (= $p15_main01_2 $p14_main01_2)))
 (let (($x1065 (or $x902 invalidFree_1)))
 (let (($x911 (and (= H_1 (uplus h4_2 (pt $p13_main01_2 (Pt_R_0 l7_2)))) (= $p14_main01_2 l7_2))))
 (let (($x1066 (or $x911 invalidFree_1)))
 (let (($x922 (= $p13_main01_2 $M.0_1)))
 (let (($x1067 (or $x922 invalidFree_1)))
 (let (($x1070 (and (and (and $x1067 $x1066) $x1065) (or (or $x1062 (and $x900 $x1053)) $x1054))))
 (let (($x1073 (and (and (and $x1070 $x1052) $x1051) (or (or $x1048 (and $x868 $x1039)) $x1040))))
 (let (($x1080 (and (and (and (and (and $x1073 $x1038) (and $x945 $x1075)) $x958) $x962) $x965)))
 (let (($x666 (= loc_1 2)))
 ...
 (let (($x1025 (= invalidFree_2 invalidFree1_2)))
 (let (($x752 (= H_2 H4_2)))
 (let (($x749 (= AH_2 AH3_2)))
 ...
 (let (($x1003 (or $x693 invalidFree1_2)))
 (let (($x695 (= $M.03_2 nil)))
 (let (($x1004 (or $x695 invalidFree1_2)))
 (let (($x1005 (= invalidFree1_2 invalidFree_1)))
 (let (($x1006 (and invalidFree_1 $x1005)))
 (let (($x697 (= H4_2 h3_2)))
 ...
 (let (($x1013 (or (= $p7_main01_2 nil) (= ah2_2 (uplus AH_1 (pt $p7_main01_2 (Pt_R_1 d6_2)))))))
 (let (($x1014 (and $x1013 invalidFree1_2)))
 (let (($x725 (= $p7_main01_2 $p6_main01_2)))
 (let (($x1017 (or $x725 invalidFree_1)))
 (let (($x727 (= $p6_main01_2 $M.0_1)))
 (let (($x1018 (or $x727 invalidFree_1)))
 (let (($x1021 (and (and (and $x1018 $x1017) (or (or $x1014 (and $x723 $x1005)) $x1006)) $x1004)))
 (let (($x1027 (and (and (and $x1021 $x1003) (or $x691 invalidFree1_2)) (and $x753 $x1025))))
 (let (($x683 (= $i5_main0_1 1)))
 (let (($x684 (and $x666 $x683)))
 (let (($x1082 (and (=> $x684 (and (and (and $x1027 $x794) $x801) $x808)) (=> $x839 $x1080))))
 (let (($x994 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x974 (or $x530 invalidFree_0)))
 (let (($x541 (= $p4_main01_1 $M.02_1)))
 (let (($x975 (or $x541 invalidFree_0)))
 (let (($x543 (= $p3_main01_1 $p2_main01_1)))
 (let (($x976 (or $x543 invalidFree_0)))
 ...
 (let (($x978 (or $x556 invalidFree_0)))
 (let (($x558 (= $p1_main01_1 $p0_main01_1)))
 (let (($x979 (or $x558 invalidFree_0)))
 ...
 (let (($x571 (= $M.01_1 nil)))
 (let (($x981 (or $x571 invalidFree_0)))
 (let (($x985 (and (and (and (and $x981 (or $x569 invalidFree_0)) $x979) $x978) (or $x554 invalidFree_0))))
 (let (($x992 (and (and (and (and (and (and $x985 $x976) $x975) $x974) $x989) $x650) $x663)))
 (let (($x494 (= loc_0 1)))
 (let (($x972 (not invalidFree_0)))
 (let (($x496 (and (and (= H_0 emp) (= AH_0 emp)) $x494)))
 (let (($x1083 (and (and (and $x496 $x972) (=> $x494 (and (and $x992 $x994) $x666))) $x1082)))
 (and $x1083 invalidFree_2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
