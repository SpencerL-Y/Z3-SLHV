...
(assert
 (let (($x1309 (= AH_5 (uplus ah7 (pt l32 (Pt_R_1 d13))))))
 (let (($x1302 (or (= H_5 (uplus h12 (pt l30 (Pt_R_0 l31)))) (= H_5 (uplus h12 (pt l30 (Pt_R_1 d12)))))))
 (let (($x1093 (= loc_5 4)))
 (let (($x1086 (= H_5 H_4)))
 ...
 (let (($x763 (= loc_2 3)))
 (let (($x1276 (=> $x763 (and (and (and (and (and $x921 $x925) $x959) $x963) $x970) $x977))))
 ...
 (let (($x1266 (and (and (and (and (and (and $x892 $x861) $x830) $x828) $x902) $x912) $x749)))
 (let (($x701 (= loc_1 2)))
 ...
 (let (($x1269 (and (=> $x706 (and (and (and (and $x708 $x742) $x749) $x756) $x763)) (=> $x798 (and $x1266 $x763)))))
 ...
 (let (($x1243 (and (and (and (and (and (and $x634 $x617) $x615) $x604) $x593) $x581) $x570)))
 (let (($x1249 (and (and (and (and (and (and $x1243 $x559) $x547) $x536) $x527) $x515) $x506)))
 (let (($x449 (= loc_0 1)))
 (let (($x451 (and (and (= H_0 emp) (= AH_0 emp)) $x449)))
 (let (($x1255 (and $x451 (=> $x449 (and (and (and (and $x1249 $x1126) $x693) $x698) $x701)))))
 (let (($x1283 (and (and (and $x1255 $x1269) $x1276) (=> $x977 (and (and (and (and $x708 $x1015) $x1022) $x1029) $x1035)))))
 (let (($x1289 (and $x1283 (=> $x1035 (and (and (and (and $x708 $x1073) $x1080) $x1087) $x1093)))))
 (and $x1289 (and (and $x1093 $x1302) $x1309)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
