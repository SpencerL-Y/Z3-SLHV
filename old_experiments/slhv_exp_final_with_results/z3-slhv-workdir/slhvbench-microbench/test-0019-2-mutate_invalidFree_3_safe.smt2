...
(assert
 (let (($x999 (= loc_3 4)))
 (let (($x1107 (= invalidFree_3 invalidFree_2)))
 (let (($x994 (= AH_3 AH_2)))
 ...
 (let (($x1084 (and (and (and (or true invalidFree_1) (and true true)) $x845) $x852)))
 (let (($x714 (= loc_1 2)))
 (let (($x863 (and $x714 (not (= $i10_main0_1 1)))))
 (let (($x1074 (= invalidFree_2 invalidFree2_2)))
 (let (($x806 (= H_2 H7_2)))
 (let (($x804 (= AH_2 AH5_2)))
 (let (($x807 (and $x804 $x806)))
 (let (($x1048 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1049 (and invalidFree1_2 $x1048)))
 (let (($x740 (= H7_2 h10_2)))
 ...
 (let (($x1056 (or (= $p9_main0_1 nil) (= ah4_2 (uplus AH4_2 (pt $p9_main0_1 (Pt_R_1 d8_2)))))))
 (let (($x1057 (and $x1056 invalidFree2_2)))
 (let (($x1060 (= invalidFree1_2 invalidFree_1)))
 (let (($x1061 (and invalidFree_1 $x1060)))
 (let (($x771 (= H6_2 h9_2)))
 ...
 (let (($x1068 (or (= $p7_main0_1 nil) (= ah2_2 (uplus AH_1 (pt $p7_main0_1 (Pt_R_1 d5_2)))))))
 (let (($x1069 (and $x1068 invalidFree1_2)))
 (let (($x1072 (and (or (or $x1069 (and $x800 $x1060)) $x1061) (or (or $x1057 (and $x769 $x1048)) $x1049))))
 (let (($x738 (= $i10_main0_1 1)))
 (let (($x739 (and $x714 $x738)))
 (let (($x1080 (=> $x739 (and (and (and (and $x1072 (and $x807 $x1074)) $x845) $x852) $x859))))
 (let (($x1037 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1015 (or $x602 invalidFree_0)))
 (let (($x613 (= $p3_main01_1 $p1_main01_1)))
 (let (($x1016 (or $x613 invalidFree_0)))
 ...
 (let (($x1018 (or $x626 invalidFree_0)))
 ...
 (let (($x1022 (and (and (and (or $x643 invalidFree_0) $x1018) (or $x624 invalidFree_0)) $x1016)))
 (let (($x1027 (and (and (and (and (and $x1022 $x1015) (or $x590 invalidFree_0)) $x1013) $x1012) $x1011)))
 (let (($x1033 (and (and (and (and (and $x1027 $x1010) $x1009) $x1008) (or $x515 invalidFree_0)) $x1032)))
 (let (($x458 (= loc_0 1)))
 (let (($x1005 (not invalidFree_0)))
 (let (($x460 (and (and (= H_0 emp) (= AH_0 emp)) $x458)))
 (let (($x1041 (and (and $x460 $x1005) (=> $x458 (and (and (and (and $x1033 $x706) $x711) $x1037) $x714)))))
 (let (($x1091 (and $x1041 (and $x1080 (=> $x863 (and (and (and $x1084 $x872) $x1086) $x859))))))
 (let (($x1111 (and $x1091 (=> $x859 (and (and (and (and $x1103 $x991) $x995) $x1107) $x999)))))
 (and $x1111 invalidFree_3)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
