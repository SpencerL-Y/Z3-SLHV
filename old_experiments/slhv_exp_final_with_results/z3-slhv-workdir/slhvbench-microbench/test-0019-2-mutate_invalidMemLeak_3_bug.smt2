...
(assert
 (let (($x1174 (= AH_3 (uplus ah5 (pt l31 (Pt_R_1 d10))))))
 (let (($x1167 (or (= H_3 (uplus h15 (pt l29 (Pt_R_0 l30)))) (= H_3 (uplus h15 (pt l29 (Pt_R_1 d9)))))))
 (let (($x999 (= loc_3 4)))
 (let (($x994 (= AH_3 AH_2)))
 ...
 (let (($x1149 (and (and (and (and (and (and $x937 $x926) $x915) $x903) $x892) $x1101) $x987)))
 (let (($x859 (= loc_2 3)))
 (let (($x871 (= H_2 H_1)))
 ...
 (let (($x1136 (=> $x739 (and (and (and (and (and $x800 $x769) $x808) $x845) $x852) $x859))))
 (let (($x1142 (and $x1136 (=> $x863 (and (and (and (and $x865 $x845) $x852) $x872) $x859)))))
 ...
 (let (($x1118 (and (and (and (and (and (and $x643 $x626) $x624) $x613) $x602) $x590) $x579)))
 (let (($x1124 (and (and (and (and (and (and $x1118 $x568) $x556) $x545) $x536) $x524) $x515)))
 (let (($x458 (= loc_0 1)))
 (let (($x460 (and (and (= H_0 emp) (= AH_0 emp)) $x458)))
 (let (($x1130 (and $x460 (=> $x458 (and (and (and (and $x1124 $x1032) $x706) $x711) $x714)))))
 (let (($x1154 (and (and $x1130 $x1142) (=> $x859 (and (and (and $x1149 $x991) $x995) $x999)))))
 (and $x1154 (and (and $x999 $x1167) $x1174)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
