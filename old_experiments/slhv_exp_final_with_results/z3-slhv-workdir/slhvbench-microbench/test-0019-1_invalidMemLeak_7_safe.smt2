...
(assert
 (let (($x1459 (= AH_7 (uplus ah7 (pt l32 (Pt_R_1 d13))))))
 (let (($x1452 (or (= H_7 (uplus h12 (pt l30 (Pt_R_0 l31)))) (= H_7 (uplus h12 (pt l30 (Pt_R_1 d12)))))))
 (let (($x1209 (= loc_7 4)))
 (let (($x1202 (= H_7 H_6)))
 ...
 (let (($x763 (= loc_2 3)))
 (let (($x1414 (=> $x763 (and (and (and (and (and $x921 $x925) $x959) $x963) $x970) $x977))))
 ...
 (let (($x1404 (and (and (and (and (and (and $x892 $x861) $x830) $x828) $x902) $x912) $x749)))
 (let (($x701 (= loc_1 2)))
 ...
 (let (($x1407 (and (=> $x706 (and (and (and (and $x708 $x742) $x749) $x756) $x763)) (=> $x798 (and $x1404 $x763)))))
 ...
 (let (($x1381 (and (and (and (and (and (and $x634 $x617) $x615) $x604) $x593) $x581) $x570)))
 (let (($x1387 (and (and (and (and (and (and $x1381 $x559) $x547) $x536) $x527) $x515) $x506)))
 (let (($x449 (= loc_0 1)))
 (let (($x451 (and (and (= H_0 emp) (= AH_0 emp)) $x449)))
 (let (($x1393 (and $x451 (=> $x449 (and (and (and (and $x1387 $x1242) $x693) $x698) $x701)))))
 (let (($x1421 (and (and (and $x1393 $x1407) $x1414) (=> $x977 (and (and (and (and $x708 $x1015) $x1022) $x1029) $x1035)))))
 (let (($x1427 (and $x1421 (=> $x1035 (and (and (and (and $x708 $x1073) $x1080) $x1087) $x1093)))))
 (let (($x1433 (and $x1427 (=> $x1093 (and (and (and (and $x708 $x1131) $x1138) $x1145) $x1151)))))
 (let (($x1439 (and $x1433 (=> $x1151 (and (and (and (and $x708 $x1189) $x1196) $x1203) $x1209)))))
 (and $x1439 (and (and $x1209 $x1452) $x1459)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
