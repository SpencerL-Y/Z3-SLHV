...
(assert
 (let (($x1276 (= loc_1 2)))
 (let (($x1292 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1284 (or $x1078 invalidFree_0)))
 ...
 (let (($x1293 (and (and (and (and (and (or $x1098 invalidFree_0) $x1284) $x1287) $x1244) $x1273) $x1292)))
 (let (($x1053 (= loc_0 1)))
 (let (($x1282 (not invalidFree_0)))
 (let (($x1055 (and (and (= H_0 emp) (= AH_0 emp)) $x1053)))
 (and (and (and $x1055 $x1282) (=> $x1053 (and $x1293 $x1276))) invalidFree_1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
