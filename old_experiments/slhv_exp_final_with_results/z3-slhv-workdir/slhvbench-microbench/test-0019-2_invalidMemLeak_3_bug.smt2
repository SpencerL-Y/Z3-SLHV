...
(assert
 (let (($x1314 (= AH_3 (uplus ah7 (pt l36 (Pt_R_1 d13))))))
 (let (($x1307 (or (= H_3 (uplus h16 (pt l34 (Pt_R_0 l35)))) (= H_3 (uplus h16 (pt l34 (Pt_R_1 d12)))))))
 (let (($x1121 (= loc_3 4)))
 ...
 (let (($x1287 (and (and (and (and (and (and $x1055 $x1044) $x1033) $x1021) $x1010) $x1008) $x977)))
 (let (($x933 (= loc_2 3)))
 (let (($x1293 (=> $x933 (and (and (and (and $x1287 (and $x1079 true)) $x1113) $x1117) $x1121))))
 (let (($x945 (= H_2 H_1)))
 ...
 (let (($x1274 (=> $x810 (and (and (and (and (and $x871 $x840) $x879) $x919) $x926) $x933))))
 (let (($x1280 (and $x1274 (=> $x937 (and (and (and (and $x939 $x919) $x926) $x946) $x933)))))
 ...
 (let (($x1256 (and (and (and (and (and (and $x710 $x693) $x691) $x680) $x669) $x657) $x646)))
 (let (($x1262 (and (and (and (and (and (and $x1256 $x635) $x623) $x612) $x603) $x591) $x582)))
 (let (($x525 (= loc_0 1)))
 (let (($x527 (and (and (= H_0 emp) (= AH_0 emp)) $x525)))
 (let (($x1268 (and $x527 (=> $x525 (and (and (and (and $x1262 $x1154) $x777) $x782) $x785)))))
 (and (and (and $x1268 $x1280) $x1293) (and (and $x1121 $x1307) $x1314)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
