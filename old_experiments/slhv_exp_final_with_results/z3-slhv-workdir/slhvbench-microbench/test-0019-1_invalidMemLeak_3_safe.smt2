...
(assert
 (let (($x1159 (= AH_3 (uplus ah7 (pt l32 (Pt_R_1 d13))))))
 (let (($x1152 (or (= H_3 (uplus h12 (pt l30 (Pt_R_0 l31)))) (= H_3 (uplus h12 (pt l30 (Pt_R_1 d12)))))))
 (let (($x977 (= loc_3 4)))
 (let (($x969 (= H_3 H_2)))
 ...
 (let (($x763 (= loc_2 3)))
 (let (($x1138 (=> $x763 (and (and (and (and (and $x921 $x925) $x959) $x963) $x970) $x977))))
 ...
 (let (($x1128 (and (and (and (and (and (and $x892 $x861) $x830) $x828) $x902) $x912) $x749)))
 (let (($x701 (= loc_1 2)))
 ...
 (let (($x1131 (and (=> $x706 (and (and (and (and $x708 $x742) $x749) $x756) $x763)) (=> $x798 (and $x1128 $x763)))))
 ...
 (let (($x1105 (and (and (and (and (and (and $x634 $x617) $x615) $x604) $x593) $x581) $x570)))
 (let (($x1111 (and (and (and (and (and (and $x1105 $x559) $x547) $x536) $x527) $x515) $x506)))
 (let (($x449 (= loc_0 1)))
 (let (($x451 (and (and (= H_0 emp) (= AH_0 emp)) $x449)))
 (let (($x1117 (and $x451 (=> $x449 (and (and (and (and $x1111 $x1010) $x693) $x698) $x701)))))
 (and (and (and $x1117 $x1131) $x1138) (and (and $x977 $x1152) $x1159)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
