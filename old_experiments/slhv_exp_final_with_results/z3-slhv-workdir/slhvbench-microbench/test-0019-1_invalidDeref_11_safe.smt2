...
(assert
 (let (($x1441 (= loc_11 4)))
 (let (($x1438 (= invalidDeref_11 invalidDeref_10)))
 (let (($x1434 (= H_11 H_10)))
 ...
 (let (($x1429 (and (and (and (or true invalidDeref_10) (and true true)) $x1421) $x1428)))
 (let (($x1383 (= loc_10 4)))
 (let (($x1380 (= invalidDeref_10 invalidDeref_9)))
 (let (($x1376 (= H_10 H_9)))
 ...
 (let (($x1371 (and (and (and (or true invalidDeref_9) (and true true)) $x1363) $x1370)))
 (let (($x1325 (= loc_9 4)))
 (let (($x1322 (= invalidDeref_9 invalidDeref_8)))
 (let (($x1318 (= H_9 H_8)))
 ...
 (let (($x1313 (and (and (and (or true invalidDeref_8) (and true true)) $x1305) $x1312)))
 (let (($x1267 (= loc_8 4)))
 (let (($x1264 (= invalidDeref_8 invalidDeref_7)))
 (let (($x1260 (= H_8 H_7)))
 ...
 (let (($x1255 (and (and (and (or true invalidDeref_7) (and true true)) $x1247) $x1254)))
 (let (($x1209 (= loc_7 4)))
 ...
 (let (($x1270 (and (and $x1154 (=> $x1151 (and (and (and $x1197 $x1203) $x1206) $x1209))) (=> $x1209 (and (and (and $x1255 $x1261) $x1264) $x1267)))))
 (let (($x1386 (and (and $x1270 (=> $x1267 (and (and (and $x1313 $x1319) $x1322) $x1325))) (=> $x1325 (and (and (and $x1371 $x1377) $x1380) $x1383)))))
 (and (and $x1386 (=> $x1383 (and (and (and $x1429 $x1435) $x1438) $x1441))) invalidDeref_11)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
