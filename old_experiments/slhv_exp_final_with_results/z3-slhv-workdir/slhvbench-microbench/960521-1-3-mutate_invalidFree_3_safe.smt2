...
(assert
 (let (($x1447 (= loc_3 4)))
 (let (($x1617 (= invalidFree_3 invalidFree_2)))
 (let (($x1439 (= H_3 H_2)))
 ...
 (let (($x1611 (or $x1340 invalidFree_2)))
 (let (($x1619 (and (and (and (and (and (and $x1611 $x1344) $x1405) $x1433) $x1440) $x1617) $x1447)))
 (let (($x1184 (= loc_2 3)))
 ...
 (let (($x1602 (= invalidFree_2 invalidFree4_2)))
 (let (($x1314 (= H_2 H7_2)))
 ...
 (let (($x1567 (= invalidFree4_2 invalidFree3_2)))
 (let (($x1568 (and invalidFree3_2 $x1567)))
 (let (($x1218 (= H7_2 h8_2)))
 ...
 (let (($x1575 (or (= $p25_main01_2 nil) (= ah8_2 (uplus AH5_2 (pt $p25_main01_2 (Pt_R_1 d34_2)))))))
 (let (($x1576 (and $x1575 invalidFree4_2)))
 (let (($x1252 (= $p25_main01_2 $p24_main01_2)))
 (let (($x1579 (or $x1252 invalidFree3_2)))
 (let (($x1255 (= $p24_main01_2 (locadd $p23_main01_2 (- 1)))))
 (let (($x1580 (or $x1255 invalidFree3_2)))
 (let (($x1257 (= $p23_main01_2 $M.2_1)))
 (let (($x1581 (or $x1257 invalidFree3_2)))
 (let (($x1582 (= invalidFree3_2 invalidFree_1)))
 (let (($x1583 (and invalidFree_1 $x1582)))
 (let (($x1259 (= H6_2 h7_2)))
 ...
 (let (($x1590 (or (= $p22_main01_2 nil) (= ah6_2 (uplus AH_1 (pt $p22_main01_2 (Pt_R_1 d28_2)))))))
 (let (($x1591 (and $x1590 invalidFree3_2)))
 (let (($x1293 (= $p22_main01_2 $p21_main01_2)))
 (let (($x1594 (or $x1293 invalidFree_1)))
 (let (($x1295 (= $p21_main01_2 $M.1_1)))
 (let (($x1595 (or $x1295 invalidFree_1)))
 (let (($x1598 (and (and (and $x1595 $x1594) (or (or $x1591 (and $x1291 $x1582)) $x1583)) $x1581)))
 (let (($x1601 (and (and (and $x1598 $x1580) $x1579) (or (or $x1576 (and $x1250 $x1567)) $x1568))))
 (let (($x961 (= loc_1 2)))
 (let (($x1217 (and $x961 (not (= $i15_main0_1 1)))))
 (let (($x1608 (=> $x1217 (and (and (and (and $x1601 (and $x1315 $x1602)) $x1331) $x1178) $x1184))))
 ...
 (let (($x1554 (= invalidFree_2 invalidFree2_2)))
 (let (($x1099 (= H_2 H5_2)))
 ...
 (let (($x1518 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1519 (and invalidFree1_2 $x1518)))
 (let (($x996 (= H5_2 h6_2)))
 ...
 (let (($x1526 (or (= $p20_main01_2 nil) (= ah4_2 (uplus AH3_2 (pt $p20_main01_2 (Pt_R_1 d22_2)))))))
 (let (($x1527 (and $x1526 invalidFree2_2)))
 (let (($x1030 (= $p20_main01_2 $p19_main01_2)))
 (let (($x1530 (or $x1030 invalidFree1_2)))
 (let (($x1033 (= $p19_main01_2 (locadd $p18_main01_2 (- 1)))))
 (let (($x1531 (or $x1033 invalidFree1_2)))
 (let (($x1035 (= $p18_main01_2 $M.2_1)))
 (let (($x1532 (or $x1035 invalidFree1_2)))
 (let (($x1533 (= invalidFree1_2 invalidFree_1)))
 (let (($x1534 (and invalidFree_1 $x1533)))
 (let (($x1037 (= H4_2 h5_2)))
 ...
 (let (($x1541 (or (= $p17_main01_2 nil) (= ah2_2 (uplus AH_1 (pt $p17_main01_2 (Pt_R_1 d16_2)))))))
 (let (($x1542 (and $x1541 invalidFree1_2)))
 (let (($x1071 (= $p17_main01_2 $p16_main01_2)))
 (let (($x1545 (or $x1071 invalidFree_1)))
 (let (($x1073 (= $p16_main01_2 $M.1_1)))
 (let (($x1546 (or $x1073 invalidFree_1)))
 (let (($x1549 (and (and (and $x1546 $x1545) (or (or $x1542 (and $x1069 $x1533)) $x1534)) $x1532)))
 (let (($x1552 (and (and (and $x1549 $x1531) $x1530) (or (or $x1527 (and $x1028 $x1518)) $x1519))))
 (let (($x994 (= $i15_main0_1 1)))
 (let (($x995 (and $x961 $x994)))
 (let (($x1560 (=> $x995 (and (and (and (and $x1552 (and $x1100 $x1554)) $x1147) $x1178) $x1184))))
 (let (($x1507 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1466 (or $x778 invalidFree_0)))
 (let (($x780 (= $i6_main01_1 3)))
 (let (($x1467 (or $x780 invalidFree_0)))
 (let (($x782 (= $i5_main01_1 3)))
 (let (($x1468 (or $x782 invalidFree_0)))
 (let (($x784 (= $M.12_1 $p3_main01_1)))
 (let (($x1469 (or $x784 invalidFree_0)))
 (let (($x786 (= $p4_main01_1 $p3_main01_1)))
 (let (($x1470 (or $x786 invalidFree_0)))
 ...
 (let (($x1472 (or $x811 invalidFree_0)))
 (let (($x813 (= $i1_main01_1 3)))
 (let (($x1473 (or $x813 invalidFree_0)))
 (let (($x815 (= $i0_main01_1 3)))
 (let (($x1474 (or $x815 invalidFree_0)))
 (let (($x817 (= $M.02_1 3)))
 (let (($x1475 (or $x817 invalidFree_0)))
 (let (($x819 (= $M.21_1 nil)))
 (let (($x1476 (or $x819 invalidFree_0)))
 (let (($x821 (= $M.11_1 nil)))
 (let (($x1477 (or $x821 invalidFree_0)))
 (let (($x823 (= $M.01_1 0)))
 (let (($x1478 (or $x823 invalidFree_0)))
 (let (($x1484 (and (and (and (and (and (and $x1478 $x1477) $x1476) $x1475) $x1474) $x1473) $x1472)))
 (let (($x1489 (and (and (and (and (and $x1484 (or $x809 invalidFree_0)) $x1470) $x1469) $x1468) $x1467)))
 (let (($x1494 (and (and (and (and (and $x1489 $x1466) (or $x776 invalidFree_0)) $x1464) $x1463) $x1462)))
 (let (($x1500 (and (and (and (and (and (and $x1494 $x1461) $x1460) $x1459) $x1458) $x1457) $x1456)))
 (let (($x1508 (and (and (and (and (and $x1500 (or $x699 invalidFree_0)) $x1502) $x953) $x958) $x1507)))
 (let (($x638 (= loc_0 1)))
 (let (($x1453 (not invalidFree_0)))
 (let (($x640 (and (and (= H_0 emp) (= AH_0 emp)) $x638)))
 (let (($x1610 (and (and (and $x640 $x1453) (=> $x638 (and $x1508 $x961))) (and $x1560 $x1608))))
 (and (and $x1610 (=> $x1184 $x1619)) invalidFree_3))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
