...
(assert
 (let (($x1958 (or (= H_3 (uplus h46 (pt l64 (Pt_R_0 l65)))) (= H_3 (uplus h46 (pt l64 (Pt_R_1 d12)))))))
 (let (($x1967 (and (and false $x1958) (= AH_3 (uplus ah7 (pt l66 (Pt_R_1 d13)))))))
 (let (($x1752 (= loc_3 4)))
 ...
 (let (($x1943 (=> $x1762 (and (and (and (and (and $x1774 $x1763) $x1784) $x1820) $x1741) $x1752))))
 (let (($x1747 (= H_3 H_2)))
 ...
 (let (($x1932 (and (and (and (and (and (and $x1608 $x1597) $x1588) $x1576) $x1567) $x1565) $x1884)))
 (let (($x1563 (= $i7_append0_2 1)))
 (let (($x1564 (and $x1543 $x1563)))
 (let (($x1944 (and (=> $x1564 (and (and (and (and $x1932 $x1719) $x1741) $x1748) $x1752)) $x1943)))
 ...
 (let (($x1918 (and (and (and (and (and (and $x1397 $x1395) $x1378) $x1367) $x1358) $x1347) $x1335)))
 (let (($x1924 (and (and (and (and (and (and $x1918 $x1324) $x1315) $x1863) $x1520) $x1539) $x1543)))
 (let (($x1276 (= loc_1 2)))
 ...
 (let (($x1053 (= loc_0 1)))
 (let (($x1911 (=> $x1053 (and (and (and (and (and $x1098 $x1078) $x1836) $x1244) $x1273) $x1276))))
 (let (($x1055 (and (and (= H_0 emp) (= AH_0 emp)) $x1053)))
 (and (and (and (and $x1055 $x1911) (=> $x1276 $x1924)) $x1944) $x1967))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
