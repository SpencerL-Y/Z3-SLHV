...
(assert
 (let (($x951 (= loc_5 4)))
 (let (($x948 (= invalidDeref_5 invalidDeref_4)))
 (let (($x944 (= H_5 H_4)))
 ...
 (let (($x939 (and (and (and (or true invalidDeref_4) (and true true)) $x931) $x938)))
 (let (($x896 (= loc_4 4)))
 (let (($x893 (= invalidDeref_4 invalidDeref_3)))
 (let (($x889 (= H_4 H_3)))
 ...
 (let (($x884 (and (and (and (or true invalidDeref_3) (and true true)) $x876) $x883)))
 (let (($x841 (= loc_3 4)))
 (let (($x837 (= invalidDeref_3 invalidDeref_2)))
 (let (($x833 (= H_3 H_2)))
 ...
 (let (($x828 (and (and (and (or (= $r_main01_3 0) invalidDeref_2) $x792) $x823) $x827)))
 (let (($x687 (= loc_2 3)))
 ...
 (let (($x432 (= $i10_main01_1 0)))
 (let (($x433 (= $p7_main01_1 $p9_main01_1)))
 (let (($x434 (not $x433)))
 (let (($x435 (and $x434 $x432)))
 (let (($x436 (= $i10_main01_1 1)))
 (let (($x437 (and $x433 $x436)))
 ...
 (let (($x844 (and (and (and (and $x383 $x385) (=> $x381 (and $x626 $x628))) $x785) (=> $x687 (and (and (and $x828 $x834) $x837) $x841)))))
 (let (($x954 (and (and $x844 (=> $x841 (and (and (and $x884 $x890) $x893) $x896))) (=> $x896 (and (and (and $x939 $x945) $x948) $x951)))))
 (and $x954 invalidDeref_5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
