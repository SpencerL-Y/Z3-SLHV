...
(assert
 (let (($x938 (= loc_6 8)))
 (let (($x928 (= invalidDeref_6 invalidDeref_5)))
 ...
 (let (($x929 (and (and (and (and invalidDeref_5 (and true true)) $x912) $x925) $x928)))
 (let (($x871 (= loc_5 8)))
 (let (($x937 (and (=> (= loc_5 3) (and $x929 (= loc_6 3))) (=> (= loc_5 5) (and $x929 (= loc_6 5))))))
 (let (($x851 (= invalidDeref_5 invalidDeref_4)))
 ...
 (let (($x868 (and (and (and (or (= $r_main01_5 0) invalidDeref_4) $x865) $x835) $x845)))
 (let (($x789 (= loc_4 7)))
 (let (($x857 (= loc_5 5)))
 (let (($x847 (= $r_main0_5 $r_main0_4)))
 (let (($x848 (and $x845 $x847)))
 (let (($x852 (and (and (and (and invalidDeref_4 (and true true)) $x835) $x848) $x851)))
 (let (($x738 (= loc_4 5)))
 (let (($x860 (and (=> (= loc_4 3) (and $x852 (= loc_5 3))) (=> $x738 (and $x852 $x857)))))
 ...
 (let (($x741 (and (=> (= loc_3 3) (and $x733 (= loc_4 3))) (=> (= loc_3 5) (and $x733 $x738)))))
 ...
 (let (($x942 (and (and $x798 (and $x860 (=> $x789 (and (and $x868 $x851) $x871)))) (and $x937 (=> $x871 (and $x929 $x938))))))
 (and $x942 invalidDeref_6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
