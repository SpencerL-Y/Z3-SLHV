...
(assert
 ...
 (let (($x971 (and (and $x432 $x716) $x729)))
 (let (($x675 (= loc_3 6)))
 ...
 (let (($x982 (and (and (and (and (and $x767 $x759) $x754) $x752) (and $x779 true)) $x785)))
 (let (($x747 (= $i1_free_g20_3 1)))
 (let (($x748 (and $x675 $x747)))
 (let (($x976 (and (=> (= loc_3 3) (and $x971 (= loc_4 3))) (=> (= loc_3 5) (and $x971 (= loc_4 5))))))
 (let (($x989 (and (and $x976 (=> $x748 (and (and $x982 $x729) $x789))) (=> $x794 (and $x971 $x789)))))
 ...
 (let (($x963 (and (and (and (and (and (and $x640 $x638) $x636) $x631) $x629) $x627) $x659)))
 (let (($x538 (= loc_2 4)))
 ...
 (let (($x934 (and false $x432)))
 (let (($x601 (= $i0_h0_2 1)))
 (let (($x602 (and $x538 $x601)))
 (let (($x489 (= loc_2 3)))
 (let (($x957 (and (=> $x489 (and (and (and $x432 $x579) $x592) (= loc_3 3))) (=> $x602 (and (and (and $x934 $x579) $x592) $x609)))))
 ...
 (let (($x944 (and (and (and (and (and (and $x518 $x513) $x511) $x503) $x835) $x534) $x482)))
 (let (($x425 (= loc_1 2)))
 ...
 (let (($x947 (and (=> $x430 (and (and (and $x934 $x469) $x482) $x489)) (=> $x499 (and $x944 $x538)))))
 ...
 (let (($x348 (= $M.01_1 0)))
 (let (($x930 (and (and (and (and (and (and $x348 $x346) $x341) $x339) $x364) $x401) $x418)))
 (let (($x333 (= loc_0 1)))
 (let (($x328 (= A_0 epsilon)))
 (let (($x969 (and (and (and $x328 (=> $x333 (and $x930 $x425))) $x947) (and $x957 (=> $x620 (and (and (and $x963 $x668) $x671) $x675))))))
 (and (and $x969 $x989) (and (or (= loc_4 3) (= loc_4 5)) (freeable A_4 l1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
