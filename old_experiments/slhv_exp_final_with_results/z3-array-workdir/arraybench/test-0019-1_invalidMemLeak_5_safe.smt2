...
(assert
 ...
 (let (($x1286 (=> $x853 (and (and (and (and (and $x862 $x857) $x867) $x833) $x840) $x847))))
 ...
 (let (($x1252 (and (and (and (and (and (and $x658 $x653) $x651) $x646) $x638) $x633) $x628)))
 (let (($x1258 (and (and (and (and (and (and $x1252 $x619) $x614) $x612) $x604) $x599) $x590)))
 (let (($x1264 (and (and (and (and (and (and $x1258 $x585) $x583) $x581) $x576) $x574) $x566)))
 (let (($x1270 (and (and (and (and (and (and $x1264 $x561) $x552) $x547) $x539) $x534) $x525)))
 (let (($x475 (= loc_0 1)))
 (let (($x470 (= A_0 epsilon)))
 (let (($x1276 (and $x470 (=> $x475 (and (and (and (and $x1270 $x520) $x1175) $x760) $x763)))))
 (let (($x1288 (and $x1276 (and (=> $x768 (and (and (and $x769 $x833) $x840) $x847)) $x1286))))
 (let (($x1294 (and $x1288 (=> $x847 (and (and (and (and $x877 $x881) $x945) $x949) $x956)))))
 (let (($x1304 (and (and $x1294 (=> $x956 (and (and (and $x769 $x1023) $x1030) $x1036))) (=> $x1036 (and (and (and $x769 $x1103) $x1110) $x1116)))))
 (and $x1304 (and $x1116 (freeable A_5 l1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
