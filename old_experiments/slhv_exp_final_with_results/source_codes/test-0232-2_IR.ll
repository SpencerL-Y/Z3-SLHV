; ModuleID = '/home/zhuyt/SESL/bin/b-rc9bs9wb.bc'
...
@.str.1 = private unnamed_addr constant [14 x i8] c"test-0232-2.c\00", align 1
...
19:                                               ; preds = %9, %6
  ...
  br i1 %21, label %.lr.ph, label %30, !dbg !48, !verifier.code !14
...
22:                                               ; preds = %.lr.ph, %22
  ...
  %26 = load %struct.item*, %struct.item** %1, align 8, !dbg !54, !verifier.code !14
  %27 = bitcast %struct.item* %26 to i8*, !dbg !54, !verifier.code !14
  call void @free(i8* %27) #6, !dbg !55, !verifier.code !14
  store %struct.item* %25, %struct.item** %1, align 8, !dbg !56, !verifier.code !14
  %28 = load %struct.item*, %struct.item** %1, align 8, !dbg !47, !verifier.code !14
  %29 = icmp ne %struct.item* %28, null, !dbg !48, !verifier.code !14
  br i1 %29, label %22, label %._crit_edge, !dbg !48, !llvm.loop !57, !verifier.code !14

._crit_edge:                                      ; preds = %22
  br label %30, !dbg !48, !verifier.code !14

30:                                               ; preds = %._crit_edge, %19
  ret i32 0, !dbg !59, !verifier.code !14
}
...
; Function Attrs: noinline nounwind uwtable
define internal void @append(%struct.item** %0) #0 !dbg !60 {
  call void @llvm.dbg.value(metadata %struct.item** %0, metadata !64, metadata !DIExpression()), !dbg !65, !verifier.code !14
  %2 = call noalias i8* @malloc(i32 16) #6, !dbg !66, !verifier.code !14
  %3 = bitcast i8* %2 to %struct.item*, !dbg !66, !verifier.code !14
  call void @llvm.dbg.value(metadata %struct.item* %3, metadata !67, metadata !DIExpression()), !dbg !65, !verifier.code !14
  %4 = load %struct.item*, %struct.item** %0, align 8, !dbg !68, !verifier.code !14
  %5 = getelementptr inbounds %struct.item, %struct.item* %3, i32 0, i32 0, !dbg !69, !verifier.code !14
  store %struct.item* %4, %struct.item** %5, align 8, !dbg !70, !verifier.code !14
  %6 = getelementptr inbounds %struct.item, %struct.item* %3, i32 0, i32 0, !dbg !71, !verifier.code !14
  %7 = load %struct.item*, %struct.item** %6, align 8, !dbg !71, !verifier.code !14
  %8 = icmp ne %struct.item* %7, null, !dbg !72, !verifier.code !14
  br i1 %8, label %9, label %15, !dbg !72, !verifier.code !14

9:                                                ; preds = %1
  %10 = getelementptr inbounds %struct.item, %struct.item* %3, i32 0, i32 0, !dbg !73, !verifier.code !14
  %11 = load %struct.item*, %struct.item** %10, align 8, !dbg !73, !verifier.code !14
  %12 = getelementptr inbounds %struct.item, %struct.item* %11, i32 0, i32 1, !dbg !74, !verifier.code !14
  %13 = load %struct.item*, %struct.item** %12, align 8, !dbg !74, !verifier.code !14
  %14 = bitcast %struct.item* %13 to i8*, !dbg !75, !verifier.code !14
  br label %17, !dbg !72, !verifier.code !14

15:                                               ; preds = %1
  %16 = call noalias i8* @malloc(i32 16) #6, !dbg !76, !verifier.code !14
  br label %17, !dbg !72, !verifier.code !14

17:                                               ; preds = %15, %9
  %18 = phi i8* [ %14, %9 ], [ %16, %15 ], !dbg !72, !verifier.code !14
  %19 = bitcast i8* %18 to %struct.item*, !dbg !72, !verifier.code !14
  %20 = getelementptr inbounds %struct.item, %struct.item* %3, i32 0, i32 1, !dbg !77, !verifier.code !14
  store %struct.item* %19, %struct.item** %20, align 8, !dbg !78, !verifier.code !14
  store %struct.item* %3, %struct.item** %0, align 8, !dbg !79, !verifier.code !14
  ret void, !dbg !80, !verifier.code !14
}
...
!1 = !DIFile(filename: "/home/zhuyt/slhv_expr/source_codes/test-0232-2.i", directory: "/home/zhuyt/SESL/bin")
!2 = !{}
...
!8 = !DIFile(filename: "slhv_expr/source_codes/test-0232-2.i", directory: "/home/zhuyt")
...
!54 = !DILocation(line: 551, column: 14, scope: !50)
!55 = !DILocation(line: 551, column: 9, scope: !50)
!56 = !DILocation(line: 552, column: 14, scope: !50)
!57 = distinct !{!57, !48, !58}
!58 = !DILocation(line: 553, column: 5, scope: !15)
!59 = !DILocation(line: 554, column: 5, scope: !15)
!60 = distinct !DISubprogram(name: "append", scope: !8, file: !8, line: 528, type: !61, scopeLine: 529, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!61 = !DISubroutineType(types: !62)
!62 = !{null, !63}
!63 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!64 = !DILocalVariable(name: "plist", arg: 1, scope: !60, file: !8, line: 528, type: !63)
!65 = !DILocation(line: 0, scope: !60)
!66 = !DILocation(line: 530, column: 25, scope: !60)
!67 = !DILocalVariable(name: "item", scope: !60, file: !8, line: 530, type: !20)
!68 = !DILocation(line: 531, column: 18, scope: !60)
!69 = !DILocation(line: 531, column: 11, scope: !60)
!70 = !DILocation(line: 531, column: 16, scope: !60)
!71 = !DILocation(line: 532, column: 25, scope: !60)
!72 = !DILocation(line: 532, column: 18, scope: !60)
!73 = !DILocation(line: 533, column: 17, scope: !60)
!74 = !DILocation(line: 533, column: 23, scope: !60)
!75 = !DILocation(line: 533, column: 11, scope: !60)
!76 = !DILocation(line: 534, column: 11, scope: !60)
!77 = !DILocation(line: 532, column: 11, scope: !60)
!78 = !DILocation(line: 532, column: 16, scope: !60)
!79 = !DILocation(line: 535, column: 12, scope: !60)
!80 = !DILocation(line: 536, column: 1, scope: !60)
