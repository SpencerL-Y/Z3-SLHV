; ModuleID = '/home/zhuyt/SESL/bin/b-h_plcfb7.bc'
...
2:                                                ; preds = %0
  call void @_Exit(i32 1) #5, !dbg !38, !verifier.code !20
...
5:                                                ; preds = %0
  ...
  call void @free_g1(), !dbg !55, !verifier.code !20
  call void @free_g2(), !dbg !56, !verifier.code !20
  ret i32 0, !dbg !57, !verifier.code !20
}
...
!3 = !DIFile(filename: "/home/zhuyt/slhv_expr/source_codes/global-atexit-1.i", directory: "/home/zhuyt/SESL/bin")
!4 = !{}
!5 = !{!6, !7, !8}
...
!10 = !{!0}
!11 = !DIFile(filename: "slhv_expr/source_codes/global-atexit-1.i", directory: "/home/zhuyt")
...
!55 = !DILocation(line: 580, column: 2, scope: !40)
!56 = !DILocation(line: 581, column: 2, scope: !40)
!57 = !DILocation(line: 582, column: 2, scope: !40)
