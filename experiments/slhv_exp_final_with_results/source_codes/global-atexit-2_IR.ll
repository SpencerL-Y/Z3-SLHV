; ModuleID = '/home/zhuyt/SESL/bin/b-_v00lsvm.bc'
...
define internal void @f() #0 !dbg !40 {
  %1 = call noalias i8* @malloc(i32 4) #4, !dbg !41, !verifier.code !20
  ...
  %4 = call i32 @atexit(void ()* @free_g1) #4, !dbg !45, !verifier.code !20
...
define dso_local i32 @main() #0 !dbg !48 {
  %1 = call noalias i8* @malloc(i32 8) #4, !dbg !51, !verifier.code !20
  %2 = bitcast i8* %1 to i32**, !dbg !52, !verifier.code !20
  store i32** %2, i32*** @g, align 8, !dbg !53, !verifier.code !20
  %3 = call noalias i8* @malloc(i32 4) #4, !dbg !54, !verifier.code !20
  %4 = bitcast i8* %3 to i32*, !dbg !55, !verifier.code !20
  %5 = load i32**, i32*** @g, align 8, !dbg !56, !verifier.code !20
  store i32* %4, i32** %5, align 8, !dbg !57, !verifier.code !20
  call void @h(), !dbg !58, !verifier.code !20
  %6 = load i32**, i32*** @g, align 8, !dbg !59, !verifier.code !20
  %7 = load i32*, i32** %6, align 8, !dbg !60, !verifier.code !20
  %8 = bitcast i32* %7 to i8*, !dbg !60, !verifier.code !20
  call void @free(i8* %8) #4, !dbg !61, !verifier.code !20
  %9 = load i32**, i32*** @g, align 8, !dbg !62, !verifier.code !20
  %10 = bitcast i32** %9 to i8*, !dbg !62, !verifier.code !20
  call void @free(i8* %10) #4, !dbg !63, !verifier.code !20
  store i32** null, i32*** @g, align 8, !dbg !64, !verifier.code !20
  call void @free_g2(), !dbg !65, !verifier.code !20
  call void @free_g1(), !dbg !66, !verifier.code !20
...
!1 = distinct !DIGlobalVariable(name: "g", scope: !2, file: !11, line: 556, type: !9, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "/home/zhuyt/slhv_expr/source_codes/global-atexit-2.i", directory: "/home/zhuyt/SESL/bin")
!4 = !{}
!5 = !{!6, !7, !9}
...
!10 = !{!0}
!11 = !DIFile(filename: "slhv_expr/source_codes/global-atexit-2.i", directory: "/home/zhuyt")
...
!40 = distinct !DISubprogram(name: "f", scope: !11, file: !11, line: 568, type: !17, scopeLine: 568, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!41 = !DILocation(line: 569, column: 15, scope: !40)
!42 = !DILocation(line: 569, column: 7, scope: !40)
!43 = !DILocation(line: 569, column: 3, scope: !40)
!44 = !DILocation(line: 569, column: 5, scope: !40)
!45 = !DILocation(line: 570, column: 2, scope: !40)
!46 = !DILocation(line: 571, column: 2, scope: !40)
!47 = !DILocation(line: 572, column: 1, scope: !40)
!48 = distinct !DISubprogram(name: "main", scope: !11, file: !11, line: 573, type: !49, scopeLine: 573, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!49 = !DISubroutineType(types: !50)
!50 = !{!8}
!51 = !DILocation(line: 574, column: 15, scope: !48)
!52 = !DILocation(line: 574, column: 6, scope: !48)
!53 = !DILocation(line: 574, column: 4, scope: !48)
!54 = !DILocation(line: 577, column: 15, scope: !48)
!55 = !DILocation(line: 577, column: 7, scope: !48)
!56 = !DILocation(line: 577, column: 3, scope: !48)
!57 = !DILocation(line: 577, column: 5, scope: !48)
!58 = !DILocation(line: 578, column: 2, scope: !48)
!59 = !DILocation(line: 579, column: 8, scope: !48)
!60 = !DILocation(line: 579, column: 7, scope: !48)
!61 = !DILocation(line: 579, column: 2, scope: !48)
!62 = !DILocation(line: 580, column: 7, scope: !48)
!63 = !DILocation(line: 580, column: 2, scope: !48)
!64 = !DILocation(line: 581, column: 4, scope: !48)
!65 = !DILocation(line: 582, column: 2, scope: !48)
!66 = !DILocation(line: 583, column: 2, scope: !48)
!67 = !DILocation(line: 584, column: 2, scope: !48)
