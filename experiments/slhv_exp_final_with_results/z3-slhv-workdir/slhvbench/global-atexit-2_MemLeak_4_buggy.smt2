...
(assert
 (let (($x1536 (= AH_4 (uplus ah9 (pt l19 (Pt_R_1 d20))))))
 (let (($x1529 (or (= H_4 (uplus h11 (pt l17 (Pt_R_0 l18)))) (= H_4 (uplus h11 (pt l17 (Pt_R_1 d19)))))))
 (let (($x1244 (= loc_4 5)))
 (let (($x1237 (= H_4 H_3)))
 ...
 (let (($x1113 (= loc_3 4)))
 (let (($x1509 (=> $x1113 (and (and (and (and (and $x1168 $x1172) $x1224) $x1231) $x1238) $x1244))))
 (let (($x1515 (and $x1509 (=> $x1162 (and (and (and (and $x1119 $x1224) $x1251) $x1238) $x1244)))))
 (let (($x1143 (= H_3 H_2)))
 ...
 (let (($x965 (= loc_2 4)))
 (let (($x1501 (=> $x965 (and (and (and (and (and $x1152 $x1155) $x1138) $x1107) $x1144) $x1162))))
 (let (($x1492 (and (and (and $x1119 $x1138) (and $x1107 (= $r_main0_3 $r_main0_2))) $x1144)))
 (let (($x808 (= loc_2 3)))
 ...
 (let (($x1486 (and (and (and (and (and $x1036 $x1025) $x1016) $x1014) (and $x1054 true)) $x1100)))
 (let (($x986 (= $i9_main0_2 1)))
 (let (($x987 (and $x808 $x986)))
 (let (($x1495 (and (=> $x987 (and (and $x1486 $x1110) $x1113)) (=> $x1117 (and $x1492 $x1113)))))
 ...
 (let (($x1471 (and (and (and (and (and (and $x922 $x911) $x902) $x900) $x872) $x870) $x868)))
 (let (($x1477 (and (and (and (and (and $x1471 $x840) (and $x945 true)) $x958) $x962) $x965)))
 (let (($x666 (= loc_1 2)))
 ...
 (let (($x1457 (and (and (= $p6_main01_2 $M.0_1) (= $p7_main01_2 $p6_main01_2)) $x723)))
 (let (($x1463 (and (and (and (and (and (and $x1457 $x695) $x693) $x691) $x754) $x794) $x801)))
 ...
 (let (($x571 (= $M.01_1 nil)))
 (let (($x1448 (and (and (and (and (and (and $x571 $x569) $x558) $x556) $x554) $x543) $x541)))
 (let (($x494 (= loc_0 1)))
 (let (($x1454 (=> $x494 (and (and (and (and (and $x1448 $x530) $x1278) $x650) $x663) $x666))))
 (let (($x496 (and (and (= H_0 emp) (= AH_0 emp)) $x494)))
 (let (($x1480 (and (and $x496 $x1454) (and (=> $x684 (and $x1463 $x808)) (=> $x839 $x1477)))))
 (and (and (and $x1480 (and $x1495 $x1501)) $x1515) (and (and $x1244 $x1529) $x1536))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
