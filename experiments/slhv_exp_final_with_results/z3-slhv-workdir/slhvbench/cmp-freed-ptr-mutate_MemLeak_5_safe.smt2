...
(assert
 (let (($x900 (= AH_5 (uplus ah7 (pt l16 (Pt_R_1 d11))))))
 (let (($x893 (or (= H_5 (uplus h4 (pt l14 (Pt_R_0 l15)))) (= H_5 (uplus h4 (pt l14 (Pt_R_1 d10)))))))
 (let (($x705 (= loc_5 4)))
 (let (($x698 (= H_5 H_4)))
 ...
 (let (($x866 (and (and (and (and (and (and $x568 $x566) $x538) $x583) $x602) $x606) $x613)))
 (let (($x505 (= loc_2 3)))
 (let (($x520 (= H_2 H_1)))
 ...
 (let (($x853 (=> $x432 (and (and (and (and (and $x461 $x459) $x472) $x491) $x498) $x505))))
 (let (($x859 (and $x853 (=> $x509 (and (and (and (and $x511 $x515) $x498) $x521) $x505)))))
 ...
 (let (($x841 (and (and (and (and (and (and $x367 $x356) $x354) $x352) $x324) $x313) $x311)))
 (let (($x277 (= loc_0 1)))
 (let (($x279 (and (and (= H_0 emp) (= AH_0 emp)) $x277)))
 (let (($x847 (and $x279 (=> $x277 (and (and (and (and $x841 $x398) $x407) $x412) $x418)))))
 (let (($x874 (and (and (and $x847 $x859) (=> $x505 $x866)) (=> $x613 (and (and (and (and $x511 $x639) $x646) $x653) $x659)))))
 (let (($x880 (and $x874 (=> $x659 (and (and (and (and $x511 $x685) $x692) $x699) $x705)))))
 (and $x880 (and (and $x705 $x893) $x900)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
