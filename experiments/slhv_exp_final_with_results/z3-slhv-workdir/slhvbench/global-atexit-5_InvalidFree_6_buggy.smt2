...
(assert
 (let (($x2203 (= loc_6 5)))
 (let (($x2509 (= invalidFree_6 invalidFree_5)))
 (let (($x2196 (= H_6 H_5)))
 ...
 (let (($x2516 (and (and (and (or true invalidFree_5) (and true true)) $x2177) $x2210)))
 (let (($x1921 (= loc_5 5)))
 (let (($x2100 (= $r_main0_6 $r_main01_6)))
 (let (($x2101 (and $x2100 true)))
 (let (($x2097 (= $r_main01_6 0)))
 (let (($x2503 (or $x2097 invalidFree_5)))
 (let (($x2511 (and (and (and (and (and (and $x2503 $x2101) $x2177) $x2190) $x2197) $x2509) $x2203)))
 (let (($x2008 (= loc_5 3)))
 (let (($x2521 (and (=> $x2008 $x2511) (=> $x1921 (and (and (and $x2516 $x2197) $x2509) $x2203)))))
 ...
 (let (($x2494 (= invalidFree_5 invalidFree7_5)))
 (let (($x2067 (= H_5 H10_5)))
 ...
 (let (($x2476 (or $x2023 invalidFree7_5)))
 (let (($x2477 (= invalidFree7_5 invalidFree_4)))
 (let (($x2478 (and invalidFree_4 $x2477)))
 ...
 (let (($x2485 (or (= $p27_main01_5 nil) (= ah14_5 (uplus AH_4 (pt $p27_main01_5 (Pt_R_1 d30_5)))))))
 (let (($x2486 (and $x2485 invalidFree7_5)))
 (let (($x2053 (= $p27_main01_5 $p26_main01_5)))
 (let (($x2489 (or $x2053 invalidFree_4)))
 (let (($x2055 (= $p26_main01_5 $M.0_4)))
 (let (($x2490 (or $x2055 invalidFree_4)))
 (let (($x2493 (and (and (and $x2490 $x2489) (or (or $x2486 (and $x2051 $x2477)) $x2478)) $x2476)))
 (let (($x1806 (= loc_4 9)))
 (let (($x2500 (=> $x1806 (and (and (and (and $x2493 (and $x2068 $x2494)) $x2088) $x1908) $x2008))))
 ...
 (let (($x2465 (= invalidFree_5 invalidFree6_5)))
 (let (($x1979 (= H_5 H9_5)))
 ...
 (let (($x2447 (or $x1935 invalidFree6_5)))
 (let (($x2448 (= invalidFree6_5 invalidFree_4)))
 (let (($x2449 (and invalidFree_4 $x2448)))
 ...
 (let (($x2456 (or (= $p15_main01_5 nil) (= ah12_5 (uplus AH_4 (pt $p15_main01_5 (Pt_R_1 d26_5)))))))
 (let (($x2457 (and $x2456 invalidFree6_5)))
 (let (($x1965 (= $p15_main01_5 $p14_main01_5)))
 (let (($x2460 (or $x1965 invalidFree_4)))
 (let (($x1967 (= $p14_main01_5 $M.0_4)))
 (let (($x2461 (or $x1967 invalidFree_4)))
 (let (($x2464 (and (and (and $x2461 $x2460) (or (or $x2457 (and $x1963 $x2448)) $x2449)) $x2447)))
 (let (($x1703 (= loc_4 8)))
 (let (($x2471 (=> $x1703 (and (and (and (and $x2464 (and $x1980 $x2465)) $x2004) $x1908) $x2008))))
 (let (($x2440 (= invalidFree_5 invalidFree_4)))
 (let (($x1914 (= H_5 H_4)))
 ...
 (let (($x2437 (and (and (and (or true invalidFree_4) (and true true)) $x1892) $x1908)))
 (let (($x1594 (= loc_4 5)))
 (let (($x2501 (and (and (=> $x1594 (and (and (and $x2437 $x1915) $x2440) $x1921)) $x2471) $x2500)))
 (let (($x2365 (= invalidFree_4 invalidFree_3)))
 (let (($x1587 (= H_4 H_3)))
 ...
 (let (($x2362 (and (and (and (or true invalidFree_3) (and true true)) $x1565) $x1581)))
 (let (($x2366 (and (and $x2362 $x1588) $x2365)))
 (let (($x1483 (= loc_3 7)))
 ...
 (let (($x2422 (= invalidFree_4 invalidFree5_4)))
 (let (($x1790 (= H_4 H8_4)))
 ...
 (let (($x2404 (= invalidFree5_4 invalidFree_3)))
 (let (($x2405 (and invalidFree_3 $x2404)))
 ...
 (let (($x2412 (or (= $p25_main01_4 nil) (= ah10_4 (uplus AH_3 (pt $p25_main01_4 (Pt_R_1 d22_4)))))))
 (let (($x2413 (and $x2412 invalidFree5_4)))
 (let (($x1758 (= $p25_main01_4 $p24_main01_4)))
 (let (($x2416 (or $x1758 invalidFree_3)))
 (let (($x1767 (and (= H_3 (uplus h11_4 (pt $p23_main01_4 (Pt_R_0 l17_4)))) (= $p24_main01_4 l17_4))))
 (let (($x2417 (or $x1767 invalidFree_3)))
 (let (($x1778 (= $p23_main01_4 $M.0_3)))
 (let (($x2418 (or $x1778 invalidFree_3)))
 (let (($x2421 (and (and (and $x2418 $x2417) $x2416) (or (or $x2413 (and $x1756 $x2404)) $x2405))))
 (let (($x1728 (= $i22_main0_3 1)))
 (let (($x1729 (and $x1483 $x1728)))
 (let (($x2428 (=> $x1729 (and (and (and (and $x2421 (and $x1791 $x2422)) $x1802) $x1581) $x1806))))
 (let (($x1311 (= loc_3 6)))
 ...
 (let (($x2390 (= invalidFree_4 invalidFree4_4)))
 (let (($x1675 (= H_4 H7_4)))
 ...
 (let (($x2372 (= invalidFree4_4 invalidFree_3)))
 (let (($x2373 (and invalidFree_3 $x2372)))
 ...
 (let (($x2380 (or (= $p13_main01_4 nil) (= ah8_4 (uplus AH_3 (pt $p13_main01_4 (Pt_R_1 d18_4)))))))
 (let (($x2381 (and $x2380 invalidFree4_4)))
 (let (($x1643 (= $p13_main01_4 $p12_main01_4)))
 (let (($x2384 (or $x1643 invalidFree_3)))
 (let (($x1652 (and (= H_3 (uplus h8_4 (pt $p11_main01_4 (Pt_R_0 l13_4)))) (= $p12_main01_4 l13_4))))
 (let (($x2385 (or $x1652 invalidFree_3)))
 (let (($x1663 (= $p11_main01_4 $M.0_3)))
 (let (($x2386 (or $x1663 invalidFree_3)))
 (let (($x2389 (and (and (and $x2386 $x2385) $x2384) (or (or $x2381 (and $x1641 $x2372)) $x2373))))
 (let (($x1613 (= $i10_main0_3 1)))
 (let (($x1614 (and $x1311 $x1613)))
 (let (($x2396 (=> $x1614 (and (and (and (and $x2389 (and $x1676 $x2390)) $x1699) $x1581) $x1703))))
 (let (($x2400 (and (and (=> (= loc_3 5) (and $x2366 $x1594)) $x2396) (=> $x1708 (and $x2366 $x1703)))))
 ...
 (let (($x2350 (= invalidFree_3 invalidFree3_3)))
 (let (($x1460 (= H_3 H6_3)))
 ...
 (let (($x2312 (or $x1353 invalidFree3_3)))
 (let (($x2313 (= invalidFree3_3 invalidFree2_3)))
 (let (($x2314 (and invalidFree2_3 $x2313)))
 (let (($x1355 (= H6_3 h7_3)))
 ...
 (let (($x2321 (or (= $p20_main01_3 nil) (= ah6_3 (uplus AH4_3 (pt $p20_main01_3 (Pt_R_1 d14_3)))))))
 (let (($x2322 (and $x2321 invalidFree3_3)))
 (let (($x1383 (= $p20_main01_3 $p19_main01_3)))
 (let (($x2325 (or $x1383 invalidFree2_3)))
 (let (($x1385 (= $p19_main01_3 $M.0_2)))
 (let (($x2326 (or $x1385 invalidFree2_3)))
 (let (($x2327 (= invalidFree2_3 invalidFree_2)))
 (let (($x2328 (and invalidFree_2 $x2327)))
 (let (($x1387 (= H5_3 h6_3)))
 ...
 (let (($x2335 (or (= $p18_main01_3 nil) (= ah4_3 (uplus AH_2 (pt $p18_main01_3 (Pt_R_1 d10_3)))))))
 (let (($x2336 (and $x2335 invalidFree2_3)))
 (let (($x1415 (= $p18_main01_3 $p17_main01_3)))
 (let (($x2339 (or $x1415 invalidFree_2)))
 (let (($x1424 (and (= H_2 (uplus h4_3 (pt $p16_main01_3 (Pt_R_0 l7_3)))) (= $p17_main01_3 l7_3))))
 (let (($x2340 (or $x1424 invalidFree_2)))
 (let (($x1435 (= $p16_main01_3 $M.0_2)))
 (let (($x2341 (or $x1435 invalidFree_2)))
 (let (($x2344 (and (and (and $x2341 $x2340) $x2339) (or (or $x2336 (and $x1413 $x2327)) $x2328))))
 (let (($x2347 (and (and (and $x2344 $x2326) $x2325) (or (or $x2322 (and $x1381 $x2313)) $x2314))))
 (let (($x2352 (and (and (and $x2347 $x2312) (or $x1351 invalidFree3_3)) (and $x1461 $x2350))))
 (let (($x1165 (= loc_2 4)))
 (let (($x1344 (and $x1165 (not (= $i8_main0_2 1)))))
 (let (($x2290 (= invalidFree_3 invalidFree_2)))
 (let (($x1270 (= H_3 H_2)))
 ...
 (let (($x2295 (or $x1293 invalidFree_2)))
 (let (($x2300 (and (and (and (and (and $x2295 (or $x1291 invalidFree_2)) $x1299) $x1248) $x1306) $x1271)))
 ...
 (let (($x2284 (or $x1171 invalidFree_2)))
 (let (($x2292 (and (and (and (and (and (and $x2284 $x1175) $x1251) $x1264) $x1271) $x2290) $x1278)))
 (let (($x1069 (= loc_2 3)))
 (let (($x2357 (and (and (=> $x1069 $x2292) (=> $x1284 (and (and $x2300 $x2290) $x1311))) (=> $x1344 (and (and (and $x2352 $x1476) $x1480) $x1483)))))
 (let (($x2278 (= invalidFree_2 invalidFree_1)))
 ...
 (let (($x2267 (or $x1096 invalidFree_1)))
 (let (($x1107 (= $p7_main01_2 $M.0_1)))
 (let (($x2268 (or $x1107 invalidFree_1)))
 (let (($x1109 (= $p6_main01_2 $p5_main01_2)))
 (let (($x2269 (or $x1109 invalidFree_1)))
 ...
 (let (($x2276 (and (and (and (and (and (or $x1120 invalidFree_1) $x2269) $x2268) $x2267) $x2274) $x1161)))
 (let (($x911 (= loc_1 2)))
 ...
 (let (($x2260 (= invalidFree_2 invalidFree1_2)))
 (let (($x977 (= H_2 H2_2)))
 (let (($x974 (= AH_2 AH2_2)))
 ...
 (let (($x928 (= $M.03_2 nil)))
 (let (($x2241 (or $x928 invalidFree1_2)))
 (let (($x2242 (= invalidFree1_2 invalidFree_1)))
 (let (($x2243 (and invalidFree_1 $x2242)))
 (let (($x930 (= H2_2 h1_2)))
 ...
 (let (($x2250 (or (= $p4_main01_2 nil) (= ah2_2 (uplus AH_1 (pt $p4_main01_2 (Pt_R_1 d5_2)))))))
 (let (($x2251 (and $x2250 invalidFree1_2)))
 (let (($x958 (= $p4_main01_2 $p3_main01_2)))
 (let (($x2254 (or $x958 invalidFree_1)))
 (let (($x960 (= $p3_main01_2 $M.0_1)))
 (let (($x2255 (or $x960 invalidFree_1)))
 (let (($x2258 (and (and (and $x2255 $x2254) (or (or $x2251 (and $x956 $x2242)) $x2243)) $x2241)))
 (let (($x926 (= $i2_main0_1 1)))
 (let (($x927 (and $x911 $x926)))
 (let (($x2266 (=> $x927 (and (and (and (and $x2258 (and $x978 $x2260)) $x1046) $x1062) $x1069))))
 (let (($x2233 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x2222 (or $x761 invalidFree_0)))
 (let (($x763 (= $p1_main01_1 $p0_main01_1)))
 (let (($x2223 (or $x763 invalidFree_0)))
 ...
 (let (($x776 (= $M.01_1 nil)))
 (let (($x2225 (or $x776 invalidFree_0)))
 (let (($x2230 (and (and (and (and (and $x2225 (or $x774 invalidFree_0)) $x2223) $x2222) $x795) $x884)))
 (let (($x747 (= loc_0 1)))
 (let (($x2220 (not invalidFree_0)))
 (let (($x749 (and (and (= H_0 emp) (= AH_0 emp)) $x747)))
 (let (($x2237 (and (and $x749 $x2220) (=> $x747 (and (and (and $x2230 $x905) $x2233) $x911)))))
 (let (($x2283 (and $x2237 (and $x2266 (=> $x1085 (and (and (and $x2276 $x1062) $x2278) $x1165))))))
 (let (($x2433 (and (and $x2283 $x2357) (and (and $x2400 $x2428) (=> $x1811 (and $x2366 $x1806))))))
 (and (and (and $x2433 $x2501) $x2521) invalidFree_6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
