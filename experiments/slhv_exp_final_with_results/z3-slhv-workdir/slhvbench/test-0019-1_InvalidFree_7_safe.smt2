...
(assert
 (let (($x1209 (= loc_7 4)))
 (let (($x1370 (= invalidFree_7 invalidFree_6)))
 (let (($x1202 (= H_7 H_6)))
 ...
 (let (($x1367 (and (and (and (or true invalidFree_6) (and true true)) $x1189) $x1196)))
 (let (($x1151 (= loc_6 4)))
 (let (($x1359 (= invalidFree_6 invalidFree_5)))
 (let (($x1144 (= H_6 H_5)))
 ...
 (let (($x1356 (and (and (and (or true invalidFree_5) (and true true)) $x1131) $x1138)))
 (let (($x1093 (= loc_5 4)))
 (let (($x1348 (= invalidFree_5 invalidFree_4)))
 (let (($x1086 (= H_5 H_4)))
 ...
 (let (($x1345 (and (and (and (or true invalidFree_4) (and true true)) $x1073) $x1080)))
 (let (($x1035 (= loc_4 4)))
 (let (($x1337 (= invalidFree_4 invalidFree_3)))
 (let (($x1028 (= H_4 H_3)))
 ...
 (let (($x1334 (and (and (and (or true invalidFree_3) (and true true)) $x1015) $x1022)))
 (let (($x977 (= loc_3 4)))
 (let (($x1326 (= invalidFree_3 invalidFree_2)))
 (let (($x969 (= H_3 H_2)))
 ...
 (let (($x1320 (or $x921 invalidFree_2)))
 (let (($x1328 (and (and (and (and (and (and $x1320 $x925) $x959) $x963) $x970) $x1326) $x977)))
 (let (($x763 (= loc_2 3)))
 ...
 (let (($x1311 (= invalidFree_2 invalidFree3_2)))
 (let (($x900 (= H_2 H8_2)))
 (let (($x901 (and (and (= $p11_main0_2 $p11_main01_2) (= AH_2 AH6_2)) $x900)))
 (let (($x1271 (= invalidFree3_2 invalidFree2_2)))
 (let (($x1272 (and invalidFree2_2 $x1271)))
 (let (($x799 (= H8_2 h11_2)))
 ...
 (let (($x1279 (or (= $p11_main01_2 nil) (= ah6_2 (uplus AH5_2 (pt $p11_main01_2 (Pt_R_1 d11_2)))))))
 (let (($x1280 (and $x1279 invalidFree3_2)))
 (let (($x830 (= $p11_main01_2 $p1_main0_1)))
 (let (($x1283 (or $x830 invalidFree2_2)))
 (let (($x1284 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1285 (and invalidFree1_2 $x1284)))
 (let (($x832 (= H7_2 h10_2)))
 ...
 (let (($x1292 (or (= $p9_main0_1 nil) (= ah4_2 (uplus AH4_2 (pt $p9_main0_1 (Pt_R_1 d8_2)))))))
 (let (($x1293 (and $x1292 invalidFree2_2)))
 (let (($x1296 (= invalidFree1_2 invalidFree_1)))
 (let (($x1297 (and invalidFree_1 $x1296)))
 (let (($x863 (= H6_2 h9_2)))
 ...
 (let (($x1304 (or (= $p7_main0_1 nil) (= ah2_2 (uplus AH_1 (pt $p7_main0_1 (Pt_R_1 d5_2)))))))
 (let (($x1305 (and $x1304 invalidFree1_2)))
 (let (($x1308 (and (or (or $x1305 (and $x892 $x1296)) $x1297) (or (or $x1293 (and $x861 $x1284)) $x1285))))
 (let (($x1313 (and (and (and $x1308 $x1283) (or (or $x1280 (and $x828 $x1271)) $x1272)) (and $x901 $x1311))))
 (let (($x701 (= loc_1 2)))
 (let (($x798 (and $x701 (not (= $i10_main0_1 1)))))
 (let (($x1258 (= invalidFree_2 invalidFree_1)))
 (let (($x755 (= H_2 H_1)))
 ...
 (let (($x1255 (and (and (and (or true invalidFree_1) (and true true)) $x742) $x749)))
 (let (($x705 (= $i10_main0_1 1)))
 (let (($x706 (and $x701 $x705)))
 (let (($x1318 (and (=> $x706 (and (and (and $x1255 $x756) $x1258) $x763)) (=> $x798 (and (and (and $x1313 $x912) $x749) $x763)))))
 (let (($x1247 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1225 (or $x593 invalidFree_0)))
 (let (($x604 (= $p3_main01_1 $p1_main01_1)))
 (let (($x1226 (or $x604 invalidFree_0)))
 ...
 (let (($x1228 (or $x617 invalidFree_0)))
 ...
 (let (($x1232 (and (and (and (or $x634 invalidFree_0) $x1228) (or $x615 invalidFree_0)) $x1226)))
 (let (($x1237 (and (and (and (and (and $x1232 $x1225) (or $x581 invalidFree_0)) $x1223) $x1222) $x1221)))
 (let (($x1243 (and (and (and (and (and $x1237 $x1220) $x1219) $x1218) (or $x506 invalidFree_0)) $x1242)))
 (let (($x449 (= loc_0 1)))
 (let (($x1215 (not invalidFree_0)))
 (let (($x451 (and (and (= H_0 emp) (= AH_0 emp)) $x449)))
 (let (($x1251 (and (and $x451 $x1215) (=> $x449 (and (and (and (and $x1243 $x693) $x698) $x1247) $x701)))))
 (let (($x1341 (and (and (and $x1251 $x1318) (=> $x763 $x1328)) (=> $x977 (and (and (and $x1334 $x1029) $x1337) $x1035)))))
 (let (($x1363 (and (and $x1341 (=> $x1035 (and (and (and $x1345 $x1087) $x1348) $x1093))) (=> $x1093 (and (and (and $x1356 $x1145) $x1359) $x1151)))))
 (and (and $x1363 (=> $x1151 (and (and (and $x1367 $x1203) $x1370) $x1209))) invalidFree_7))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
