...
(assert
 (let (($x1632 (= AH_5 (uplus ah9 (pt l19 (Pt_R_1 d20))))))
 (let (($x1625 (or (= H_5 (uplus h11 (pt l17 (Pt_R_0 l18)))) (= H_5 (uplus h11 (pt l17 (Pt_R_1 d19)))))))
 (let (($x1334 (= loc_5 5)))
 (let (($x1327 (= H_5 H_4)))
 ...
 (let (($x1113 (= loc_3 4)))
 (let (($x1599 (=> $x1113 (and (and (and (and (and $x1168 $x1172) $x1224) $x1231) $x1238) $x1244))))
 (let (($x1605 (and $x1599 (=> $x1162 (and (and (and (and $x1119 $x1224) $x1251) $x1238) $x1244)))))
 (let (($x1143 (= H_3 H_2)))
 ...
 (let (($x965 (= loc_2 4)))
 (let (($x1591 (=> $x965 (and (and (and (and (and $x1152 $x1155) $x1138) $x1107) $x1144) $x1162))))
 (let (($x1582 (and (and (and $x1119 $x1138) (and $x1107 (= $r_main0_3 $r_main0_2))) $x1144)))
 (let (($x808 (= loc_2 3)))
 ...
 (let (($x1576 (and (and (and (and (and $x1036 $x1025) $x1016) $x1014) (and $x1054 true)) $x1100)))
 (let (($x986 (= $i9_main0_2 1)))
 (let (($x987 (and $x808 $x986)))
 (let (($x1585 (and (=> $x987 (and (and $x1576 $x1110) $x1113)) (=> $x1117 (and $x1582 $x1113)))))
 ...
 (let (($x1561 (and (and (and (and (and (and $x922 $x911) $x902) $x900) $x872) $x870) $x868)))
 (let (($x1567 (and (and (and (and (and $x1561 $x840) (and $x945 true)) $x958) $x962) $x965)))
 (let (($x666 (= loc_1 2)))
 ...
 (let (($x1547 (and (and (= $p6_main01_2 $M.0_1) (= $p7_main01_2 $p6_main01_2)) $x723)))
 (let (($x1553 (and (and (and (and (and (and $x1547 $x695) $x693) $x691) $x754) $x794) $x801)))
 ...
 (let (($x571 (= $M.01_1 nil)))
 (let (($x1538 (and (and (and (and (and (and $x571 $x569) $x558) $x556) $x554) $x543) $x541)))
 (let (($x494 (= loc_0 1)))
 (let (($x1544 (=> $x494 (and (and (and (and (and $x1538 $x530) $x1357) $x650) $x663) $x666))))
 (let (($x496 (and (and (= H_0 emp) (= AH_0 emp)) $x494)))
 (let (($x1570 (and (and $x496 $x1544) (and (=> $x684 (and $x1553 $x808)) (=> $x839 $x1567)))))
 (let (($x1612 (and (and (and $x1570 (and $x1585 $x1591)) $x1605) (=> $x1244 (and (and (and (and $x1119 $x1311) $x1321) $x1328) $x1334)))))
 (and $x1612 (and (and $x1334 $x1625) $x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
