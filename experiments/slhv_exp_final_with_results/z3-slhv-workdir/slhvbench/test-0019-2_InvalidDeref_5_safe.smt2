...
(assert
 (let (($x1249 (= loc_5 4)))
 (let (($x1246 (= invalidDeref_5 invalidDeref_4)))
 (let (($x1242 (= H_5 H_4)))
 ...
 (let (($x1237 (and (and (and (or true invalidDeref_4) (and true true)) $x1229) $x1236)))
 (let (($x1185 (= loc_4 4)))
 (let (($x1182 (= invalidDeref_4 invalidDeref_3)))
 (let (($x1178 (= H_4 H_3)))
 ...
 (let (($x1173 (and (and (and (or true invalidDeref_3) (and true true)) $x1165) $x1172)))
 (let (($x1121 (= loc_3 4)))
 ...
 (let (($x1188 (and (and $x952 (=> $x933 (and (and (and $x1083 $x1113) $x1117) $x1121))) (=> $x1121 (and (and (and $x1173 $x1179) $x1182) $x1185)))))
 (and (and $x1188 (=> $x1185 (and (and (and $x1237 $x1243) $x1246) $x1249))) invalidDeref_5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
