...
(assert
 (let (($x818 (= AH_2 (uplus ah5 (pt l30 (Pt_R_1 d9))))))
 (let (($x811 (or (= H_2 (uplus h9 (pt l28 (Pt_R_0 l29)))) (= H_2 (uplus h9 (pt l28 (Pt_R_1 d8)))))))
 (let (($x693 (= loc_2 2)))
 (let (($x686 (= H_2 H_1)))
 ...
 (let (($x780 (and (and (and (and (and (and $x588 $x565) $x563) $x552) $x541) $x529) $x527)))
 (let (($x786 (and (and (and (and (and (and $x780 $x515) $x503) $x492) $x483) $x449) $x447)))
 (let (($x346 (= loc_0 1)))
 (let (($x348 (and (and (= H_0 emp) (= AH_0 emp)) $x346)))
 (let (($x792 (and $x348 (=> $x346 (and (and (and $x786 $x413) (and $x637 true)) $x643)))))
 (let (($x798 (and $x792 (=> $x643 (and (and (and (and $x648 $x676) $x680) $x687) $x693)))))
 (and $x798 (and (and $x693 $x811) $x818))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
