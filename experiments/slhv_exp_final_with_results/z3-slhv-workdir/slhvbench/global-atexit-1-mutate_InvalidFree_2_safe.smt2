...
(assert
 (let (($x575 (= loc_2 4)))
 (let (($x606 (= invalidFree_2 invalidFree_1)))
 ...
 (let (($x610 (or $x530 invalidFree_1)))
 (let (($x541 (= $p5_main01_2 $M.0_1)))
 (let (($x611 (or $x541 invalidFree_1)))
 (let (($x543 (= $p4_main01_2 $p3_main01_2)))
 (let (($x612 (or $x543 invalidFree_1)))
 ...
 (let (($x619 (and (and (and (and (and (or $x554 invalidFree_1) $x612) $x611) $x610) $x617) $x571)))
 (let (($x432 (= loc_1 2)))
 ...
 (let (($x603 (and (and (and (or true invalidFree_1) (and true true)) $x476) $x489)))
 (let (($x436 (= $i2_main0_1 1)))
 (let (($x437 (and $x432 $x436)))
 (let (($x624 (and (=> $x437 (and (and (and $x603 $x496) $x606) $x503)) (=> $x519 (and (and (and $x619 $x489) $x606) $x575)))))
 (let (($x595 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x584 (or $x338 invalidFree_0)))
 (let (($x340 (= $p1_main01_1 $p0_main01_1)))
 (let (($x585 (or $x340 invalidFree_0)))
 ...
 (let (($x353 (= $M.01_1 nil)))
 (let (($x587 (or $x353 invalidFree_0)))
 (let (($x592 (and (and (and (and (and $x587 (or $x351 invalidFree_0)) $x585) $x584) $x372) $x409)))
 (let (($x324 (= loc_0 1)))
 (let (($x582 (not invalidFree_0)))
 (let (($x326 (and (and (= H_0 emp) (= AH_0 emp)) $x324)))
 (let (($x599 (and (and $x326 $x582) (=> $x324 (and (and (and $x592 $x426) $x595) $x432)))))
 (and (and $x599 $x624) invalidFree_2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
