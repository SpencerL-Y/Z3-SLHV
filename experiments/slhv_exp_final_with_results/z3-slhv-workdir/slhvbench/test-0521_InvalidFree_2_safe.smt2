...
(assert
 (let (($x5150 (= loc_2 4)))
 (let (($x5185 (= invalidFree_2 invalidFree_1)))
 (let (($x5111 (= H_2 H_1)))
 ...
 (let (($x5192 (and (and (and (or true invalidFree_1) (and true true)) $x5145) $x5105)))
 (let (($x4549 (= loc_1 2)))
 ...
 (let (($x5179 (or $x4556 invalidFree_1)))
 (let (($x5187 (and (and (and (and (and (and $x5179 $x4560) $x4975) $x5105) $x5112) $x5185) $x5118)))
 (let (($x4554 (= $i5_main0_1 1)))
 (let (($x4555 (and $x4549 $x4554)))
 (let (($x5197 (and (=> $x4555 $x5187) (=> $x5122 (and (and (and $x5192 $x5112) $x5185) $x5150)))))
 (let (($x5174 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x5159 (or $x3744 invalidFree_0)))
 ...
 (let (($x5166 (and (and (or $x3808 invalidFree_0) (or $x3791 invalidFree_0)) (or $x3780 invalidFree_0))))
 (let (($x5169 (and (and (and $x5166 (or $x3769 invalidFree_0)) (or $x3752 invalidFree_0)) $x5159)))
 (let (($x3711 (= loc_0 1)))
 (let (($x5177 (=> $x3711 (and (and (and (and (and $x5169 $x3838) $x4375) $x4543) $x5174) $x4549))))
 (let (($x5157 (not invalidFree_0)))
 (let (($x3713 (and (and (= H_0 emp) (= AH_0 emp)) $x3711)))
 (and (and (and (and $x3713 $x5157) $x5177) $x5197) invalidFree_2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
