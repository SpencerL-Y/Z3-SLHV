...
(assert
 (let (($x555 (= loc_5 6)))
 (let (($x658 (= invalidFree_5 invalidFree_4)))
 (let (($x541 (= H_5 H_4)))
 ...
 (let (($x655 (and (and (and (or true invalidFree_4) (and true true)) $x519) $x535)))
 (let (($x659 (and (and $x655 $x542) $x658)))
 (let (($x495 (= loc_4 6)))
 (let (($x664 (and (=> (= loc_4 3) (and $x659 (= loc_5 3))) (=> (= loc_4 5) (and $x659 (= loc_5 5))))))
 (let (($x641 (= invalidFree_4 invalidFree_3)))
 (let (($x481 (= H_4 H_3)))
 ...
 (let (($x638 (and (and (and (or true invalidFree_3) (and true true)) $x459) $x475)))
 (let (($x642 (and (and $x638 $x482) $x641)))
 (let (($x435 (= loc_3 6)))
 (let (($x647 (and (=> (= loc_3 3) (and $x642 (= loc_4 3))) (=> (= loc_3 5) (and $x642 (= loc_4 5))))))
 (let (($x612 (= invalidFree_3 invalidFree_2)))
 (let (($x399 (= H_3 H_2)))
 ...
 (let (($x625 (or $x425 invalidFree_2)))
 (let (($x631 (and (and (and (and (and (and $x625 $x428) $x377) $x390) $x400) $x612) $x435)))
 (let (($x353 (= loc_2 4)))
 (let (($x424 (and $x353 (not (= $i0_h0_2 1)))))
 (let (($x418 (= loc_3 5)))
 (let (($x392 (= $r_main0_3 $r_main0_2)))
 (let (($x393 (and $x390 $x392)))
 (let (($x619 (and (and (and (or false invalidFree_2) (and true true)) $x377) $x393)))
 (let (($x409 (= $i0_h0_2 1)))
 (let (($x410 (and $x353 $x409)))
 (let (($x406 (= loc_3 3)))
 (let (($x609 (and (and (and (or true invalidFree_2) (and true true)) $x377) $x393)))
 (let (($x280 (= loc_2 3)))
 (let (($x624 (and (=> $x280 (and (and (and $x609 $x400) $x612) $x406)) (=> $x410 (and (and (and $x619 $x400) $x612) $x418)))))
 (let (($x586 (= invalidFree_2 invalidFree_1)))
 ...
 (let (($x590 (or $x307 invalidFree_1)))
 (let (($x318 (= $p2_f01_2 $M.0_1)))
 (let (($x591 (or $x318 invalidFree_1)))
 (let (($x320 (= $p1_f01_2 $p0_f01_2)))
 (let (($x592 (or $x320 invalidFree_1)))
 ...
 (let (($x599 (and (and (and (and (and (or $x331 invalidFree_1) $x592) $x591) $x590) $x597) $x349)))
 (let (($x224 (= loc_1 2)))
 ...
 (let (($x583 (and (and (and (or false invalidFree_1) (and true true)) $x250) $x266)))
 (let (($x228 (= $i3_main0_1 1)))
 (let (($x229 (and $x224 $x228)))
 (let (($x604 (and (=> $x229 (and (and (and $x583 $x273) $x586) $x280)) (=> $x296 (and (and (and $x599 $x266) $x586) $x353)))))
 (let (($x575 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x564 (or $x150 invalidFree_0)))
 (let (($x152 (= $p1_main01_1 $p0_main01_1)))
 (let (($x565 (or $x152 invalidFree_0)))
 ...
 (let (($x165 (= $M.01_1 nil)))
 (let (($x567 (or $x165 invalidFree_0)))
 (let (($x572 (and (and (and (and (and $x567 (or $x163 invalidFree_0)) $x565) $x564) $x184) $x197)))
 (let (($x136 (= loc_0 1)))
 (let (($x562 (not invalidFree_0)))
 (let (($x138 (and (and (= H_0 emp) (= AH_0 emp)) $x136)))
 (let (($x579 (and (and $x138 $x562) (=> $x136 (and (and (and $x572 $x218) $x575) $x224)))))
 (let (($x651 (and (and (and $x579 $x604) (and $x624 (=> $x424 $x631))) (and $x647 (=> $x435 (and $x642 $x495))))))
 (and (and $x651 (and $x664 (=> $x495 (and $x659 $x555)))) invalidFree_5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
