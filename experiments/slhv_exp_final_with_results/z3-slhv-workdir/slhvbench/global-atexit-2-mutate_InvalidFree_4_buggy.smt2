...
(assert
 ...
 (let (($x1454 (= invalidFree_4 invalidFree4_4)))
 (let (($x1253 (= H_4 H7_4)))
 ...
 (let (($x1436 (or $x1209 invalidFree4_4)))
 (let (($x1437 (= invalidFree4_4 invalidFree_3)))
 (let (($x1438 (and invalidFree_3 $x1437)))
 ...
 (let (($x1445 (or (= $p1_free_g101_4 nil) (= ah8_4 (uplus AH_3 (pt $p1_free_g101_4 (Pt_R_1 d18_4)))))))
 (let (($x1446 (and $x1445 invalidFree4_4)))
 (let (($x1239 (= $p1_free_g101_4 $p0_free_g101_4)))
 (let (($x1449 (or $x1239 invalidFree_3)))
 (let (($x1241 (= $p0_free_g101_4 $M.0_3)))
 (let (($x1450 (or $x1241 invalidFree_3)))
 (let (($x1453 (and (and (and $x1450 $x1449) (or (or $x1446 (and $x1237 $x1437)) $x1438)) $x1436)))
 (let (($x1104 (= loc_3 6)))
 (let (($x1460 (=> $x1104 (and (and (and (and $x1453 (and $x1254 $x1454)) $x1270) $x1182) $x1274))))
 (let (($x1195 (= loc_4 5)))
 (let (($x1429 (= invalidFree_4 invalidFree_3)))
 (let (($x1188 (= H_4 H_3)))
 ...
 (let (($x1426 (and (and (and (or true invalidFree_3) (and true true)) $x1172) $x1182)))
 (let (($x1006 (= loc_3 5)))
 (let (($x1380 (= invalidFree_3 invalidFree_2)))
 (let (($x998 (= H_3 H_2)))
 ...
 (let (($x1416 (and (and (and (or true invalidFree_2) (and true true)) $x985) $x1101)))
 (let (($x923 (= loc_2 4)))
 ...
 (let (($x1405 (= invalidFree_3 invalidFree3_3)))
 (let (($x1087 (= H_3 H6_3)))
 ...
 (let (($x1387 (= invalidFree3_3 invalidFree_2)))
 (let (($x1388 (and invalidFree_2 $x1387)))
 (let (($x1027 (= H6_3 h9_3)))
 ...
 (let (($x1395 (or (= $p4_free_g201_3 nil) (= ah6_3 (uplus AH_2 (pt $p4_free_g201_3 (Pt_R_1 d14_3)))))))
 (let (($x1396 (and $x1395 invalidFree3_3)))
 (let (($x1055 (= $p4_free_g201_3 $p3_free_g201_3)))
 (let (($x1399 (or $x1055 invalidFree_2)))
 (let (($x1064 (and (= H_2 (uplus h7_3 (pt $p2_free_g201_3 (Pt_R_0 l11_3)))) (= $p3_free_g201_3 l11_3))))
 (let (($x1400 (or $x1064 invalidFree_2)))
 (let (($x1075 (= $p2_free_g201_3 $M.0_2)))
 (let (($x1401 (or $x1075 invalidFree_2)))
 (let (($x1404 (and (and (and $x1401 $x1400) $x1399) (or (or $x1396 (and $x1053 $x1387)) $x1388))))
 (let (($x1025 (= $i1_free_g20_2 1)))
 (let (($x1026 (and $x923 $x1025)))
 (let (($x1411 (=> $x1026 (and (and (and (and $x1404 (and $x1088 $x1405)) $x1098) $x1101) $x1104))))
 (let (($x932 (= $r_main0_3 $r_main01_3)))
 (let (($x933 (and $x932 true)))
 (let (($x929 (= $r_main01_3 0)))
 (let (($x1374 (or $x929 invalidFree_2)))
 (let (($x1382 (and (and (and (and (and (and $x1374 $x933) $x985) $x992) $x999) $x1380) $x1006)))
 (let (($x749 (= loc_2 3)))
 (let (($x1421 (and (and (=> $x749 $x1382) $x1411) (=> $x1109 (and (and (and $x1416 $x999) $x1380) $x1104)))))
 ...
 (let (($x1365 (= invalidFree_2 invalidFree2_2)))
 (let (($x903 (= H_2 H5_2)))
 (let (($x901 (= AH_2 AH4_2)))
 ...
 (let (($x1325 (or $x791 invalidFree2_2)))
 (let (($x793 (= $M.03_2 nil)))
 (let (($x1326 (or $x793 invalidFree2_2)))
 (let (($x1327 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1328 (and invalidFree1_2 $x1327)))
 (let (($x795 (= H5_2 h6_2)))
 ...
 (let (($x1335 (or (= $p10_main01_2 nil) (= ah4_2 (uplus AH3_2 (pt $p10_main01_2 (Pt_R_1 d10_2)))))))
 (let (($x1336 (and $x1335 invalidFree2_2)))
 (let (($x823 (= $p10_main01_2 $p9_main01_2)))
 (let (($x1339 (or $x823 invalidFree1_2)))
 (let (($x825 (= $p9_main01_2 $M.0_1)))
 (let (($x1340 (or $x825 invalidFree1_2)))
 (let (($x1341 (= invalidFree1_2 invalidFree_1)))
 (let (($x1342 (and invalidFree_1 $x1341)))
 (let (($x827 (= H4_2 h5_2)))
 ...
 (let (($x1349 (or (= $p8_main01_2 nil) (= ah2_2 (uplus AH_1 (pt $p8_main01_2 (Pt_R_1 d6_2)))))))
 (let (($x1350 (and $x1349 invalidFree1_2)))
 (let (($x855 (= $p8_main01_2 $p7_main01_2)))
 (let (($x1353 (or $x855 invalidFree_1)))
 (let (($x864 (and (= H_1 (uplus h3_2 (pt $p6_main01_2 (Pt_R_0 l5_2)))) (= $p7_main01_2 l5_2))))
 (let (($x1354 (or $x864 invalidFree_1)))
 (let (($x875 (= $p6_main01_2 $M.0_1)))
 (let (($x1355 (or $x875 invalidFree_1)))
 (let (($x1358 (and (and (and $x1355 $x1354) $x1353) (or (or $x1350 (and $x853 $x1341)) $x1342))))
 (let (($x1361 (and (and (and $x1358 $x1340) $x1339) (or (or $x1336 (and $x821 $x1327)) $x1328))))
 (let (($x1367 (and (and (and (and $x1361 $x1326) $x1325) (or $x789 invalidFree2_2)) (and $x904 $x1365))))
 (let (($x666 (= loc_1 2)))
 (let (($x782 (and $x666 (not (= $i5_main0_1 1)))))
 (let (($x1314 (= invalidFree_2 invalidFree_1)))
 (let (($x741 (= H_2 H_1)))
 ...
 (let (($x1311 (and (and (and (or true invalidFree_1) (and true true)) $x725) $x735)))
 (let (($x670 (= $i5_main0_1 1)))
 (let (($x671 (and $x666 $x670)))
 (let (($x1372 (and (=> $x671 (and (and (and $x1311 $x742) $x1314) $x749)) (=> $x782 (and (and (and $x1367 $x917) $x920) $x923)))))
 (let (($x1303 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1287 (or $x556 invalidFree_0)))
 (let (($x558 (= $p1_main01_1 $p0_main01_1)))
 (let (($x1288 (or $x558 invalidFree_0)))
 ...
 (let (($x571 (= $M.01_1 nil)))
 (let (($x1290 (or $x571 invalidFree_0)))
 (let (($x1294 (and (and (and (and $x1290 (or $x569 invalidFree_0)) $x1288) $x1287) (or $x554 invalidFree_0))))
 (let (($x1301 (and (and (and (and (and (and $x1294 $x1285) $x1284) $x1283) $x1298) $x650) $x663)))
 (let (($x494 (= loc_0 1)))
 (let (($x1281 (not invalidFree_0)))
 (let (($x496 (and (and (= H_0 emp) (= AH_0 emp)) $x494)))
 (let (($x1373 (and (and (and $x496 $x1281) (=> $x494 (and (and $x1301 $x1303) $x666))) $x1372)))
 (let (($x1462 (and (and $x1373 $x1421) (and (=> $x1006 (and (and (and $x1426 $x1189) $x1429) $x1195)) $x1460))))
 (and $x1462 invalidFree_4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
