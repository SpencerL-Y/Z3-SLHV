...
(assert
 (let (($x775 (or (= H_1 (uplus h12 (pt l30 (Pt_R_0 l31)))) (= H_1 (uplus h12 (pt l30 (Pt_R_1 d12)))))))
 (let (($x784 (and (and false $x775) (= AH_1 (uplus ah7 (pt l32 (Pt_R_1 d13)))))))
 (let (($x701 (= loc_1 2)))
 ...
 (let (($x750 (and (and (and (and (and (and $x634 $x617) $x615) $x604) $x593) $x581) $x570)))
 (let (($x756 (and (and (and (and (and (and $x750 $x559) $x547) $x536) $x527) $x515) $x506)))
 (let (($x449 (= loc_0 1)))
 (let (($x451 (and (and (= H_0 emp) (= AH_0 emp)) $x449)))
 (let (($x762 (and $x451 (=> $x449 (and (and (and (and $x756 $x734) $x693) $x698) $x701)))))
 (and $x762 $x784))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
