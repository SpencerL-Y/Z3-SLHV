...
(assert
 ...
 (let (($x1490 (= invalidFree_2 invalidFree4_2)))
 (let (($x1314 (= H_2 H7_2)))
 ...
 (let (($x1455 (= invalidFree4_2 invalidFree3_2)))
 (let (($x1456 (and invalidFree3_2 $x1455)))
 (let (($x1218 (= H7_2 h8_2)))
 ...
 (let (($x1463 (or (= $p25_main01_2 nil) (= ah8_2 (uplus AH5_2 (pt $p25_main01_2 (Pt_R_1 d34_2)))))))
 (let (($x1464 (and $x1463 invalidFree4_2)))
 (let (($x1252 (= $p25_main01_2 $p24_main01_2)))
 (let (($x1467 (or $x1252 invalidFree3_2)))
 (let (($x1255 (= $p24_main01_2 (locadd $p23_main01_2 (- 1)))))
 (let (($x1468 (or $x1255 invalidFree3_2)))
 (let (($x1257 (= $p23_main01_2 $M.2_1)))
 (let (($x1469 (or $x1257 invalidFree3_2)))
 (let (($x1470 (= invalidFree3_2 invalidFree_1)))
 (let (($x1471 (and invalidFree_1 $x1470)))
 (let (($x1259 (= H6_2 h7_2)))
 ...
 (let (($x1478 (or (= $p22_main01_2 nil) (= ah6_2 (uplus AH_1 (pt $p22_main01_2 (Pt_R_1 d28_2)))))))
 (let (($x1479 (and $x1478 invalidFree3_2)))
 (let (($x1293 (= $p22_main01_2 $p21_main01_2)))
 (let (($x1482 (or $x1293 invalidFree_1)))
 (let (($x1295 (= $p21_main01_2 $M.1_1)))
 (let (($x1483 (or $x1295 invalidFree_1)))
 (let (($x1486 (and (and (and $x1483 $x1482) (or (or $x1479 (and $x1291 $x1470)) $x1471)) $x1469)))
 (let (($x1489 (and (and (and $x1486 $x1468) $x1467) (or (or $x1464 (and $x1250 $x1455)) $x1456))))
 (let (($x961 (= loc_1 2)))
 (let (($x1217 (and $x961 (not (= $i15_main0_1 1)))))
 (let (($x1496 (=> $x1217 (and (and (and (and $x1489 (and $x1315 $x1490)) $x1331) $x1178) $x1184))))
 ...
 (let (($x1442 (= invalidFree_2 invalidFree2_2)))
 (let (($x1099 (= H_2 H5_2)))
 ...
 (let (($x1406 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1407 (and invalidFree1_2 $x1406)))
 (let (($x996 (= H5_2 h6_2)))
 ...
 (let (($x1414 (or (= $p20_main01_2 nil) (= ah4_2 (uplus AH3_2 (pt $p20_main01_2 (Pt_R_1 d22_2)))))))
 (let (($x1415 (and $x1414 invalidFree2_2)))
 (let (($x1030 (= $p20_main01_2 $p19_main01_2)))
 (let (($x1418 (or $x1030 invalidFree1_2)))
 (let (($x1033 (= $p19_main01_2 (locadd $p18_main01_2 (- 1)))))
 (let (($x1419 (or $x1033 invalidFree1_2)))
 (let (($x1035 (= $p18_main01_2 $M.2_1)))
 (let (($x1420 (or $x1035 invalidFree1_2)))
 (let (($x1421 (= invalidFree1_2 invalidFree_1)))
 ...
 (let (($x1429 (or (= $p17_main01_2 nil) (= ah2_2 (uplus AH_1 (pt $p17_main01_2 (Pt_R_1 d16_2)))))))
 (let (($x1430 (and $x1429 invalidFree1_2)))
 (let (($x1071 (= $p17_main01_2 $p16_main01_2)))
 (let (($x1433 (or $x1071 invalidFree_1)))
 (let (($x1073 (= $p16_main01_2 $M.1_1)))
 (let (($x1434 (or $x1073 invalidFree_1)))
 (let (($x1437 (and (and (and $x1434 $x1433) (or (or $x1430 (and $x1069 $x1421)) $x1422)) $x1420)))
 (let (($x1440 (and (and (and $x1437 $x1419) $x1418) (or (or $x1415 (and $x1028 $x1406)) $x1407))))
 (let (($x994 (= $i15_main0_1 1)))
 (let (($x995 (and $x961 $x994)))
 (let (($x1448 (=> $x995 (and (and (and (and $x1440 (and $x1100 $x1442)) $x1147) $x1178) $x1184))))
 ...
 (let (($x1354 (or $x778 invalidFree_0)))
 (let (($x780 (= $i6_main01_1 3)))
 (let (($x1355 (or $x780 invalidFree_0)))
 (let (($x782 (= $i5_main01_1 3)))
 (let (($x1356 (or $x782 invalidFree_0)))
 (let (($x784 (= $M.12_1 $p3_main01_1)))
 (let (($x1357 (or $x784 invalidFree_0)))
 (let (($x786 (= $p4_main01_1 $p3_main01_1)))
 (let (($x1358 (or $x786 invalidFree_0)))
 ...
 (let (($x1360 (or $x811 invalidFree_0)))
 (let (($x813 (= $i1_main01_1 3)))
 (let (($x1361 (or $x813 invalidFree_0)))
 (let (($x815 (= $i0_main01_1 3)))
 (let (($x1362 (or $x815 invalidFree_0)))
 (let (($x817 (= $M.02_1 3)))
 (let (($x1363 (or $x817 invalidFree_0)))
 (let (($x819 (= $M.21_1 nil)))
 (let (($x1364 (or $x819 invalidFree_0)))
 (let (($x821 (= $M.11_1 nil)))
 (let (($x1365 (or $x821 invalidFree_0)))
 (let (($x823 (= $M.01_1 0)))
 (let (($x1366 (or $x823 invalidFree_0)))
 (let (($x1372 (and (and (and (and (and (and $x1366 $x1365) $x1364) $x1363) $x1362) $x1361) $x1360)))
 (let (($x1377 (and (and (and (and (and $x1372 (or $x809 invalidFree_0)) $x1358) $x1357) $x1356) $x1355)))
 (let (($x1382 (and (and (and (and (and $x1377 $x1354) (or $x776 invalidFree_0)) $x1352) $x1351) $x1350)))
 (let (($x1388 (and (and (and (and (and (and $x1382 $x1349) $x1348) $x1347) $x1346) $x1345) $x1344)))
 (let (($x1396 (and (and (and (and (and $x1388 (or $x699 invalidFree_0)) $x1390) $x953) $x958) $x1395)))
 (let (($x638 (= loc_0 1)))
 (let (($x1341 (not invalidFree_0)))
 (let (($x640 (and (and (= H_0 emp) (= AH_0 emp)) $x638)))
 (let (($x1498 (and (and (and $x640 $x1341) (=> $x638 (and $x1396 $x961))) (and $x1448 $x1496))))
 (and $x1498 invalidFree_2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
