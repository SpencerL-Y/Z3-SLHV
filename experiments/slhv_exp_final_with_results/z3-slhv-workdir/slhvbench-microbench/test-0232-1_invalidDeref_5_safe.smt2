...
(declare-const invalidDeref13_4 Bool)
...
(declare-const invalidDeref11_4 Bool)
(declare-locvar l29_4 IntLoc)
(declare-hvar h23_4 IntHeap)
(declare-locvar l30_4 IntLoc)
(declare-hvar h24_4 IntHeap)
(declare-const invalidDeref10_4 Bool)
(declare-locvar l27_4 IntLoc)
(declare-hvar h21_4 IntHeap)
(declare-locvar l28_4 IntLoc)
(declare-hvar h22_4 IntHeap)
(declare-locvar l25_4 IntLoc)
(declare-hvar h19_4 IntHeap)
(declare-locvar l26_4 IntLoc)
(declare-hvar h20_4 IntHeap)
...
(assert
 (let (($x1726 (= loc_5 6)))
 (let (($x1722 (= invalidDeref_5 invalidDeref_4)))
 (let (($x1718 (= H_5 H_4)))
 ...
 (let (($x1713 (and (and (and (or (= $r_main01_5 0) invalidDeref_4) $x1635) $x1705) $x1712)))
 (let (($x1594 (= loc_4 5)))
 (let (($x1624 (= invalidDeref_4 invalidDeref_3)))
 (let (($x1621 (= H_4 H_3)))
 ...
 (let (($x1618 (and (and (and (or true invalidDeref_3) (and true true)) $x1616) $x1590)))
 (let (($x1348 (= loc_3 4)))
 (let (($x1598 (and $x1348 (not (= $i2_main0_3 1)))))
 (let (($x1580 (and (and (and (and (and $x1565 $x1567) $x1570) $x1573) $x1576) $x1579)))
 (let (($x1524 (= invalidDeref_4 invalidDeref13_4)))
 (let (($x1521 (= H_4 H9_4)))
 ...
 (let (($x1389 (= invalidDeref13_4 invalidDeref12_4)))
 (let (($x1390 (and invalidDeref12_4 $x1389)))
 ...
 (let (($x1401 (= $p0_main0_3 nil)))
 (let (($x1405 (= h27 (uplus H8_4 (pt $p0_main0_3 (Pt_R_0 l37_4))))))
 (let (($x1409 (or (or (and (or $x1405 $x1401) invalidDeref13_4) (and $x1399 $x1389)) $x1390)))
 ...
 (let (($x1443 (= invalidDeref12_4 invalidDeref11_4)))
 (let (($x1444 (and invalidDeref11_4 $x1443)))
 (let (($x1445 (= $p6_main01_4 l29_4)))
 (let (($x1449 (= H_3 (uplus h23_4 (pt $p0_main0_3 (Pt_R_0 l29_4))))))
 (let (($x1450 (and $x1449 $x1445)))
 (let (($x1455 (= h24_4 (uplus H_3 (pt $p0_main0_3 (Pt_R_0 l30_4))))))
 (let (($x1459 (or (or (and (or $x1455 $x1401) invalidDeref12_4) (and $x1450 $x1443)) $x1444)))
 (let (($x1460 (= invalidDeref11_4 invalidDeref10_4)))
 (let (($x1461 (and invalidDeref10_4 $x1460)))
 (let (($x1462 (= $p5_main01_4 l27_4)))
 (let (($x1466 (= H_3 (uplus h21_4 (pt $p4_main01_4 (Pt_R_0 l27_4))))))
 (let (($x1467 (and $x1466 $x1462)))
 (let (($x1469 (= $p4_main01_4 nil)))
 (let (($x1473 (= h22_4 (uplus H_3 (pt $p4_main01_4 (Pt_R_0 l28_4))))))
 (let (($x1477 (or (or (and (or $x1473 $x1469) invalidDeref11_4) (and $x1467 $x1460)) $x1461)))
 (let (($x1480 (= invalidDeref10_4 invalidDeref_3)))
 (let (($x1481 (and invalidDeref_3 $x1480)))
 (let (($x1482 (= $p3_main01_4 l25_4)))
 (let (($x1486 (= H_3 (uplus h19_4 (pt $p0_main0_3 (Pt_R_0 l25_4))))))
 (let (($x1487 (and $x1486 $x1482)))
 (let (($x1492 (= h20_4 (uplus H_3 (pt $p0_main0_3 (Pt_R_0 l26_4))))))
 (let (($x1496 (or (or (and (or $x1492 $x1401) invalidDeref10_4) (and $x1487 $x1480)) $x1481)))
 (let (($x1498 (and (and $x1496 (or (= $p4_main01_4 $p3_main01_4) invalidDeref10_4)) $x1477)))
 (let (($x1500 (and (and $x1498 $x1459) (or (= $p7_main01_4 $p6_main01_4) invalidDeref12_4))))
 (let (($x1526 (and (and (and $x1500 (or $x1439 invalidDeref12_4)) $x1409) (and $x1522 $x1524))))
 (let (($x1387 (= $i2_main0_3 1)))
 (let (($x1388 (and $x1348 $x1387)))
 (let (($x1628 (and (=> $x1388 (and (and (and $x1526 $x1580) $x1590) $x1594)) (=> $x1598 (and (and (and $x1618 $x1622) $x1624) $x1594)))))
 (let (($x1343 (= AH_3 AH_2)))
 ...
 (let (($x1629 (and (and $x1158 (=> $x1093 (and (and (and $x1334 $x1340) $x1344) $x1348))) $x1628)))
 (and (and $x1629 (=> $x1594 (and (and (and $x1713 $x1719) $x1722) $x1726))) invalidDeref_5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
