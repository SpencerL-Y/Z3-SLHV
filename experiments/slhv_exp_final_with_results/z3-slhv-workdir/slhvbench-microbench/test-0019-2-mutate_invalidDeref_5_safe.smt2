...
(assert
 (let (($x1121 (= loc_5 4)))
 (let (($x1118 (= invalidDeref_5 invalidDeref_4)))
 (let (($x1114 (= H_5 H_4)))
 ...
 (let (($x1109 (and (and (and (or true invalidDeref_4) (and true true)) $x1101) $x1108)))
 (let (($x1060 (= loc_4 4)))
 (let (($x1057 (= invalidDeref_4 invalidDeref_3)))
 (let (($x1053 (= H_4 H_3)))
 ...
 (let (($x1048 (and (and (and (or true invalidDeref_3) (and true true)) $x1040) $x1047)))
 (let (($x999 (= loc_3 4)))
 (let (($x994 (= AH_3 AH_2)))
 ...
 (let (($x1124 (and (and $x1002 (=> $x999 (and (and (and $x1048 $x1054) $x1057) $x1060))) (=> $x1060 (and (and (and $x1109 $x1115) $x1118) $x1121)))))
 (and $x1124 invalidDeref_5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
