...
(assert
 (let (($x1071 (or (= H_2 (uplus h11 (pt l17 (Pt_R_0 l18)))) (= H_2 (uplus h11 (pt l17 (Pt_R_1 d19)))))))
 (let (($x1080 (and (and false $x1071) (= AH_2 (uplus ah9 (pt l19 (Pt_R_1 d20)))))))
 (let (($x923 (= loc_2 4)))
 ...
 (let (($x1047 (and (and (and (and (and (and $x875 $x864) $x855) $x853) $x825) $x823) $x821)))
 (let (($x1053 (and (and (and (and (and $x1047 $x793) $x791) $x789) (and $x904 true)) $x917)))
 (let (($x666 (= loc_1 2)))
 ...
 (let (($x1057 (and (=> $x671 (and (and (and (and $x673 $x725) $x735) $x742) $x749)) (=> $x782 (and (and $x1053 $x920) $x923)))))
 ...
 (let (($x571 (= $M.01_1 nil)))
 (let (($x1029 (and (and (and (and (and (and $x571 $x569) $x558) $x556) $x554) $x543) $x541)))
 (let (($x494 (= loc_0 1)))
 (let (($x1035 (=> $x494 (and (and (and (and (and $x1029 $x530) $x947) $x650) $x663) $x666))))
 (let (($x496 (and (and (= H_0 emp) (= AH_0 emp)) $x494)))
 (and (and (and $x496 $x1035) $x1057) $x1080)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
