...
(assert
 (let (($x1001 (= AH_3 (uplus ah5 (pt l27 (Pt_R_1 d10))))))
 (let (($x994 (or (= H_3 (uplus h11 (pt l25 (Pt_R_0 l26)))) (= H_3 (uplus h11 (pt l25 (Pt_R_1 d9)))))))
 (let (($x841 (= loc_3 4)))
 (let (($x833 (= H_3 H_2)))
 ...
 (let (($x687 (= loc_2 3)))
 (let (($x980 (=> $x687 (and (and (and (and (and $x788 $x792) $x823) $x827) $x834) $x841))))
 ...
 (let (($x972 (=> $x711 (and (and (and (and (and $x772 $x741) $x778) $x666) $x673) $x687))))
 (let (($x679 (= H_2 H_1)))
 (let (($x680 (and (and true (= AH_2 AH_1)) $x679)))
 (let (($x632 (= $i10_main0_1 1)))
 (let (($x633 (and $x628 $x632)))
 (let (($x966 (=> $x633 (and (and (and (and (and true true) $x666) $x673) $x680) $x687))))
 ...
 (let (($x950 (and (and (and (and (and (and $x566 $x549) $x547) $x536) $x525) $x513) $x502)))
 (let (($x956 (and (and (and (and (and (and $x950 $x491) $x479) $x468) $x459) $x447) $x438)))
 (let (($x381 (= loc_0 1)))
 (let (($x383 (and (and (= H_0 emp) (= AH_0 emp)) $x381)))
 (let (($x974 (and (and $x383 (=> $x381 (and (and (and $x956 $x874) $x625) $x628))) (and $x966 $x972))))
 (and (and $x974 $x980) (and (and $x841 $x994) $x1001))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
