...
(assert
 (let (($x1514 (or (= H_2 (uplus h9 (pt l23 (Pt_R_0 l24)))) (= H_2 (uplus h9 (pt l23 (Pt_R_1 d35)))))))
 (let (($x1523 (and (and false $x1514) (= AH_2 (uplus ah9 (pt l25 (Pt_R_1 d36)))))))
 (let (($x1148 (= loc_2 3)))
 ...
 (let (($x1491 (and (and (= $p20_main01_2 $M.1_1) (= $p21_main01_2 $p20_main01_2)) $x1251)))
 (let (($x1497 (and (and (and (and (and (and $x1491 $x1217) $x1215) $x1213) $x1273) $x1286) $x1142)))
 (let (($x936 (= loc_1 2)))
 ...
 (let (($x1481 (and (and (= $p16_main01_2 $M.1_1) (= $p17_main01_2 $p16_main01_2)) $x1040)))
 (let (($x1487 (and (and (and (and (and (and $x1481 $x1006) $x1004) $x1002) $x1068) $x1111) $x1142)))
 ...
 (let (($x800 (= $M.02_1 3)))
 (let (($x802 (= $M.21_1 nil)))
 (let (($x1454 (and (and (and (and (= $M.01_1 0) (= $M.11_1 nil)) $x802) $x800) $x798)))
 (let (($x1460 (and (and (and (and (and (and $x1454 $x796) $x794) $x792) $x769) $x767) $x765)))
 (let (($x1466 (and (and (and (and (and (and $x1460 $x763) $x761) $x759) $x736) $x734) $x732)))
 (let (($x1472 (and (and (and (and (and (and $x1466 $x730) $x727) $x716) $x705) $x703) $x691)))
 (let (($x621 (= loc_0 1)))
 (let (($x1478 (=> $x621 (and (and (and (and (and $x1472 $x682) $x1345) $x928) $x933) $x936))))
 (let (($x623 (and (and (= H_0 emp) (= AH_0 emp)) $x621)))
 (let (($x1501 (and (and $x623 $x1478) (and (=> $x969 (and $x1487 $x1148)) (=> $x1180 (and $x1497 $x1148))))))
 (and $x1501 $x1523))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
