...
(assert
 (let (($x859 (= loc_2 3)))
 (let (($x962 (= invalidFree_2 invalidFree_1)))
 (let (($x871 (= H_2 H_1)))
 ...
 (let (($x960 (and (and (and (or true invalidFree_1) (and true true)) $x845) $x852)))
 (let (($x714 (= loc_1 2)))
 (let (($x863 (and $x714 (not (= $i10_main0_1 1)))))
 (let (($x950 (= invalidFree_2 invalidFree2_2)))
 (let (($x806 (= H_2 H7_2)))
 (let (($x804 (= AH_2 AH5_2)))
 (let (($x807 (and $x804 $x806)))
 (let (($x924 (= invalidFree2_2 invalidFree1_2)))
 (let (($x925 (and invalidFree1_2 $x924)))
 (let (($x740 (= H7_2 h10_2)))
 ...
 (let (($x932 (or (= $p9_main0_1 nil) (= ah4_2 (uplus AH4_2 (pt $p9_main0_1 (Pt_R_1 d8_2)))))))
 (let (($x933 (and $x932 invalidFree2_2)))
 (let (($x936 (= invalidFree1_2 invalidFree_1)))
 (let (($x937 (and invalidFree_1 $x936)))
 (let (($x771 (= H6_2 h9_2)))
 ...
 (let (($x944 (or (= $p7_main0_1 nil) (= ah2_2 (uplus AH_1 (pt $p7_main0_1 (Pt_R_1 d5_2)))))))
 (let (($x945 (and $x944 invalidFree1_2)))
 (let (($x948 (and (or (or $x945 (and $x800 $x936)) $x937) (or (or $x933 (and $x769 $x924)) $x925))))
 (let (($x738 (= $i10_main0_1 1)))
 (let (($x739 (and $x714 $x738)))
 (let (($x956 (=> $x739 (and (and (and (and $x948 (and $x807 $x950)) $x845) $x852) $x859))))
 (let (($x913 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x891 (or $x602 invalidFree_0)))
 (let (($x613 (= $p3_main01_1 $p1_main01_1)))
 (let (($x892 (or $x613 invalidFree_0)))
 ...
 (let (($x894 (or $x626 invalidFree_0)))
 ...
 (let (($x898 (and (and (and (or $x643 invalidFree_0) $x894) (or $x624 invalidFree_0)) $x892)))
 (let (($x903 (and (and (and (and (and $x898 $x891) (or $x590 invalidFree_0)) $x889) $x888) $x887)))
 (let (($x909 (and (and (and (and (and $x903 $x886) $x885) $x884) (or $x515 invalidFree_0)) $x908)))
 (let (($x458 (= loc_0 1)))
 (let (($x881 (not invalidFree_0)))
 (let (($x460 (and (and (= H_0 emp) (= AH_0 emp)) $x458)))
 (let (($x917 (and (and $x460 $x881) (=> $x458 (and (and (and (and $x909 $x706) $x711) $x913) $x714)))))
 (let (($x967 (and $x917 (and $x956 (=> $x863 (and (and (and $x960 $x872) $x962) $x859))))))
 (and $x967 invalidFree_2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
