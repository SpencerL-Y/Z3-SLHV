...
(assert
 (let (($x1249 (= loc_5 4)))
 (let (($x1395 (= invalidFree_5 invalidFree_4)))
 (let (($x1242 (= H_5 H_4)))
 (let (($x1243 (and (and true (= AH_5 AH_4)) $x1242)))
 (let (($x1235 (= $r_main0_5 $r_main0_4)))
 (let (($x1236 (and (and true (= $i10_main0_5 $i10_main0_4)) $x1235)))
 (let (($x1228 (= $p9_main0_5 $p9_main0_4)))
 (let (($x1225 (= $p8_main0_5 $p8_main0_4)))
 (let (($x1222 (= $p7_main0_5 $p7_main0_4)))
 (let (($x1219 (= $p6_main0_5 $p6_main0_4)))
 (let (($x1216 (= $p5_main0_5 $p5_main0_4)))
 (let (($x1213 (= $p4_main0_5 $p4_main0_4)))
 (let (($x1210 (= $p3_main0_5 $p3_main0_4)))
 (let (($x1207 (= $p2_main0_5 $p2_main0_4)))
 (let (($x1204 (= $p1_main0_5 $p1_main0_4)))
 (let (($x1201 (= $p13_main0_5 $p13_main0_4)))
 (let (($x1198 (= $p12_main0_5 $p12_main0_4)))
 (let (($x1195 (= $p11_main0_5 $p11_main0_4)))
 (let (($x1202 (and (and (and (and true (= $p0_main0_5 $p0_main0_4)) $x1195) $x1198) $x1201)))
 (let (($x1220 (and (and (and (and (and (and $x1202 $x1204) $x1207) $x1210) $x1213) $x1216) $x1219)))
 (let (($x1229 (and (and (and $x1220 $x1222) $x1225) $x1228)))
 (let (($x1392 (and (and (and (or true invalidFree_4) (and true true)) $x1229) $x1236)))
 (let (($x1185 (= loc_4 4)))
 (let (($x1384 (= invalidFree_4 invalidFree_3)))
 (let (($x1178 (= H_4 H_3)))
 (let (($x1179 (and (and true (= AH_4 AH_3)) $x1178)))
 (let (($x1171 (= $r_main0_4 $r_main0_3)))
 (let (($x1172 (and (and true (= $i10_main0_4 $i10_main0_3)) $x1171)))
 (let (($x1164 (= $p9_main0_4 $p9_main0_3)))
 (let (($x1161 (= $p8_main0_4 $p8_main0_3)))
 (let (($x1158 (= $p7_main0_4 $p7_main0_3)))
 (let (($x1155 (= $p6_main0_4 $p6_main0_3)))
 (let (($x1152 (= $p5_main0_4 $p5_main0_3)))
 (let (($x1149 (= $p4_main0_4 $p4_main0_3)))
 (let (($x1146 (= $p3_main0_4 $p3_main0_3)))
 (let (($x1143 (= $p2_main0_4 $p2_main0_3)))
 (let (($x1140 (= $p1_main0_4 $p1_main0_3)))
 (let (($x1137 (= $p13_main0_4 $p13_main0_3)))
 (let (($x1134 (= $p12_main0_4 $p12_main0_3)))
 (let (($x1131 (= $p11_main0_4 $p11_main0_3)))
 (let (($x1138 (and (and (and (and true (= $p0_main0_4 $p0_main0_3)) $x1131) $x1134) $x1137)))
 (let (($x1156 (and (and (and (and (and (and $x1138 $x1140) $x1143) $x1146) $x1149) $x1152) $x1155)))
 (let (($x1165 (and (and (and $x1156 $x1158) $x1161) $x1164)))
 (let (($x1381 (and (and (and (or true invalidFree_3) (and true true)) $x1165) $x1172)))
 (let (($x1121 (= loc_3 4)))
 ...
 (let (($x1370 (= invalidFree_3 invalidFree3_3)))
 (let (($x1078 (= H_3 H10_3)))
 ...
 (let (($x977 (= $r_main01_3 0)))
 (let (($x1345 (or $x977 invalidFree3_3)))
 (let (($x1346 (= invalidFree3_3 invalidFree_2)))
 (let (($x1347 (and invalidFree_2 $x1346)))
 ...
 (let (($x1354 (or (= $p13_main01_3 nil) (= ah6_3 (uplus AH_2 (pt $p13_main01_3 (Pt_R_1 d11_3)))))))
 (let (($x1355 (and $x1354 invalidFree3_3)))
 (let (($x1010 (= $p13_main01_3 $p1_main0_2)))
 (let (($x1358 (or $x1010 invalidFree_2)))
 (let (($x1021 (and (= H8_3 (uplus h13_3 (pt $p12_main01_3 (Pt_R_0 l27_3)))) (= H9_3 (uplus h13_3 (pt $p12_main01_3 (Pt_R_0 nil)))))))
 (let (($x1359 (or $x1021 invalidFree_2)))
 (let (($x1033 (= $p12_main01_3 (locadd $p1_main0_2 1))))
 (let (($x1360 (or $x1033 invalidFree_2)))
 (let (($x1044 (and (= H_2 (uplus h11_3 (pt $p11_main01_3 (Pt_R_0 l25_3)))) (= H8_3 (uplus h11_3 (pt $p11_main01_3 (Pt_R_0 nil)))))))
 (let (($x1361 (or $x1044 invalidFree_2)))
 (let (($x1055 (= $p11_main01_3 $p1_main0_2)))
 (let (($x1362 (or $x1055 invalidFree_2)))
 (let (($x1367 (and (and (and (and (and $x1362 $x1361) $x1360) $x1359) $x1358) (or (or $x1355 (and $x1008 $x1346)) $x1347))))
 (let (($x1375 (and (and (and (and (and $x1367 $x1345) (and $x1079 $x1370)) $x1113) $x1117) $x1121)))
 (let (($x933 (= loc_2 3)))
 (let (($x1336 (= invalidFree_2 invalidFree_1)))
 (let (($x945 (= H_2 H_1)))
 ...
 (let (($x1334 (and (and (and (or true invalidFree_1) (and true true)) $x919) $x926)))
 (let (($x785 (= loc_1 2)))
 (let (($x937 (and $x785 (not (= $i10_main0_1 1)))))
 (let (($x1324 (= invalidFree_2 invalidFree2_2)))
 (let (($x877 (= H_2 H7_2)))
 (let (($x875 (= AH_2 AH5_2)))
 (let (($x878 (and $x875 $x877)))
 (let (($x1298 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1299 (and invalidFree1_2 $x1298)))
 (let (($x811 (= H7_2 h10_2)))
 ...
 (let (($x1306 (or (= $p9_main0_1 nil) (= ah4_2 (uplus AH4_2 (pt $p9_main0_1 (Pt_R_1 d8_2)))))))
 (let (($x1307 (and $x1306 invalidFree2_2)))
 (let (($x1310 (= invalidFree1_2 invalidFree_1)))
 (let (($x1311 (and invalidFree_1 $x1310)))
 (let (($x842 (= H6_2 h9_2)))
 ...
 (let (($x1318 (or (= $p7_main0_1 nil) (= ah2_2 (uplus AH_1 (pt $p7_main0_1 (Pt_R_1 d5_2)))))))
 (let (($x1319 (and $x1318 invalidFree1_2)))
 (let (($x1322 (and (or (or $x1319 (and $x871 $x1310)) $x1311) (or (or $x1307 (and $x840 $x1298)) $x1299))))
 (let (($x809 (= $i10_main0_1 1)))
 (let (($x810 (and $x785 $x809)))
 (let (($x1330 (=> $x810 (and (and (and (and $x1322 (and $x878 $x1324)) $x919) $x926) $x933))))
 (let (($x1287 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1265 (or $x669 invalidFree_0)))
 (let (($x680 (= $p3_main01_1 $p1_main01_1)))
 (let (($x1266 (or $x680 invalidFree_0)))
 ...
 (let (($x1268 (or $x693 invalidFree_0)))
 ...
 (let (($x1272 (and (and (and (or $x710 invalidFree_0) $x1268) (or $x691 invalidFree_0)) $x1266)))
 (let (($x1277 (and (and (and (and (and $x1272 $x1265) (or $x657 invalidFree_0)) $x1263) $x1262) $x1261)))
 (let (($x1283 (and (and (and (and (and $x1277 $x1260) $x1259) $x1258) (or $x582 invalidFree_0)) $x1282)))
 (let (($x525 (= loc_0 1)))
 (let (($x1255 (not invalidFree_0)))
 (let (($x527 (and (and (= H_0 emp) (= AH_0 emp)) $x525)))
 (let (($x1291 (and (and $x527 $x1255) (=> $x525 (and (and (and (and $x1283 $x777) $x782) $x1287) $x785)))))
 (let (($x1341 (and $x1291 (and $x1330 (=> $x937 (and (and (and $x1334 $x946) $x1336) $x933))))))
 (let (($x1388 (and (and $x1341 (=> $x933 $x1375)) (=> $x1121 (and (and (and $x1381 $x1179) $x1384) $x1185)))))
 (and (and $x1388 (=> $x1185 (and (and (and $x1392 $x1243) $x1395) $x1249))) invalidFree_5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
