...
(assert
 (let (($x1176 (= loc_2 4)))
 (let (($x1244 (= invalidFree_2 invalidFree_1)))
 (let (($x1145 (= H_2 H_1)))
 ...
 (let (($x1251 (and (and (and (or true invalidFree_1) (and true true)) $x1090) $x1171)))
 (let (($x1015 (= loc_1 2)))
 ...
 (let (($x1238 (or $x1022 invalidFree_1)))
 (let (($x1246 (and (and (and (and (and (and $x1238 $x1026) $x1090) $x1139) $x1146) $x1244) $x1152)))
 (let (($x1020 (= $i1_foo0_1 1)))
 (let (($x1021 (and $x1015 $x1020)))
 (let (($x1256 (and (=> $x1021 $x1246) (=> $x1156 (and (and (and $x1251 $x1146) $x1244) $x1176)))))
 (let (($x1233 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x1194 (or $x806 invalidFree_0)))
 (let (($x808 (= $i6_main01_1 2)))
 (let (($x1195 (or $x808 invalidFree_0)))
 (let (($x810 (= $i5_main01_1 2)))
 (let (($x1196 (or $x810 invalidFree_0)))
 (let (($x812 (= $M.12_1 $p3_main01_1)))
 (let (($x1197 (or $x812 invalidFree_0)))
 (let (($x814 (= $p4_main01_1 $p3_main01_1)))
 (let (($x1198 (or $x814 invalidFree_0)))
 ...
 (let (($x1200 (or $x833 invalidFree_0)))
 (let (($x835 (= $i1_main01_1 2)))
 (let (($x1201 (or $x835 invalidFree_0)))
 (let (($x837 (= $i0_main01_1 2)))
 (let (($x1202 (or $x837 invalidFree_0)))
 (let (($x839 (= $M.02_1 2)))
 (let (($x1203 (or $x839 invalidFree_0)))
 (let (($x841 (= $M.31_1 nil)))
 (let (($x1204 (or $x841 invalidFree_0)))
 (let (($x843 (= $M.11_1 nil)))
 (let (($x1205 (or $x843 invalidFree_0)))
 (let (($x845 (= $M.01_1 0)))
 (let (($x1206 (or $x845 invalidFree_0)))
 (let (($x1212 (and (and (and (and (and (and $x1206 $x1205) $x1204) $x1203) $x1202) $x1201) $x1200)))
 (let (($x1217 (and (and (and (and (and $x1212 (or $x831 invalidFree_0)) $x1198) $x1197) $x1196) $x1195)))
 (let (($x1222 (and (and (and (and (and $x1217 $x1194) (or $x804 invalidFree_0)) $x1192) $x1191) $x1190)))
 (let (($x1227 (and (and (and (and (and $x1222 $x1189) $x1188) $x1187) $x1186) (or $x754 invalidFree_0))))
 (let (($x704 (= loc_0 1)))
 (let (($x1236 (=> $x704 (and (and (and (and (and $x1227 $x1228) $x979) $x1012) $x1233) $x1015))))
 (let (($x1183 (not invalidFree_0)))
 (let (($x706 (and (and (= H_0 emp) (= AH_0 emp)) $x704)))
 (and (and (and (and $x706 $x1183) $x1236) $x1256) invalidFree_2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
