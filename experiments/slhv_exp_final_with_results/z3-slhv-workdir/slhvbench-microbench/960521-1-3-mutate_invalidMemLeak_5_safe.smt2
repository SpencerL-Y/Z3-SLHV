...
(assert
 (let (($x1955 (= AH_5 (uplus ah9 (pt l25 (Pt_R_1 d36))))))
 (let (($x1948 (or (= H_5 (uplus h9 (pt l23 (Pt_R_0 l24)))) (= H_5 (uplus h9 (pt l23 (Pt_R_1 d35)))))))
 (let (($x1666 (= loc_5 4)))
 (let (($x1659 (= H_5 H_4)))
 ...
 (let (($x1184 (= loc_2 3)))
 (let (($x1922 (=> $x1184 (and (and (and (and (and $x1340 $x1344) $x1405) $x1433) $x1440) $x1447))))
 ...
 (let (($x1905 (and (and (= $p21_main01_2 $M.1_1) (= $p22_main01_2 $p21_main01_2)) $x1291)))
 (let (($x1911 (and (and (and (and (and (and $x1905 $x1257) $x1255) $x1252) $x1250) $x1316) $x1331)))
 (let (($x961 (= loc_1 2)))
 ...
 (let (($x1894 (and (and (= $p16_main01_2 $M.1_1) (= $p17_main01_2 $p16_main01_2)) $x1069)))
 (let (($x1900 (and (and (and (and (and (and $x1894 $x1035) $x1033) $x1030) $x1028) $x1101) $x1147)))
 (let (($x994 (= $i15_main0_1 1)))
 (let (($x995 (and $x961 $x994)))
 (let (($x1915 (and (=> $x995 (and (and $x1900 $x1178) $x1184)) (=> $x1217 (and (and $x1911 $x1178) $x1184)))))
 ...
 (let (($x817 (= $M.02_1 3)))
 (let (($x819 (= $M.21_1 nil)))
 (let (($x1867 (and (and (and (and (= $M.01_1 0) (= $M.11_1 nil)) $x819) $x817) $x815)))
 (let (($x1873 (and (and (and (and (and (and $x1867 $x813) $x811) $x809) $x786) $x784) $x782)))
 (let (($x1879 (and (and (and (and (and (and $x1873 $x780) $x778) $x776) $x753) $x751) $x749)))
 (let (($x1885 (and (and (and (and (and (and $x1879 $x747) $x744) $x733) $x722) $x720) $x708)))
 (let (($x638 (= loc_0 1)))
 (let (($x1891 (=> $x638 (and (and (and (and (and $x1885 $x699) $x1721) $x953) $x958) $x961))))
 (let (($x640 (and (and (= H_0 emp) (= AH_0 emp)) $x638)))
 (let (($x1929 (and (and (and (and $x640 $x1891) $x1915) $x1922) (=> $x1447 (and (and (and (and $x1452 $x1513) $x1544) $x1551) $x1557)))))
 (let (($x1935 (and $x1929 (=> $x1557 (and (and (and (and $x1452 $x1622) $x1653) $x1660) $x1666)))))
 (and $x1935 (and (and $x1666 $x1948) $x1955)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
