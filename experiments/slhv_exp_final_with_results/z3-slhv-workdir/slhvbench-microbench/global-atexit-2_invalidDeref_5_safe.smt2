...
(assert
 (let (($x1334 (= loc_5 5)))
 (let (($x1331 (= invalidDeref_5 invalidDeref_4)))
 (let (($x1327 (= H_5 H_4)))
 ...
 (let (($x1322 (and (and (and (or true invalidDeref_4) (and true true)) $x1311) $x1321)))
 (let (($x1244 (= loc_4 5)))
 (let (($x1241 (= invalidDeref_4 invalidDeref_3)))
 (let (($x1237 (= H_4 H_3)))
 ...
 (let (($x1252 (and (and (and (or true invalidDeref_3) (and true true)) $x1224) $x1251)))
 (let (($x1162 (= loc_3 5)))
 (let (($x1171 (= $r_main0_4 $r_main01_4)))
 (let (($x1172 (and $x1171 true)))
 (let (($x1232 (and (and (and (or (= $r_main01_4 0) invalidDeref_3) $x1172) $x1224) $x1231)))
 (let (($x1113 (= loc_3 4)))
 (let (($x1257 (and (=> $x1113 (and (and (and $x1232 $x1238) $x1241) $x1244)) (=> $x1162 (and (and (and $x1252 $x1238) $x1241) $x1244)))))
 ...
 (let (($x1258 (and (and (and (and (and $x496 $x498) $x668) (and $x810 $x967)) $x1165) $x1257)))
 (and (and $x1258 (=> $x1244 (and (and (and $x1322 $x1328) $x1331) $x1334))) invalidDeref_5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
