...
(assert
 (let (($x1702 (= AH_3 (uplus ah9 (pt l25 (Pt_R_1 d36))))))
 (let (($x1695 (or (= H_3 (uplus h9 (pt l23 (Pt_R_0 l24)))) (= H_3 (uplus h9 (pt l23 (Pt_R_1 d35)))))))
 (let (($x1447 (= loc_3 4)))
 (let (($x1439 (= H_3 H_2)))
 ...
 (let (($x1184 (= loc_2 3)))
 (let (($x1681 (=> $x1184 (and (and (and (and (and $x1340 $x1344) $x1405) $x1433) $x1440) $x1447))))
 ...
 (let (($x1664 (and (and (= $p21_main01_2 $M.1_1) (= $p22_main01_2 $p21_main01_2)) $x1291)))
 (let (($x1670 (and (and (and (and (and (and $x1664 $x1257) $x1255) $x1252) $x1250) $x1316) $x1331)))
 (let (($x961 (= loc_1 2)))
 ...
 (let (($x1653 (and (and (= $p16_main01_2 $M.1_1) (= $p17_main01_2 $p16_main01_2)) $x1069)))
 (let (($x1659 (and (and (and (and (and (and $x1653 $x1035) $x1033) $x1030) $x1028) $x1101) $x1147)))
 (let (($x994 (= $i15_main0_1 1)))
 (let (($x995 (and $x961 $x994)))
 (let (($x1674 (and (=> $x995 (and (and $x1659 $x1178) $x1184)) (=> $x1217 (and (and $x1670 $x1178) $x1184)))))
 ...
 (let (($x817 (= $M.02_1 3)))
 (let (($x819 (= $M.21_1 nil)))
 (let (($x1626 (and (and (and (and (= $M.01_1 0) (= $M.11_1 nil)) $x819) $x817) $x815)))
 (let (($x1632 (and (and (and (and (and (and $x1626 $x813) $x811) $x809) $x786) $x784) $x782)))
 (let (($x1638 (and (and (and (and (and (and $x1632 $x780) $x778) $x776) $x753) $x751) $x749)))
 (let (($x1644 (and (and (and (and (and (and $x1638 $x747) $x744) $x733) $x722) $x720) $x708)))
 (let (($x638 (= loc_0 1)))
 (let (($x1650 (=> $x638 (and (and (and (and (and $x1644 $x699) $x1502) $x953) $x958) $x961))))
 (let (($x640 (and (and (= H_0 emp) (= AH_0 emp)) $x638)))
 (and (and (and (and $x640 $x1650) $x1674) $x1681) (and (and $x1447 $x1695) $x1702))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
