...
(assert
 (let (($x977 (= loc_3 4)))
 (let (($x1094 (= invalidFree_3 invalidFree_2)))
 (let (($x969 (= H_3 H_2)))
 ...
 (let (($x1088 (or $x921 invalidFree_2)))
 (let (($x1096 (and (and (and (and (and (and $x1088 $x925) $x959) $x963) $x970) $x1094) $x977)))
 (let (($x763 (= loc_2 3)))
 ...
 (let (($x1079 (= invalidFree_2 invalidFree3_2)))
 (let (($x900 (= H_2 H8_2)))
 ...
 (let (($x1047 (or (= $p11_main01_2 nil) (= ah6_2 (uplus AH5_2 (pt $p11_main01_2 (Pt_R_1 d11_2)))))))
 (let (($x1048 (and $x1047 invalidFree3_2)))
 (let (($x830 (= $p11_main01_2 $p1_main0_1)))
 (let (($x1051 (or $x830 invalidFree2_2)))
 (let (($x1052 (= invalidFree2_2 invalidFree1_2)))
 (let (($x1053 (and invalidFree1_2 $x1052)))
 (let (($x832 (= H7_2 h10_2)))
 ...
 (let (($x1060 (or (= $p9_main0_1 nil) (= ah4_2 (uplus AH4_2 (pt $p9_main0_1 (Pt_R_1 d8_2)))))))
 (let (($x1061 (and $x1060 invalidFree2_2)))
 (let (($x1064 (= invalidFree1_2 invalidFree_1)))
 (let (($x1065 (and invalidFree_1 $x1064)))
 (let (($x863 (= H6_2 h9_2)))
 ...
 (let (($x1072 (or (= $p7_main0_1 nil) (= ah2_2 (uplus AH_1 (pt $p7_main0_1 (Pt_R_1 d5_2)))))))
 (let (($x1073 (and $x1072 invalidFree1_2)))
 (let (($x1076 (and (or (or $x1073 (and $x892 $x1064)) $x1065) (or (or $x1061 (and $x861 $x1052)) $x1053))))
 (let (($x1081 (and (and (and $x1076 $x1051) (or (or $x1048 (and $x828 $x1039)) $x1040)) (and $x901 $x1079))))
 (let (($x701 (= loc_1 2)))
 (let (($x798 (and $x701 (not (= $i10_main0_1 1)))))
 (let (($x1026 (= invalidFree_2 invalidFree_1)))
 (let (($x755 (= H_2 H_1)))
 ...
 (let (($x1023 (and (and (and (or true invalidFree_1) (and true true)) $x742) $x749)))
 (let (($x705 (= $i10_main0_1 1)))
 (let (($x706 (and $x701 $x705)))
 (let (($x1086 (and (=> $x706 (and (and (and $x1023 $x756) $x1026) $x763)) (=> $x798 (and (and (and $x1081 $x912) $x749) $x763)))))
 (let (($x1015 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x993 (or $x593 invalidFree_0)))
 (let (($x604 (= $p3_main01_1 $p1_main01_1)))
 (let (($x994 (or $x604 invalidFree_0)))
 ...
 (let (($x996 (or $x617 invalidFree_0)))
 ...
 (let (($x1000 (and (and (and (or $x634 invalidFree_0) $x996) (or $x615 invalidFree_0)) $x994)))
 (let (($x1005 (and (and (and (and (and $x1000 $x993) (or $x581 invalidFree_0)) $x991) $x990) $x989)))
 (let (($x1011 (and (and (and (and (and $x1005 $x988) $x987) $x986) (or $x506 invalidFree_0)) $x1010)))
 (let (($x449 (= loc_0 1)))
 (let (($x983 (not invalidFree_0)))
 (let (($x451 (and (and (= H_0 emp) (= AH_0 emp)) $x449)))
 (let (($x1019 (and (and $x451 $x983) (=> $x449 (and (and (and (and $x1011 $x693) $x698) $x1015) $x701)))))
 (and (and (and $x1019 $x1086) (=> $x763 $x1096)) invalidFree_3))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
