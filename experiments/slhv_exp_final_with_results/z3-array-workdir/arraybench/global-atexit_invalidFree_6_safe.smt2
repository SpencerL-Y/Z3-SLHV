...
(declare-fun invalidFree2_4 () Bool)
...
(assert
 (let (($x938 (= loc_6 8)))
 (let (($x1092 (= invalidFree_6 invalidFree_5)))
 ...
 (let (($x1093 (and (and (and (and invalidFree_5 (and true true)) $x912) $x925) $x1092)))
 (let (($x871 (= loc_5 8)))
 (let (($x1098 (and (=> (= loc_5 3) (and $x1093 (= loc_6 3))) (=> (= loc_5 5) (and $x1093 (= loc_6 5))))))
 (let (($x1072 (= invalidFree_5 invalidFree_4)))
 ...
 (let (($x1079 (or $x862 invalidFree_4)))
 (let (($x789 (= loc_4 7)))
 (let (($x1085 (=> $x789 (and (and (and (and (and $x1079 $x865) $x835) $x845) $x1072) $x871))))
 (let (($x857 (= loc_5 5)))
 (let (($x847 (= $r_main0_5 $r_main0_4)))
 (let (($x848 (and $x845 $x847)))
 (let (($x1073 (and (and (and (and invalidFree_4 (and true true)) $x835) $x848) $x1072)))
 (let (($x738 (= loc_4 5)))
 (let (($x1078 (and (=> (= loc_4 3) (and $x1073 (= loc_5 3))) (=> $x738 (and $x1073 $x857)))))
 (let (($x1035 (= invalidFree_4 invalidFree_3)))
 ...
 (let (($x1036 (and (and (and (and invalidFree_3 (and true true)) $x716) $x729) $x1035)))
 (let (($x675 (= loc_3 6)))
 (let (($x794 (and $x675 (not (= $i1_free_g20_3 1)))))
 (let (($x785 (and (and (and $x698 $x706) $x712) $x715)))
 (let (($x1056 (= invalidFree_4 invalidFree2_4)))
 (let (($x778 (= A_4 A5_4)))
 ...
 (let (($x1043 (= invalidFree2_4 invalidFree_3)))
 (let (($x1044 (and invalidFree_3 $x1043)))
 (let (($x750 (= A5_4 (free A_3 $p4_free_g201_4))))
 (let (($x751 (freeable A_3 $p4_free_g201_4)))
 (let (($x752 (and $x751 $x750)))
 (let (($x1046 (not $x751)))
 (let (($x1047 (and $x1046 invalidFree2_4)))
 (let (($x754 (= $p4_free_g201_4 $p3_free_g201_4)))
 (let (($x1050 (or $x754 invalidFree_3)))
 (let (($x759 (= $p3_free_g201_4 (read A_3 $p2_free_g201_4))))
 (let (($x1051 (or $x759 invalidFree_3)))
 (let (($x767 (= $p2_free_g201_4 $M.0_3)))
 (let (($x1052 (or $x767 invalidFree_3)))
 (let (($x1055 (and (and (and $x1052 $x1051) $x1050) (or (or $x1047 (and $x752 $x1043)) $x1044))))
 (let (($x747 (= $i1_free_g20_3 1)))
 (let (($x748 (and $x675 $x747)))
 (let (($x1062 (=> $x748 (and (and (and (and $x1055 (and $x779 $x1056)) $x785) $x729) $x789))))
 (let (($x1041 (and (=> (= loc_3 3) (and $x1036 (= loc_4 3))) (=> (= loc_3 5) (and $x1036 $x738)))))
 ...
 (let (($x1022 (= invalidFree_3 invalidFree1_3)))
 (let (($x657 (= A_3 A4_3)))
 ...
 (let (($x1006 (or $x629 invalidFree1_3)))
 (let (($x631 (= $M.03_3 0)))
 (let (($x1007 (or $x631 invalidFree1_3)))
 (let (($x1008 (= invalidFree1_3 invalidFree_2)))
 (let (($x1009 (and invalidFree_2 $x1008)))
 (let (($x634 (= A4_3 (free A_2 $p1_free_g101_3))))
 (let (($x635 (freeable A_2 $p1_free_g101_3)))
 (let (($x636 (and $x635 $x634)))
 (let (($x1012 (and (not $x635) invalidFree1_3)))
 (let (($x638 (= $p1_free_g101_3 $p0_free_g101_3)))
 (let (($x1015 (or $x638 invalidFree_2)))
 (let (($x640 (= $p0_free_g101_3 $M.0_2)))
 (let (($x1016 (or $x640 invalidFree_2)))
 (let (($x1019 (and (and (and $x1016 $x1015) (or (or $x1012 (and $x636 $x1008)) $x1009)) $x1007)))
 (let (($x1024 (and (and (and $x1019 $x1006) (or $x627 invalidFree1_3)) (and $x658 $x1022))))
 (let (($x538 (= loc_2 4)))
 (let (($x620 (and $x538 (not (= $i0_h0_2 1)))))
 (let (($x609 (= loc_3 5)))
 (let (($x992 (= invalidFree_3 invalidFree_2)))
 ...
 (let (($x999 (and (and (and (or false invalidFree_2) (and true true)) $x579) $x592)))
 (let (($x601 (= $i0_h0_2 1)))
 (let (($x602 (and $x538 $x601)))
 (let (($x598 (= loc_3 3)))
 (let (($x993 (and (and (and (and invalidFree_2 (and true true)) $x579) $x592) $x992)))
 (let (($x489 (= loc_2 3)))
 (let (($x1003 (and (=> $x489 (and $x993 $x598)) (=> $x602 (and (and $x999 $x992) $x609)))))
 (let (($x968 (= invalidFree_2 invalidFree_1)))
 ...
 (let (($x972 (or $x503 invalidFree_1)))
 (let (($x511 (= $p5_main01_2 $M.0_1)))
 (let (($x973 (or $x511 invalidFree_1)))
 (let (($x513 (= $p4_main01_2 $p3_main01_2)))
 (let (($x974 (or $x513 invalidFree_1)))
 (let (($x518 (and (mallocable_top A_1 $p3_main01_2 1) (= A2_2 (malloc A_1 $p3_main01_2 1)))))
 (let (($x975 (or $x518 invalidFree_1)))
 (let (($x982 (and (and (and (and (and (and $x975 $x974) $x973) $x972) $x979) $x534) $x482)))
 (let (($x425 (= loc_1 2)))
 ...
 (let (($x966 (and (and (and (or false invalidFree_1) (and true true)) $x469) $x482)))
 (let (($x429 (= $i2_main0_1 1)))
 (let (($x430 (and $x425 $x429)))
 (let (($x986 (and (=> $x430 (and (and $x966 $x968) $x489)) (=> $x499 (and (and $x982 $x968) $x538)))))
 (let (($x958 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x947 (or $x339 invalidFree_0)))
 (let (($x341 (= $p1_main01_1 $p0_main01_1)))
 (let (($x948 (or $x341 invalidFree_0)))
 (let (($x346 (and (mallocable_top A_0 $p0_main01_1 1) (= A1_1 (malloc A_0 $p0_main01_1 1)))))
 (let (($x949 (or $x346 invalidFree_0)))
 (let (($x348 (= $M.01_1 0)))
 (let (($x950 (or $x348 invalidFree_0)))
 (let (($x956 (and (and (and (and (and (and $x950 $x949) $x948) $x947) $x364) $x401) $x418)))
 (let (($x333 (= loc_0 1)))
 (let (($x962 (and (and (= A_0 epsilon) (not invalidFree_0)) (=> $x333 (and (and $x956 $x958) $x425)))))
 (let (($x1030 (and (and $x962 $x986) (and $x1003 (=> $x620 (and (and (and $x1024 $x668) $x671) $x675))))))
 (let (($x1087 (and (and $x1030 (and (and $x1041 $x1062) (=> $x794 (and $x1036 $x789)))) (and $x1078 $x1085))))
 (and (and $x1087 (and $x1098 (=> $x871 (and $x1093 $x938)))) invalidFree_6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
