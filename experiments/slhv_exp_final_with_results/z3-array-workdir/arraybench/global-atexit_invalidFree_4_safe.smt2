...
(assert
 (let (($x789 (= loc_4 7)))
 (let (($x891 (= invalidFree_4 invalidFree_3)))
 ...
 (let (($x892 (and (and (and (and invalidFree_3 (and true true)) $x716) $x729) $x891)))
 (let (($x675 (= loc_3 6)))
 (let (($x794 (and $x675 (not (= $i1_free_g20_3 1)))))
 (let (($x785 (and (and (and $x698 $x706) $x712) $x715)))
 (let (($x912 (= invalidFree_4 invalidFree2_4)))
 (let (($x778 (= A_4 A5_4)))
 ...
 (let (($x899 (= invalidFree2_4 invalidFree_3)))
 (let (($x900 (and invalidFree_3 $x899)))
 (let (($x750 (= A5_4 (free A_3 $p4_free_g201_4))))
 (let (($x751 (freeable A_3 $p4_free_g201_4)))
 (let (($x752 (and $x751 $x750)))
 (let (($x902 (not $x751)))
 (let (($x903 (and $x902 invalidFree2_4)))
 (let (($x754 (= $p4_free_g201_4 $p3_free_g201_4)))
 (let (($x906 (or $x754 invalidFree_3)))
 (let (($x759 (= $p3_free_g201_4 (read A_3 $p2_free_g201_4))))
 (let (($x907 (or $x759 invalidFree_3)))
 (let (($x767 (= $p2_free_g201_4 $M.0_3)))
 (let (($x908 (or $x767 invalidFree_3)))
 (let (($x911 (and (and (and $x908 $x907) $x906) (or (or $x903 (and $x752 $x899)) $x900))))
 (let (($x747 (= $i1_free_g20_3 1)))
 (let (($x748 (and $x675 $x747)))
 (let (($x918 (=> $x748 (and (and (and (and $x911 (and $x779 $x912)) $x785) $x729) $x789))))
 (let (($x897 (and (=> (= loc_3 3) (and $x892 (= loc_4 3))) (=> (= loc_3 5) (and $x892 (= loc_4 5))))))
 ...
 (let (($x878 (= invalidFree_3 invalidFree1_3)))
 (let (($x657 (= A_3 A4_3)))
 ...
 (let (($x862 (or $x629 invalidFree1_3)))
 (let (($x631 (= $M.03_3 0)))
 (let (($x863 (or $x631 invalidFree1_3)))
 (let (($x864 (= invalidFree1_3 invalidFree_2)))
 (let (($x865 (and invalidFree_2 $x864)))
 (let (($x634 (= A4_3 (free A_2 $p1_free_g101_3))))
 (let (($x635 (freeable A_2 $p1_free_g101_3)))
 (let (($x636 (and $x635 $x634)))
 (let (($x868 (and (not $x635) invalidFree1_3)))
 (let (($x638 (= $p1_free_g101_3 $p0_free_g101_3)))
 (let (($x871 (or $x638 invalidFree_2)))
 (let (($x640 (= $p0_free_g101_3 $M.0_2)))
 (let (($x872 (or $x640 invalidFree_2)))
 (let (($x875 (and (and (and $x872 $x871) (or (or $x868 (and $x636 $x864)) $x865)) $x863)))
 (let (($x880 (and (and (and $x875 $x862) (or $x627 invalidFree1_3)) (and $x658 $x878))))
 (let (($x538 (= loc_2 4)))
 (let (($x620 (and $x538 (not (= $i0_h0_2 1)))))
 (let (($x609 (= loc_3 5)))
 (let (($x848 (= invalidFree_3 invalidFree_2)))
 ...
 (let (($x855 (and (and (and (or false invalidFree_2) (and true true)) $x579) $x592)))
 (let (($x601 (= $i0_h0_2 1)))
 (let (($x602 (and $x538 $x601)))
 (let (($x598 (= loc_3 3)))
 (let (($x849 (and (and (and (and invalidFree_2 (and true true)) $x579) $x592) $x848)))
 (let (($x489 (= loc_2 3)))
 (let (($x859 (and (=> $x489 (and $x849 $x598)) (=> $x602 (and (and $x855 $x848) $x609)))))
 (let (($x824 (= invalidFree_2 invalidFree_1)))
 ...
 (let (($x835 (and $x530 true)))
 (let (($x503 (= A3_2 (write A2_2 $p5_main01_2 $p3_main01_2))))
 (let (($x828 (or $x503 invalidFree_1)))
 (let (($x511 (= $p5_main01_2 $M.0_1)))
 (let (($x829 (or $x511 invalidFree_1)))
 (let (($x513 (= $p4_main01_2 $p3_main01_2)))
 (let (($x830 (or $x513 invalidFree_1)))
 (let (($x518 (and (mallocable_top A_1 $p3_main01_2 1) (= A2_2 (malloc A_1 $p3_main01_2 1)))))
 (let (($x831 (or $x518 invalidFree_1)))
 (let (($x838 (and (and (and (and (and (and $x831 $x830) $x829) $x828) $x835) $x534) $x482)))
 (let (($x425 (= loc_1 2)))
 ...
 (let (($x822 (and (and (and (or false invalidFree_1) (and true true)) $x469) $x482)))
 (let (($x429 (= $i2_main0_1 1)))
 (let (($x430 (and $x425 $x429)))
 (let (($x842 (and (=> $x430 (and (and $x822 $x824) $x489)) (=> $x499 (and (and $x838 $x824) $x538)))))
 (let (($x814 (= invalidFree_1 invalidFree_0)))
 ...
 (let (($x803 (or $x339 invalidFree_0)))
 (let (($x341 (= $p1_main01_1 $p0_main01_1)))
 (let (($x804 (or $x341 invalidFree_0)))
 (let (($x346 (and (mallocable_top A_0 $p0_main01_1 1) (= A1_1 (malloc A_0 $p0_main01_1 1)))))
 (let (($x805 (or $x346 invalidFree_0)))
 (let (($x348 (= $M.01_1 0)))
 (let (($x806 (or $x348 invalidFree_0)))
 (let (($x812 (and (and (and (and (and (and $x806 $x805) $x804) $x803) $x364) $x401) $x418)))
 (let (($x333 (= loc_0 1)))
 (let (($x818 (and (and (= A_0 epsilon) (not invalidFree_0)) (=> $x333 (and (and $x812 $x814) $x425)))))
 (let (($x886 (and (and $x818 $x842) (and $x859 (=> $x620 (and (and (and $x880 $x668) $x671) $x675))))))
 (and (and $x886 (and (and $x897 $x918) (=> $x794 (and $x892 $x789)))) invalidFree_4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
