...
(assert
 (let (($x1106 (freeable A_5 l1)))
 (let (($x1107 (and (or (or (= loc_5 3) (= loc_5 5)) (= loc_5 8)) $x1106)))
 (let (($x871 (= loc_5 8)))
 ...
 (let (($x1089 (and (and (and true true) $x835) $x848)))
 (let (($x738 (= loc_4 5)))
 (let (($x1094 (and (=> (= loc_4 3) (and $x1089 (= loc_5 3))) (=> $x738 (and $x1089 $x857)))))
 (let (($x1100 (and $x1094 (=> $x789 (and (and (and (and $x862 $x865) $x835) $x845) $x871)))))
 ...
 (let (($x1068 (and (and $x432 $x716) $x729)))
 (let (($x675 (= loc_3 6)))
 ...
 (let (($x1079 (and (and (and (and (and $x767 $x759) $x754) $x752) (and $x779 true)) $x785)))
 (let (($x747 (= $i1_free_g20_3 1)))
 (let (($x748 (and $x675 $x747)))
 (let (($x1073 (and (=> (= loc_3 3) (and $x1068 (= loc_4 3))) (=> (= loc_3 5) (and $x1068 $x738)))))
 (let (($x1086 (and (and $x1073 (=> $x748 (and (and $x1079 $x729) $x789))) (=> $x794 (and $x1068 $x789)))))
 ...
 (let (($x1060 (and (and (and (and (and (and $x640 $x638) $x636) $x631) $x629) $x627) $x659)))
 (let (($x538 (= loc_2 4)))
 ...
 (let (($x1031 (and false $x432)))
 (let (($x601 (= $i0_h0_2 1)))
 (let (($x602 (and $x538 $x601)))
 (let (($x489 (= loc_2 3)))
 (let (($x1054 (and (=> $x489 (and (and (and $x432 $x579) $x592) (= loc_3 3))) (=> $x602 (and (and (and $x1031 $x579) $x592) $x609)))))
 ...
 (let (($x1041 (and (and (and (and (and (and $x518 $x513) $x511) $x503) $x912) $x534) $x482)))
 (let (($x425 (= loc_1 2)))
 ...
 (let (($x1044 (and (=> $x430 (and (and (and $x1031 $x469) $x482) $x489)) (=> $x499 (and $x1041 $x538)))))
 ...
 (let (($x348 (= $M.01_1 0)))
 (let (($x1027 (and (and (and (and (and (and $x348 $x346) $x341) $x339) $x364) $x401) $x418)))
 (let (($x333 (= loc_0 1)))
 (let (($x328 (= A_0 epsilon)))
 (let (($x1066 (and (and (and $x328 (=> $x333 (and $x1027 $x425))) $x1044) (and $x1054 (=> $x620 (and (and (and $x1060 $x668) $x671) $x675))))))
 (and (and (and $x1066 $x1086) $x1100) $x1107))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
